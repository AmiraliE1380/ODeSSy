...
### 10.25 Automated multi-versioning: how it is implemented (reference, with pseudocode)
...
bug of §10.24). The original loop is never modified; `simplifycfg`/`adce`
...
### 10.32 Sep 16 2026: knob split, benchmark-freeze assurance, drift, Rust matmul
...
### 10.33 Swift toolchain pin (Sep 16 2026)
