...
### 11.6 The machinery program (decided Sep 10 2026): four general mechanisms, each with a falsifiable prediction
...
### 11.10 MV sweep over all local kernels, benchmarks FROZEN (Mac, Sep 10 2026)
...
### 11.12 Session 5.2 -- T3 implemented; matmul.jl prediction FAILED on solver hardness (Sep 16 2026)
