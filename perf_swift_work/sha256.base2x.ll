; ModuleID = '/Users/ebrah/Project/compiler/ODeSSy/perf_swift_work/.tmp.ll'
...
entry:
  ...
  br i1 %11, label %373, label %12, !prof !44
...
117:                                              ; preds = %112
  ...
  br i1 %118, label %393, label %119, !prof !44
...
141:                                              ; preds = %112
  ...
  br i1 %142, label %392, label %143, !prof !44
...
188:                                              ; preds = %101
  ...
  br i1 %192, label %375, label %193, !prof !44
...
193:                                              ; preds = %188
  ...
  br i1 %.not127, label %200, label %371
...
200:                                              ; preds = %193
  ...
  br i1 %206, label %376, label %207, !prof !44
...
236:                                              ; preds = %216
  ...
  %invariant.op = add nsw i64 %233, -2
  br label %247

.loopexit:                                        ; preds = %216
  %.pre = load i64, ptr %reference.new4, align 8, !range !43
  %242 = icmp eq i64 %.pre, 0
  br i1 %242, label %391, label %.loopexit..loopexit.thread_crit_edge, !prof !48

.loopexit..loopexit.thread_crit_edge:             ; preds = %.loopexit
  %.pre80 = load i32, ptr %219, align 8
  br label %.loopexit.thread

.loopexit.thread:                                 ; preds = %321, %.loopexit..loopexit.thread_crit_edge
  %243 = phi i32 [ %.pre80, %.loopexit..loopexit.thread_crit_edge ], [ %322, %321 ]
...
247:                                              ; preds = %321, %236
  %248 = phi i64 [ 0, %236 ], [ %249, %321 ]
  %exitcond.not = icmp eq i64 %248, %234
  br i1 %exitcond.not, label %377, label %.split50.preheader, !prof !44
...
.split50:                                         ; preds = %.split50.preheader, %261
  %251 = phi i64 [ %252, %261 ], [ 0, %.split50.preheader ]
  %252 = add nuw nsw i64 %251, 1
  %253 = shl nuw nsw i64 %251, 2
  %254 = add nuw nsw i64 %253, %250
  %.not130 = icmp samesign ult i64 %254, %233
  br i1 %.not130, label %255, label %.split52.us, !prof !45

255:                                              ; preds = %.split50
  %256 = or disjoint i64 %254, 1
  %.not131 = icmp samesign ult i64 %256, %233
  br i1 %.not131, label %.check, label %.split54.us, !prof !45

.check:                                           ; preds = %255
  %.not132 = icmp samesign ult i64 %254, %invariant.op
  br i1 %.not132, label %257, label %378, !prof !45

257:                                              ; preds = %.check
  %258 = or disjoint i64 %254, 3
  %.not180 = icmp samesign ult i64 %258, %233
  br i1 %.not180, label %259, label %.split56.us, !prof !45

259:                                              ; preds = %257
  %260 = load i64, ptr %228, align 8, !range !43
  %.not133 = icmp samesign ult i64 %251, %260
  br i1 %.not133, label %261, label %.split58.us, !prof !45

261:                                              ; preds = %259
  %262 = getelementptr inbounds nuw i8, ptr %237, i64 %254
  %263 = load i32, ptr %262, align 1
  %264 = call i32 @llvm.bswap.i32(i32 %263)
  %265 = getelementptr inbounds nuw [4 x i8], ptr %229, i64 %251
  store i32 %264, ptr %265, align 4
  %266 = icmp eq i64 %252, 16
  br i1 %266, label %.preheader.preheader.preheader, label %.split50, !llvm.loop !49

.preheader.preheader.preheader:                   ; preds = %261
  %267 = add nuw i64 %260, 15
  %268 = add nuw i64 %260, 2
  br label %.preheader.preheader

269:                                              ; preds = %307
  %270 = load i64, ptr %reference.new4, align 8, !range !43
  %271 = icmp eq i64 %270, 0
  br i1 %271, label %382, label %272, !prof !44

272:                                              ; preds = %269
  %273 = load i32, ptr %219, align 8
  %274 = icmp eq i64 %270, 1
  br i1 %274, label %383, label %275, !prof !44

275:                                              ; preds = %272
  %276 = load i32, ptr %220, align 4
  %277 = icmp samesign ult i64 %270, 3
  br i1 %277, label %384, label %278, !prof !44

278:                                              ; preds = %275
  %279 = load i32, ptr %221, align 8
  %280 = icmp eq i64 %270, 3
  br i1 %280, label %385, label %281, !prof !44

281:                                              ; preds = %278
  %282 = load i32, ptr %222, align 4
  %283 = icmp samesign ult i64 %270, 5
  br i1 %283, label %386, label %284, !prof !44

284:                                              ; preds = %281
  %285 = load i32, ptr %223, align 8
  %286 = icmp eq i64 %270, 5
  br i1 %286, label %387, label %287, !prof !44

287:                                              ; preds = %284
  %288 = load i32, ptr %224, align 4
  %289 = icmp samesign ult i64 %270, 7
  br i1 %289, label %388, label %290, !prof !44

290:                                              ; preds = %287
  %291 = load i32, ptr %225, align 8
  %292 = icmp eq i64 %270, 7
  br i1 %292, label %389, label %293, !prof !44

293:                                              ; preds = %290
  %294 = load i32, ptr %226, align 4
  br i1 %.not212, label %390, label %.split, !prof !44

.preheader.preheader:                             ; preds = %307, %.preheader.preheader.preheader
  %295 = phi i64 [ %296, %307 ], [ 16, %.preheader.preheader.preheader ]
  %296 = add nuw nsw i64 %295, 1
  %exitcond.not111 = icmp eq i64 %295, %267
  br i1 %exitcond.not111, label %379, label %297, !prof !44

297:                                              ; preds = %.preheader.preheader
  %298 = getelementptr [4 x i8], ptr %229, i64 %295
  ...
  %304 = lshr i32 %300, 3
  %305 = xor i32 %303, %304
  %exitcond77.not = icmp eq i64 %295, %268
  br i1 %exitcond77.not, label %380, label %306, !prof !44

306:                                              ; preds = %297
  %exitcond79.not = icmp eq i64 %295, %260
  br i1 %exitcond79.not, label %381, label %307, !prof !44

307:                                              ; preds = %306
  %308 = getelementptr i8, ptr %298, i64 -8
  %309 = load i32, ptr %308, align 4
  %310 = call i32 @llvm.fshl.i32(i32 %309, i32 %309, i32 15)
  %311 = call i32 @llvm.fshl.i32(i32 %309, i32 %309, i32 13)
  %312 = xor i32 %310, %311
  %313 = lshr i32 %309, 10
  %314 = xor i32 %312, %313
  %gep = getelementptr [4 x i8], ptr %invariant.gep, i64 %295
  %315 = load i32, ptr %gep, align 4
  %gep235 = getelementptr [4 x i8], ptr %invariant.gep234, i64 %295
  %316 = load i32, ptr %gep235, align 4
  %317 = add i32 %315, %305
  %318 = add i32 %317, %316
  %319 = add i32 %318, %314
  store i32 %319, ptr %298, align 4
  %320 = icmp eq i64 %296, 64
  br i1 %320, label %269, label %.preheader.preheader

321:                                              ; preds = %.split
  %322 = add i32 %369, %273
  store i32 %322, ptr %219, align 8
  %323 = add i32 %339, %276
  store i32 %323, ptr %220, align 4
  %324 = add i32 %338, %279
  store i32 %324, ptr %221, align 8
  %325 = add i32 %337, %282
  store i32 %325, ptr %222, align 4
  %326 = add i32 %368, %285
  store i32 %326, ptr %223, align 8
  %327 = add i32 %335, %288
  store i32 %327, ptr %224, align 4
  %328 = add i32 %334, %291
  store i32 %328, ptr %225, align 8
  %329 = add i32 %333, %294
  store i32 %329, ptr %226, align 4
  %330 = icmp eq i64 %249, %234
  br i1 %330, label %.loopexit.thread, label %247

.split:                                           ; preds = %293, %.split
  %331 = phi i64 [ %349, %.split ], [ 0, %293 ]
  %332 = phi i32 [ %333, %.split ], [ %294, %293 ]
  %333 = phi i32 [ %334, %.split ], [ %291, %293 ]
  %334 = phi i32 [ %335, %.split ], [ %288, %293 ]
  %335 = phi i32 [ %368, %.split ], [ %285, %293 ]
  %336 = phi i32 [ %337, %.split ], [ %282, %293 ]
  %337 = phi i32 [ %338, %.split ], [ %279, %293 ]
  %338 = phi i32 [ %339, %.split ], [ %276, %293 ]
  %339 = phi i32 [ %369, %.split ], [ %273, %293 ]
  %340 = and i32 %335, %334
  %341 = xor i32 %335, -1
  %342 = and i32 %333, %341
  %343 = or i32 %340, %342
  %344 = call i32 @llvm.fshl.i32(i32 %335, i32 %335, i32 26)
  %345 = call i32 @llvm.fshl.i32(i32 %335, i32 %335, i32 21)
  %346 = xor i32 %344, %345
  %347 = call i32 @llvm.fshl.i32(i32 %335, i32 %335, i32 7)
  %348 = xor i32 %346, %347
  %349 = add nuw nsw i64 %331, 1
  %350 = getelementptr inbounds nuw [4 x i8], ptr %239, i64 %331
  %351 = load i32, ptr %350, align 4
  %352 = getelementptr inbounds nuw [4 x i8], ptr %229, i64 %331
  %353 = load i32, ptr %352, align 4
  %354 = add i32 %343, %332
  %355 = add i32 %354, %348
  %356 = add i32 %355, %351
  %357 = add i32 %356, %353
  %358 = call i32 @llvm.fshl.i32(i32 %339, i32 %339, i32 30)
  %359 = call i32 @llvm.fshl.i32(i32 %339, i32 %339, i32 19)
  %360 = xor i32 %358, %359
  %361 = call i32 @llvm.fshl.i32(i32 %339, i32 %339, i32 10)
  %362 = xor i32 %360, %361
  %363 = xor i32 %338, %337
  %364 = and i32 %339, %363
  %365 = and i32 %338, %337
  ...
  %368 = add i32 %357, %336
  %369 = add i32 %367, %357
  %370 = icmp eq i64 %349, 64
  br i1 %370, label %321, label %.split

371:                                              ; preds = %193
  %372 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %372, align 8, !invariant.load !41
...
.split52.us:                                      ; preds = %.split50
  call void asm sideeffect "", "n"(i32 12) #2
  call void @llvm.trap()
  unreachable

.split54.us:                                      ; preds = %255
...
"$ss22_ContiguousArrayBufferV19_uninitializedCount15minimumCapacityAByxGSi_SitcfCs5UInt8V_Tt1gq5.exit": ; preds = %36, %34
...
.loopexit17:                                      ; preds = %155, %152, %127, %122, %98, %92, %62, %57, %15, %9, %entry
  %.sink = phi i64 [ %3, %entry ], [ %3, %15 ], [ %3, %9 ], [ %125, %127 ], [ %60, %62 ], [ %96, %98 ], [ %60, %57 ], [ %96, %92 ], [ %125, %122 ], [ %153, %152 ], [ %153, %155 ]
  %161 = phi i64 [ 0, %entry ], [ 0, %15 ], [ 0, %9 ], [ %106, %127 ], [ %38, %62 ], [ %72, %98 ], [ %2, %57 ], [ %2, %92 ], [ %2, %122 ], [ %135, %155 ], [ %2, %152 ]
...
.split6.us:                                       ; preds = %139, %110, %.thread, %74, %42
  tail call void asm sideeffect "", "n"(i32 2) #2
  tail call void @llvm.trap()
  unreachable
...
!49 = distinct !{!49, !50}
!50 = !{!"llvm.loop.unswitch.injection.disable"}
