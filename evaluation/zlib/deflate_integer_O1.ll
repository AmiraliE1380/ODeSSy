...
35:                                               ; preds = %32
  tail call void @llvm.ubsantrap(i8 13) #13, !nosanitize !49
  unreachable, !nosanitize !49
...
231:                                              ; preds = %223
  ...
  %234 = tail call i64 @adler32(i64 noundef %233, ptr noundef %216, i32 noundef %217) #11
...
235:                                              ; preds = %223
  ...
  %238 = tail call i64 @crc32(i64 noundef %237, ptr noundef %216, i32 noundef %217) #11
...
569:                                              ; preds = %561
  ...
  %572 = tail call i64 @adler32(i64 noundef %571, ptr noundef %554, i32 noundef %555) #11
...
573:                                              ; preds = %561
  ...
  %576 = tail call i64 @crc32(i64 noundef %575, ptr noundef %554, i32 noundef %555) #11
...
267:                                              ; preds = %263, %216
  %268 = tail call i64 @adler32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
...
276:                                              ; preds = %273
  %277 = tail call i64 @crc32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
...
521:                                              ; preds = %516
  ...
  %525 = tail call i64 @crc32_z(i64 noundef %522, ptr noundef %523, i64 noundef %524) #11
...
585:                                              ; preds = %570
  ...
  %590 = tail call i64 @crc32_z(i64 noundef %589, ptr noundef %588, i64 noundef %586) #11
...
596:                                              ; preds = %591
  ...
  tail call void @_tr_flush_bits(ptr noundef %598) #11
...
669:                                              ; preds = %662
  ...
  %674 = tail call i64 @crc32_z(i64 noundef %673, ptr noundef %672, i64 noundef %670) #11
...
712:                                              ; preds = %706, %699
  ...
  tail call void @_tr_flush_bits(ptr noundef %713) #11
...
785:                                              ; preds = %782
  ...
  %790 = tail call i64 @crc32_z(i64 noundef %789, ptr noundef %788, i64 noundef %786) #11
...
821:                                              ; preds = %814
  ...
  %826 = tail call i64 @crc32_z(i64 noundef %825, ptr noundef %824, i64 noundef %822) #11
  store i64 %826, ptr %806, align 8, !tbaa !60
  br label %827

827:                                              ; preds = %821, %814
  %828 = load ptr, ptr %24, align 8, !tbaa !19
  tail call void @_tr_flush_bits(ptr noundef %828) #11
...
900:                                              ; preds = %897
  ...
  %905 = tail call i64 @crc32_z(i64 noundef %904, ptr noundef %903, i64 noundef %901) #11
...
947:                                              ; preds = %936
  ...
  %954 = tail call i64 @crc32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
...
980:                                              ; preds = %974
  ...
  %985 = tail call i32 %984(ptr noundef nonnull %25, i32 noundef 5) #11, !inline_history !115
  br label %986
...
1004:                                             ; preds = %966, %998, %1000, %272, %676, %754, %869, %994, %1003, %997, %958, %929, %376, %161, %137, %89, %153
...
1028:                                             ; preds = %82, %64, %61, %55, %51, %1025, %1004
...
1074:                                             ; preds = %20, %17, %13, %9, %5, %3, %23, %1028, %1073
...
240:                                              ; preds = %236, %189
  %241 = tail call i64 @adler32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
...
249:                                              ; preds = %246
  %250 = tail call i64 @crc32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
...
498:                                              ; preds = %493
  ...
  %502 = tail call i64 @crc32_z(i64 noundef %499, ptr noundef %500, i64 noundef %501) #11
...
573:                                              ; preds = %568
  ...
  tail call void @_tr_flush_bits(ptr noundef %575) #11
...
647:                                              ; preds = %640
  ...
  %653 = tail call i64 @crc32_z(i64 noundef %652, ptr noundef %650, i64 noundef %648) #11
...
686:                                              ; preds = %679
  ...
  %691 = tail call i64 @crc32_z(i64 noundef %690, ptr noundef %689, i64 noundef %687) #11
...
765:                                              ; preds = %762
  ...
  %771 = tail call i64 @crc32_z(i64 noundef %770, ptr noundef %768, i64 noundef %766) #11
...
803:                                              ; preds = %796
  ...
  %808 = tail call i64 @crc32_z(i64 noundef %807, ptr noundef %806, i64 noundef %804) #11
...
882:                                              ; preds = %879
  ...
  %888 = tail call i64 @crc32_z(i64 noundef %887, ptr noundef %885, i64 noundef %883) #11
...
930:                                              ; preds = %919
  ...
  %937 = tail call i64 @crc32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
...
967:                                              ; preds = %960
  ...
  %972 = tail call i32 %971(ptr noundef %29, i32 noundef %1) #11
  br label %973

973:                                              ; preds = %963, %967, %965, %958
...
1012:                                             ; preds = %987, %997, %1008, %989, %988
  tail call fastcc void @flush_pending(ptr noundef %0)
...
1165:                                             ; preds = %245, %981, %1015, %984, %1017, %1016, %851, %734, %23, %655, %1161, %941, %912, %351, %132, %124, %103, %53, %46
...
164:                                              ; preds = %152, %161, %89, %96, %163, %91
...
86:                                               ; preds = %82, %77
  ...
  tail call void @_tr_stored_block(ptr noundef %0, ptr noundef null, i64 noundef 0, i32 noundef %87) #11
...
459:                                              ; preds = %451
  ...
  %462 = tail call i64 @adler32(i64 noundef %461, ptr noundef %447, i32 noundef %440) #11
...
463:                                              ; preds = %451
  ...
  %466 = tail call i64 @crc32(i64 noundef %465, ptr noundef %447, i32 noundef %440) #11
...
554:                                              ; preds = %551, %546, %543
  ...
  tail call void @_tr_stored_block(ptr noundef %0, ptr noundef %558, i64 noundef %559, i32 noundef %555) #11
...
162:                                              ; preds = %154
  ...
  %165 = tail call i64 @adler32(i64 noundef %164, ptr noundef %147, i32 noundef %148) #11
...
166:                                              ; preds = %154
  ...
  %169 = tail call i64 @crc32(i64 noundef %168, ptr noundef %147, i32 noundef %148) #11
...
385:                                              ; preds = %380
  ...
  tail call void @_tr_flush_block(ptr noundef %0, ptr noundef %381, i64 noundef %386, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %391) #11
...
453:                                              ; preds = %447
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %448, i64 noundef %454, i32 noundef 1) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %459) #11
...
523:                                              ; preds = %517
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %518, i64 noundef %524, i32 noundef 0) #11
...
173:                                              ; preds = %165
  ...
  %176 = tail call i64 @adler32(i64 noundef %175, ptr noundef %158, i32 noundef %159) #11
...
177:                                              ; preds = %165
  ...
  %180 = tail call i64 @crc32(i64 noundef %179, ptr noundef %158, i32 noundef %159) #11
...
422:                                              ; preds = %419, %339, %347, %351, %336, %333
...
550:                                              ; preds = %544
  ...
  tail call void @_tr_flush_block(ptr noundef %0, ptr noundef %545, i64 noundef %551, i32 noundef 0) #11
...
618:                                              ; preds = %612
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %613, i64 noundef %619, i32 noundef 1) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %624) #11
...
688:                                              ; preds = %682
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %683, i64 noundef %689, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %694) #11
...
203:                                              ; preds = %195
  ...
  %206 = tail call i64 @adler32(i64 noundef %205, ptr noundef %188, i32 noundef %189) #11
...
207:                                              ; preds = %195
  ...
  %210 = tail call i64 @crc32(i64 noundef %209, ptr noundef %188, i32 noundef %189) #11
...
814:                                              ; preds = %808
  ...
  tail call void @_tr_flush_block(ptr noundef %0, ptr noundef %809, i64 noundef %815, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %820) #11
...
883:                                              ; preds = %878
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %879, i64 noundef %884, i32 noundef 1) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %889) #11
...
952:                                              ; preds = %947
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %948, i64 noundef %953, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %958) #11
...
1005:                                             ; preds = %861, %357, %999, %930, %1004
...
202:                                              ; preds = %194
  ...
  %205 = tail call i64 @adler32(i64 noundef %204, ptr noundef %187, i32 noundef %188) #11
...
206:                                              ; preds = %194
  ...
  %209 = tail call i64 @crc32(i64 noundef %208, ptr noundef %187, i32 noundef %188) #11
...
604:                                              ; preds = %586, %593, %600, %603, %413, %399, %394
...
773:                                              ; preds = %768
  ...
  tail call void @_tr_flush_block(ptr noundef %0, ptr noundef %769, i64 noundef %774, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %779) #11
...
886:                                              ; preds = %880
  ...
  tail call void @_tr_flush_block(ptr noundef %0, ptr noundef %881, i64 noundef %887, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %892) #11
...
1027:                                             ; preds = %1022
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %1023, i64 noundef %1028, i32 noundef 1) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %1033) #11
...
1096:                                             ; preds = %1091
  ...
  tail call void @_tr_flush_block(ptr noundef nonnull %0, ptr noundef %1092, i64 noundef %1097, i32 noundef 0) #11
  ...
  tail call void @_tr_flush_bits(ptr noundef %1102) #11
...
1149:                                             ; preds = %944, %820, %356, %1143, %1074, %1148
