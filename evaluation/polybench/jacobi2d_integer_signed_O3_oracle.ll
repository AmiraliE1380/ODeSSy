; ModuleID = 'evaluation/polybench/jacobi2d_integer_signed_O3.ll'
...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call ptr @polybench_alloc_data(i64 noundef 900, i32 noundef 8) #11
  %4 = ptrtoaddr ptr %3 to i64
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 900, i32 noundef 8) #11
...
662:                                              ; preds = %658
  ...
  %664 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 22, i64 1, ptr %663) #12
  %665 = load ptr, ptr @stderr, align 8, !tbaa !32
  %666 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %665, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #13
  br label %667
...
680:                                              ; preds = %677, %671
  ...
  %684 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %681, ptr noundef nonnull @.str.5, double noundef %683) #13
...
690:                                              ; preds = %687
  ...
  %692 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %691, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #13
  %693 = load ptr, ptr @stderr, align 8, !tbaa !32
  %694 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 22, i64 1, ptr %693) #12
  br label %695
...
; Function Attrs: nofree nounwind uwtable
define dso_local nonnull ptr @polybench_alloc_data(i64 noundef %0, i32 noundef %1) local_unnamed_addr #7 {
  %3 = alloca ptr, align 8
  %4 = sext i32 %1 to i64
  %5 = mul i64 %0, %4
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #11
  store ptr null, ptr %3, align 8, !tbaa !36
  %6 = call i32 @posix_memalign(ptr noundef nonnull %3, i64 noundef 4096, i64 noundef %5) #11
...
11:                                               ; preds = %2
  ...
  %13 = call i64 @fwrite(ptr nonnull @.str.2.4, i64 50, i64 1, ptr %12) #12
