; ModuleID = 'evaluation/polybench/jacobi2d_integer_signed_O1.ll'
...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %4 = tail call ptr @polybench_alloc_data(i64 noundef 900, i32 noundef 8) #11
  br label %5
...
98:                                               ; preds = %94
  ...
  %100 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 22, i64 1, ptr %99) #12
  %101 = load ptr, ptr @stderr, align 8, !tbaa !22
  %102 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %101, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #13
  br label %103
...
116:                                              ; preds = %113, %107
  ...
  %120 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %117, ptr noundef nonnull @.str.5, double noundef %119) #13
...
126:                                              ; preds = %123
  ...
  %128 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %127, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #13
  %129 = load ptr, ptr @stderr, align 8, !tbaa !22
  %130 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 22, i64 1, ptr %129) #12
  br label %131
