...
\item \textbf{Super-analysis} (\S\ref{sec:superanalysis}): an aggressive compilation paradigm
  positioning between conventional heuristic-based optimization and super-optimization. The general recipe for this paradigm is to use solvers (SMT in particular) as an analysis oracle, while applying cheap conventional rules-based transformation for optimization.
