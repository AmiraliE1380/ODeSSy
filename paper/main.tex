...
not an artifact of one problem size: sweeping $(m, n, k)$ over 13
shapes --- square from $64^3$ to $2048^3$, tall, wide, deep, and inner
loops as short as $m{=}8$ --- the proof-licensed build is faster at
\emph{every} shape, by $1.9\times$ to $6.8\times$
...
loops. The gain is present at every shape ($1.9\times$--$6.8\times$)
...
$m \geq 2048$ (the $2048^3$ point and the $m{=}2048$ bars) the loop
streams 16--32\,KB columns from memory and bandwidth, not checks,
becomes the limiter.}
\Description{Two panels. Left, a line chart of speedup versus square
matrix dimension from 64 to 2048 on a log axis: about 6.8x and 6.2x at
64 and 128, about 4.1 to 4.4x from 256 to 1024, and 1.9x at 2048.
