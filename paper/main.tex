...
(Table~\ref{tab:inbounds}); ceiling is the expert-annotation arm.\par
\end{table*}
...
CryptoSwift (library) & Swift & 215 & M-series & $-0.4$\% & 2.5--3\% & $\approx$0 & none; 10\,s budget dose\\
md5 & Swift & 5 & M-series & flat & --- & --- & none; same count, no unlock\\
adler32 & Swift & 1 & M-series & $-1.4$\% & $\sim$5\% & $<0$ & none; relottery\\
md5 & Swift & 1 & x86 & $-1.8$\% & 6.0\% & $<0$ & none; relottery\\
utf8 validator & Swift & 2 & M-series & $-2$\% & $\approx$0 & $<0$ & none; relottery\\
...
sha256 & Julia & 10 & --- & n/a & $\approx$0 & --- & JIT IR not executable\\
filt (DSP.jl port) & Julia & 6 & --- & n/a & $\approx$0 & --- & JIT IR not executable\\
poly (Horner) & Julia & 1 & --- & n/a & $\approx$0 & --- & JIT IR not executable\\
matmul / lz77 & Julia & 0 & --- & n/a & --- & --- & checks are the spec\\
...
$^{c}$Honest ceiling after removing the 8.1 points of the
\texttt{-O}-vs-sandwich pipeline gap from the raw \pct{19.6}.
