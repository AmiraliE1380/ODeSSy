...
Taneja et al.~\cite{taneja2020knownbits} compiled
four programs with the maximally precise analyses installed, three of them showed a few percent of performance improvement at most; the one clear win (\pct{8}--\pct{22} on bzip2)
...
\emph{one} analysis in isolation moves the optimizer little,
\emph{conjoining} the facts from multiple analysis is what significantly improve performance; our unsat cores
...
dillig2013abductive}: given what is known and a goal, find a hypothesis
that, together with what is known, entails the goal while staying
consistent with it. Here the goal is that the trap is unreachable, and
the hypothesis becomes a runtime guard.
