; ModuleID = 'results/static/guard_competitors/Julia_lz77/irce.ll'
...
L19:                                              ; preds = %L19.preheader5, %L63
  ...
  %.not32.not.not = icmp sgt i64 %14, %"data::Array.size.0.copyload", !dbg !47
  br i1 %.not32.not.not, label %L68, label %L57, !dbg !44
...
L68:                                              ; preds = %L19.preloop, %L57.preloop, %L19, %L57, %L19.postloop, %L57.postloop, %L63.postloop, %preloop.exit.selector, %main.exit.selector
  %value_phi23 = phi i64 [ %smin20, %main.exit.selector ], [ %smax83, %preloop.exit.selector ], [ %smax84, %L63.postloop ], [ %value_phi5, %L19 ], [ %value_phi5.postloop, %L57.postloop ], [ %value_phi5.postloop, %L19.postloop ], [ %value_phi5, %L57 ], [ %value_phi5.preloop, %L57.preloop ], [ %value_phi5.preloop, %L19.preloop ]
...
L19.preloop:                                      ; preds = %L19.preheader, %L63.preloop
  ...
  %.not32.preloop.not.not = icmp sgt i64 %23, %"data::Array.size.0.copyload", !dbg !47
  br i1 %.not32.preloop.not.not, label %L68, label %L23.preloop, !dbg !44
...
L19.postloop:                                     ; preds = %L63.postloop, %main.pseudo.exit
  ...
  %.not32.postloop.not.not = icmp sgt i64 %32, %"data::Array.size.0.copyload", !dbg !47
  br i1 %.not32.postloop.not.not, label %L68, label %L23.postloop, !dbg !44
