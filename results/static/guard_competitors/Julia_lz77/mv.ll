...
L23.preloop.mv.fast:                              ; preds = %L19.preloop.mv.fast
  ...
  br i1 true, label %L38.preloop.mv.fast, label %odessy.chk1, !dbg !48
...
L38.preloop.mv.fast:                              ; preds = %L23.preloop.mv.fast
  ...
  br i1 true, label %L57.preloop.mv.fast, label %odessy.chk3, !dbg !48
...
L23.postloop.mv.fast:                             ; preds = %L19.postloop.mv.fast
  ...
  br i1 true, label %L38.postloop.mv.fast, label %odessy.chk, !dbg !48
...
L38.postloop.mv.fast:                             ; preds = %L23.postloop.mv.fast
  ...
  br i1 true, label %L57.postloop.mv.fast, label %odessy.chk2, !dbg !48
...
odessy.chk:                                       ; preds = %L23.postloop.mv.fast, %L23.postloop
  call void @odessy.chk(i32 0)
  unreachable

odessy.chk1:                                      ; preds = %L23.preloop.mv.fast, %L23.preloop
  call void @odessy.chk(i32 1)
  unreachable

odessy.chk2:                                      ; preds = %L38.postloop.mv.fast, %L38.postloop
  call void @odessy.chk(i32 2)
  unreachable

odessy.chk3:                                      ; preds = %L38.preloop.mv.fast, %L38.preloop
