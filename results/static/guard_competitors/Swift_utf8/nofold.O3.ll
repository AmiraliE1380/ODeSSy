; ModuleID = 'results/static/guard_competitors/Swift_utf8/nofold.ll'
...
3:                                                ; preds = %entry
  ...
  %mv.h = icmp samesign ult i64 %2, 4611686018427387905
  br i1 %mv.h, label %.mv.ph.mv.fast, label %.mv.ph

.mv.ph.mv.fast:                                   ; preds = %3, %73
  %5 = phi i64 [ %74, %73 ], [ 0, %3 ]
  %6 = phi i64 [ %75, %73 ], [ 0, %3 ]
  %7 = phi i64 [ %76, %73 ], [ 0, %3 ]
...
11:                                               ; preds = %.mv.ph.mv.fast
  %12 = icmp samesign ult i8 %9, -62
  br i1 %12, label %67, label %13

13:                                               ; preds = %11
  %14 = icmp samesign ult i8 %9, -32
  br i1 %14, label %56, label %15

15:                                               ; preds = %13
  %16 = icmp samesign ult i8 %9, -16
  br i1 %16, label %41, label %17

17:                                               ; preds = %15
  %18 = icmp samesign ult i8 %9, -11
...
22:                                               ; preds = %17
  %23 = add nuw i64 %7, 3
  %.not23.mv.fast = icmp slt i64 %23, %2
  br i1 %.not23.mv.fast, label %24, label %.loopexit13

24:                                               ; preds = %22
  %25 = add nuw nsw i64 %7, 1
  %.not24.mv.fast = icmp slt i64 %25, %2
  br i1 %.not24.mv.fast, label %26, label %odessy.fasttrap, !prof !45
...
26:                                               ; preds = %24
  ...
  %33 = icmp slt i8 %28, -64
  %34 = icmp slt i8 %30, -64
  %or.cond9.mv.fast = select i1 %33, i1 %34, i1 false
  %35 = icmp slt i8 %32, -64
  %or.cond11.mv.fast = select i1 %or.cond9.mv.fast, i1 %35, i1 false
  br i1 %or.cond11.mv.fast, label %38, label %36
...
41:                                               ; preds = %15
  ...
  %.not27.mv.fast = icmp slt i64 %42, %2
  br i1 %.not27.mv.fast, label %43, label %.loopexit14
...
43:                                               ; preds = %41
  ...
  %50 = icmp slt i8 %48, -64
  %or.cond.mv.fast = select i1 %49, i1 %50, i1 false
  br i1 %or.cond.mv.fast, label %53, label %51
...
56:                                               ; preds = %13
  ...
  %.not30.mv.fast = icmp slt i64 %57, %2
  br i1 %.not30.mv.fast, label %58, label %.loopexit15

58:                                               ; preds = %56
  %59 = getelementptr inbounds nuw i8, ptr %4, i64 %57
...
70:                                               ; preds = %.mv.ph.mv.fast
  %71 = add i64 %6, 1
  %72 = add nuw nsw i64 %7, 1
  br label %73

73:                                               ; preds = %70, %67, %64, %62, %53, %51, %38, %36, %19
  %74 = phi i64 [ %20, %19 ], [ %37, %36 ], [ %5, %38 ], [ %52, %51 ], [ %5, %53 ], [ %63, %62 ], [ %5, %64 ], [ %68, %67 ], [ %5, %70 ]
  %75 = phi i64 [ %6, %19 ], [ %6, %36 ], [ %39, %38 ], [ %6, %51 ], [ %54, %53 ], [ %6, %62 ], [ %65, %64 ], [ %6, %67 ], [ %71, %70 ]
  %76 = phi i64 [ %21, %19 ], [ %25, %36 ], [ %40, %38 ], [ %44, %51 ], [ %55, %53 ], [ %57, %62 ], [ %66, %64 ], [ %69, %67 ], [ %72, %70 ]
  %77 = icmp slt i64 %76, %2
  br i1 %77, label %.mv.ph.mv.fast, label %.loopexit

.mv.ph:                                           ; preds = %3, %87
  %78 = phi i64 [ %88, %87 ], [ 0, %3 ]
  %79 = phi i64 [ %89, %87 ], [ 0, %3 ]
  %80 = phi i64 [ %90, %87 ], [ 0, %3 ]
...
87:                                               ; preds = %151, %149, %146, %127, %124, %109, %106, %94, %84
  %88 = phi i64 [ %152, %151 ], [ %150, %149 ], [ %78, %146 ], [ %128, %127 ], [ %78, %124 ], [ %110, %109 ], [ %78, %106 ], [ %95, %94 ], [ %78, %84 ]
  %89 = phi i64 [ %79, %151 ], [ %79, %149 ], [ %147, %146 ], [ %79, %127 ], [ %125, %124 ], [ %79, %109 ], [ %107, %106 ], [ %79, %94 ], [ %85, %84 ]
  %90 = phi i64 [ %153, %151 ], [ %135, %149 ], [ %148, %146 ], [ %117, %127 ], [ %126, %124 ], [ %100, %109 ], [ %108, %106 ], [ %96, %94 ], [ %86, %84 ]
  %91 = icmp slt i64 %90, %2
  br i1 %91, label %.mv.ph, label %.loopexit

92:                                               ; preds = %.mv.ph
  %93 = icmp samesign ult i8 %82, -62
...
97:                                               ; preds = %92
  %98 = icmp samesign ult i8 %82, -32
  br i1 %98, label %99, label %111

99:                                               ; preds = %97
  %100 = add nuw nsw i64 %80, 1
  %.not30 = icmp slt i64 %100, %2
  br i1 %.not30, label %102, label %.loopexit15

.loopexit15:                                      ; preds = %99, %56
  %.lcssa14 = phi i64 [ %5, %56 ], [ %78, %99 ]
  %.lcssa6 = phi i64 [ %6, %56 ], [ %79, %99 ]
  %101 = add i64 %.lcssa14, 1
  br label %.loopexit

102:                                              ; preds = %99
  %103 = getelementptr inbounds nuw i8, ptr %4, i64 %100
...
111:                                              ; preds = %97
  %112 = icmp samesign ult i8 %82, -16
  br i1 %112, label %113, label %129

113:                                              ; preds = %111
  %114 = add nuw nsw i64 %80, 2
  %.not27 = icmp slt i64 %114, %2
  br i1 %.not27, label %116, label %.loopexit14

.loopexit14:                                      ; preds = %113, %41
  %.lcssa13 = phi i64 [ %5, %41 ], [ %78, %113 ]
  %.lcssa5 = phi i64 [ %6, %41 ], [ %79, %113 ]
  %115 = add i64 %.lcssa13, 1
  br label %.loopexit
...
116:                                              ; preds = %113
  ...
  %120 = getelementptr inbounds nuw i8, ptr %4, i64 %114
  %121 = load i8, ptr %120, align 1
  %122 = icmp slt i8 %119, -64
  %123 = icmp slt i8 %121, -64
  %or.cond = select i1 %122, i1 %123, i1 false
  br i1 %or.cond, label %124, label %127

124:                                              ; preds = %116
  %125 = add i64 %79, 1
  %126 = add nuw i64 %80, 3
  br label %87
...
129:                                              ; preds = %111
  %130 = icmp samesign ult i8 %82, -11
  br i1 %130, label %131, label %151

131:                                              ; preds = %129
  %132 = add nuw i64 %80, 3
  %.not23 = icmp slt i64 %132, %2
  br i1 %.not23, label %134, label %.loopexit13

.loopexit13:                                      ; preds = %131, %22
  %.lcssa9 = phi i64 [ %5, %22 ], [ %78, %131 ]
  %.lcssa1 = phi i64 [ %6, %22 ], [ %79, %131 ]
  %133 = add i64 %.lcssa9, 1
  br label %.loopexit

134:                                              ; preds = %131
  %135 = add nuw nsw i64 %80, 1
  %.not24 = icmp slt i64 %135, %2
  br i1 %.not24, label %136, label %odessy.chk1, !prof !45

136:                                              ; preds = %134
  %137 = getelementptr inbounds nuw i8, ptr %4, i64 %135
  %138 = load i8, ptr %137, align 1
  %139 = getelementptr inbounds nuw i8, ptr %81, i64 2
  %140 = load i8, ptr %139, align 1
  %141 = getelementptr inbounds nuw i8, ptr %4, i64 %132
  %142 = load i8, ptr %141, align 1
  %143 = icmp slt i8 %138, -64
  %144 = icmp slt i8 %140, -64
  %or.cond9 = select i1 %143, i1 %144, i1 false
  %145 = icmp slt i8 %142, -64
  %or.cond11 = select i1 %or.cond9, i1 %145, i1 false
  br i1 %or.cond11, label %146, label %149

146:                                              ; preds = %136
  %147 = add i64 %79, 1
  %148 = add nuw i64 %80, 4
  br label %87
...
151:                                              ; preds = %129
  %152 = add i64 %78, 1
  %153 = add nuw nsw i64 %80, 1
  br label %87

.loopexit:                                        ; preds = %87, %73, %.loopexit13, %.loopexit14, %.loopexit15, %entry
  %154 = phi i64 [ %133, %.loopexit13 ], [ %115, %.loopexit14 ], [ %101, %.loopexit15 ], [ 0, %entry ], [ %74, %73 ], [ %88, %87 ]
  %155 = phi i64 [ %.lcssa1, %.loopexit13 ], [ %.lcssa5, %.loopexit14 ], [ %.lcssa6, %.loopexit15 ], [ 0, %entry ], [ %75, %73 ], [ %89, %87 ]
  %156 = insertvalue { i64, i64 } undef, i64 %155, 0
  %157 = insertvalue { i64, i64 } %156, i64 %154, 1
  ret { i64, i64 } %157

odessy.chk1:                                      ; preds = %134
  tail call void @odessy.chk(i32 10)
  unreachable

odessy.fasttrap:                                  ; preds = %24
