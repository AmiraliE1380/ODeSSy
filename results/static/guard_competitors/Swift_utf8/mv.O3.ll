; ModuleID = 'results/static/guard_competitors/Swift_utf8/mv.ll'
...
22:                                               ; preds = %17
  ...
  br i1 %.not23.mv.fast, label %24, label %.loopexit12
...
24:                                               ; preds = %22
  ...
  %32 = icmp slt i8 %27, -64
  %33 = icmp slt i8 %29, -64
  %or.cond9.mv.fast = select i1 %32, i1 %33, i1 false
  %34 = icmp slt i8 %31, -64
  %or.cond11.mv.fast = select i1 %or.cond9.mv.fast, i1 %34, i1 false
  br i1 %or.cond11.mv.fast, label %37, label %35
...
40:                                               ; preds = %15
  %41 = add nuw nsw i64 %7, 2
  %.not27.mv.fast = icmp slt i64 %41, %2
  br i1 %.not27.mv.fast, label %42, label %.loopexit13

42:                                               ; preds = %40
  %43 = add nuw nsw i64 %7, 1
  %44 = getelementptr inbounds nuw i8, ptr %4, i64 %43
  %45 = load i8, ptr %44, align 1
  %46 = getelementptr inbounds nuw i8, ptr %4, i64 %41
  %47 = load i8, ptr %46, align 1
  %48 = icmp slt i8 %45, -64
  %49 = icmp slt i8 %47, -64
  %or.cond.mv.fast = select i1 %48, i1 %49, i1 false
  br i1 %or.cond.mv.fast, label %52, label %50
...
55:                                               ; preds = %13
  ...
  %.not30.mv.fast = icmp slt i64 %56, %2
  br i1 %.not30.mv.fast, label %57, label %.loopexit14
...
69:                                               ; preds = %.mv.ph.mv.fast
  %70 = add i64 %6, 1
  %71 = add nuw nsw i64 %7, 1
  br label %72

72:                                               ; preds = %69, %66, %63, %61, %52, %50, %37, %35, %19
  %73 = phi i64 [ %20, %19 ], [ %36, %35 ], [ %5, %37 ], [ %51, %50 ], [ %5, %52 ], [ %62, %61 ], [ %5, %63 ], [ %67, %66 ], [ %5, %69 ]
  %74 = phi i64 [ %6, %19 ], [ %6, %35 ], [ %38, %37 ], [ %6, %50 ], [ %53, %52 ], [ %6, %61 ], [ %64, %63 ], [ %6, %66 ], [ %70, %69 ]
  %75 = phi i64 [ %21, %19 ], [ %25, %35 ], [ %39, %37 ], [ %43, %50 ], [ %54, %52 ], [ %56, %61 ], [ %65, %63 ], [ %68, %66 ], [ %71, %69 ]
  %76 = icmp slt i64 %75, %2
  br i1 %76, label %.mv.ph.mv.fast, label %.loopexit

.mv.ph:                                           ; preds = %3, %86
  %77 = phi i64 [ %87, %86 ], [ 0, %3 ]
  %78 = phi i64 [ %88, %86 ], [ 0, %3 ]
  %79 = phi i64 [ %89, %86 ], [ 0, %3 ]
...
86:                                               ; preds = %150, %148, %145, %126, %123, %108, %105, %93, %83
  %87 = phi i64 [ %151, %150 ], [ %149, %148 ], [ %77, %145 ], [ %127, %126 ], [ %77, %123 ], [ %109, %108 ], [ %77, %105 ], [ %94, %93 ], [ %77, %83 ]
  %88 = phi i64 [ %78, %150 ], [ %78, %148 ], [ %146, %145 ], [ %78, %126 ], [ %124, %123 ], [ %78, %108 ], [ %106, %105 ], [ %78, %93 ], [ %84, %83 ]
  %89 = phi i64 [ %152, %150 ], [ %134, %148 ], [ %147, %145 ], [ %116, %126 ], [ %125, %123 ], [ %99, %108 ], [ %107, %105 ], [ %95, %93 ], [ %85, %83 ]
  %90 = icmp slt i64 %89, %2
  br i1 %90, label %.mv.ph, label %.loopexit

91:                                               ; preds = %.mv.ph
  %92 = icmp samesign ult i8 %81, -62
...
96:                                               ; preds = %91
  %97 = icmp samesign ult i8 %81, -32
  br i1 %97, label %98, label %110

98:                                               ; preds = %96
  %99 = add nuw nsw i64 %79, 1
  %.not30 = icmp slt i64 %99, %2
  br i1 %.not30, label %101, label %.loopexit14

.loopexit14:                                      ; preds = %98, %55
  %.lcssa14 = phi i64 [ %5, %55 ], [ %77, %98 ]
  %.lcssa6 = phi i64 [ %6, %55 ], [ %78, %98 ]
  %100 = add i64 %.lcssa14, 1
  br label %.loopexit

101:                                              ; preds = %98
  %102 = getelementptr inbounds nuw i8, ptr %4, i64 %99
...
110:                                              ; preds = %96
  %111 = icmp samesign ult i8 %81, -16
  br i1 %111, label %112, label %128

112:                                              ; preds = %110
  %113 = add nuw nsw i64 %79, 2
  %.not27 = icmp slt i64 %113, %2
  br i1 %.not27, label %115, label %.loopexit13

.loopexit13:                                      ; preds = %112, %40
  %.lcssa13 = phi i64 [ %5, %40 ], [ %77, %112 ]
  %.lcssa5 = phi i64 [ %6, %40 ], [ %78, %112 ]
  %114 = add i64 %.lcssa13, 1
  br label %.loopexit
...
128:                                              ; preds = %110
  %129 = icmp samesign ult i8 %81, -11
  br i1 %129, label %130, label %150

130:                                              ; preds = %128
  %131 = add nuw i64 %79, 3
  %.not23 = icmp slt i64 %131, %2
  br i1 %.not23, label %133, label %.loopexit12

.loopexit12:                                      ; preds = %130, %22
  %.lcssa9 = phi i64 [ %5, %22 ], [ %77, %130 ]
  %.lcssa1 = phi i64 [ %6, %22 ], [ %78, %130 ]
  %132 = add i64 %.lcssa9, 1
  br label %.loopexit

133:                                              ; preds = %130
  %134 = add nuw nsw i64 %79, 1
  %.not24 = icmp slt i64 %134, %2
  br i1 %.not24, label %135, label %odessy.chk1, !prof !45

135:                                              ; preds = %133
  %136 = getelementptr inbounds nuw i8, ptr %4, i64 %134
  %137 = load i8, ptr %136, align 1
  %138 = getelementptr inbounds nuw i8, ptr %80, i64 2
  %139 = load i8, ptr %138, align 1
  %140 = getelementptr inbounds nuw i8, ptr %4, i64 %131
  %141 = load i8, ptr %140, align 1
  %142 = icmp slt i8 %137, -64
  %143 = icmp slt i8 %139, -64
  %or.cond9 = select i1 %142, i1 %143, i1 false
  %144 = icmp slt i8 %141, -64
  %or.cond11 = select i1 %or.cond9, i1 %144, i1 false
  br i1 %or.cond11, label %145, label %148

145:                                              ; preds = %135
  %146 = add i64 %78, 1
  %147 = add nuw i64 %79, 4
  br label %86
...
.loopexit:                                        ; preds = %86, %72, %.loopexit12, %.loopexit13, %.loopexit14, %entry
  %153 = phi i64 [ %132, %.loopexit12 ], [ %114, %.loopexit13 ], [ %100, %.loopexit14 ], [ 0, %entry ], [ %73, %72 ], [ %87, %86 ]
  %154 = phi i64 [ %.lcssa1, %.loopexit12 ], [ %.lcssa5, %.loopexit13 ], [ %.lcssa6, %.loopexit14 ], [ 0, %entry ], [ %74, %72 ], [ %88, %86 ]
  %155 = insertvalue { i64, i64 } undef, i64 %154, 0
  %156 = insertvalue { i64, i64 } %155, i64 %153, 1
  ret { i64, i64 } %156

odessy.chk1:                                      ; preds = %133
