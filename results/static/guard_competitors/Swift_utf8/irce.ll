...
.loopexit.loopexit:                               ; preds = %216
  %.lcssa = phi i64 [ %225, %216 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %207
  %210 = phi i64 [ 0, %207 ], [ %.lcssa, %.loopexit.loopexit ]
...
216:                                              ; preds = %216, %209
  ...
  br i1 %226, label %.loopexit.loopexit, label %216
...
define hidden swiftcc { i64, i64 } @"$s4utf88validateySi_SitSays5UInt8VGF"(ptr readonly captures(none) %0) local_unnamed_addr #0 {
entry:
...
9:                                                ; preds = %5
  %10 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %8
...
16:                                               ; preds = %86, %84, %81, %58, %55, %39, %36, %23, %13
  ...
  br i1 %20, label %5, label %.loopexit.loopexit
...
30:                                               ; preds = %28
  %.lcssa14 = phi i64 [ %6, %28 ]
  %.lcssa6 = phi i64 [ %7, %28 ]
  %31 = add i64 %.lcssa14, 1
  br label %.loopexit

32:                                               ; preds = %28
  %33 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %29
...
45:                                               ; preds = %43
  %.lcssa13 = phi i64 [ %6, %43 ]
  %.lcssa5 = phi i64 [ %7, %43 ]
  %46 = add i64 %.lcssa13, 1
  br label %.loopexit

47:                                               ; preds = %43
  %48 = add nuw nsw i64 %8, 1
  %49 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %48
  %50 = load i8, ptr %49, align 1
  %51 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %44
...
68:                                               ; preds = %66
  %69 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %67
...
73:                                               ; preds = %72
  %74 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %71
  %75 = load i8, ptr %74, align 1
  %76 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %63
...
.loopexit.loopexit:                               ; preds = %16
  %.lcssa17 = phi i64 [ %17, %16 ]
  %.lcssa16 = phi i64 [ %18, %16 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %64, %45, %30, %entry
  %89 = phi i64 [ %65, %64 ], [ %46, %45 ], [ %31, %30 ], [ 0, %entry ], [ %.lcssa17, %.loopexit.loopexit ]
  %90 = phi i64 [ %.lcssa1, %64 ], [ %.lcssa5, %45 ], [ %.lcssa6, %30 ], [ 0, %entry ], [ %.lcssa16, %.loopexit.loopexit ]
