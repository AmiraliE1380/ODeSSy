...
3:                                                ; preds = %entry
  ...
  %mv.h = icmp sle i64 %2, 4611686018427387904
  br i1 %mv.h, label %.mv.ph.mv.fast, label %.mv.ph

.mv.ph.mv.fast:                                   ; preds = %3
  br label %5

5:                                                ; preds = %78, %.mv.ph.mv.fast
  %6 = phi i64 [ 0, %.mv.ph.mv.fast ], [ %79, %78 ]
  %7 = phi i64 [ 0, %.mv.ph.mv.fast ], [ %80, %78 ]
  %8 = phi i64 [ 0, %.mv.ph.mv.fast ], [ %81, %78 ]
  %.not22.mv.fast = icmp ult i64 %8, %2
  br i1 true, label %9, label %odessy.chk, !prof !45
...
13:                                               ; preds = %9
  %14 = icmp samesign ult i8 %11, -62
  br i1 %14, label %72, label %15

15:                                               ; preds = %13
  %16 = icmp samesign ult i8 %11, -32
  br i1 %16, label %61, label %17

17:                                               ; preds = %15
  %18 = icmp samesign ult i8 %11, -16
  br i1 %18, label %46, label %19

19:                                               ; preds = %17
  %20 = icmp samesign ult i8 %11, -11
...
24:                                               ; preds = %19
  %25 = add nuw i64 %8, 3
  %.not23.mv.fast = icmp slt i64 %25, %2
  br i1 %.not23.mv.fast, label %26, label %142

26:                                               ; preds = %24
  %27 = add nuw nsw i64 %8, 1
  %.not24.mv.fast = icmp slt i64 %27, %2
  br i1 %.not24.mv.fast, label %28, label %odessy.fasttrap, !prof !45

28:                                               ; preds = %26
  %29 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %27
  %30 = load i8, ptr %29, align 1
  %31 = add nuw nsw i64 %8, 2
  %.not25.mv.fast = icmp slt i64 %31, %2
  br i1 true, label %32, label %odessy.chk2, !prof !45

32:                                               ; preds = %28
  %.not26.mv.fast = icmp ult i64 %25, %2
  br i1 true, label %33, label %odessy.chk3, !prof !45

33:                                               ; preds = %32
  %34 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %31
  %35 = load i8, ptr %34, align 1
  %36 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %25
  %37 = load i8, ptr %36, align 1
  %38 = icmp slt i8 %30, -64
  %39 = icmp slt i8 %35, -64
  %or.cond9.mv.fast = select i1 %38, i1 %39, i1 false
  %40 = icmp slt i8 %37, -64
  %or.cond11.mv.fast = select i1 %or.cond9.mv.fast, i1 %40, i1 false
  br i1 %or.cond11.mv.fast, label %43, label %41
...
46:                                               ; preds = %17
  %47 = add nuw nsw i64 %8, 2
  %.not27.mv.fast = icmp slt i64 %47, %2
  br i1 %.not27.mv.fast, label %48, label %123

48:                                               ; preds = %46
  %49 = add nuw nsw i64 %8, 1
  %50 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %49
  %51 = load i8, ptr %50, align 1
  %52 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %47
  %53 = load i8, ptr %52, align 1
  %54 = icmp slt i8 %51, -64
  %55 = icmp slt i8 %53, -64
  %or.cond.mv.fast = select i1 %54, i1 %55, i1 false
  br i1 %or.cond.mv.fast, label %58, label %56
...
61:                                               ; preds = %15
  ...
  %.not30.mv.fast = icmp slt i64 %62, %2
  br i1 %.not30.mv.fast, label %63, label %108

63:                                               ; preds = %61
  %64 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %62
...
78:                                               ; preds = %75, %72, %69, %67, %58, %56, %43, %41, %21
  %79 = phi i64 [ %22, %21 ], [ %42, %41 ], [ %6, %43 ], [ %57, %56 ], [ %6, %58 ], [ %68, %67 ], [ %6, %69 ], [ %73, %72 ], [ %6, %75 ]
  %80 = phi i64 [ %7, %21 ], [ %7, %41 ], [ %44, %43 ], [ %7, %56 ], [ %59, %58 ], [ %7, %67 ], [ %70, %69 ], [ %7, %72 ], [ %76, %75 ]
  %81 = phi i64 [ %23, %21 ], [ %27, %41 ], [ %45, %43 ], [ %49, %56 ], [ %60, %58 ], [ %62, %67 ], [ %71, %69 ], [ %74, %72 ], [ %77, %75 ]
  %82 = icmp slt i64 %81, %2
  br i1 %82, label %5, label %.loopexit.loopexit

.mv.ph:                                           ; preds = %3
  br label %83

83:                                               ; preds = %94, %.mv.ph
  %84 = phi i64 [ 0, %.mv.ph ], [ %95, %94 ]
  %85 = phi i64 [ 0, %.mv.ph ], [ %96, %94 ]
  %86 = phi i64 [ 0, %.mv.ph ], [ %97, %94 ]
  %.not22 = icmp ult i64 %86, %2
  br i1 true, label %87, label %odessy.chk, !prof !45

87:                                               ; preds = %83
  %88 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %86
...
94:                                               ; preds = %164, %162, %159, %136, %133, %117, %114, %101, %91
  %95 = phi i64 [ %165, %164 ], [ %163, %162 ], [ %84, %159 ], [ %137, %136 ], [ %84, %133 ], [ %118, %117 ], [ %84, %114 ], [ %102, %101 ], [ %84, %91 ]
  %96 = phi i64 [ %85, %164 ], [ %85, %162 ], [ %160, %159 ], [ %85, %136 ], [ %134, %133 ], [ %85, %117 ], [ %115, %114 ], [ %85, %101 ], [ %92, %91 ]
  %97 = phi i64 [ %166, %164 ], [ %145, %162 ], [ %161, %159 ], [ %126, %136 ], [ %135, %133 ], [ %107, %117 ], [ %116, %114 ], [ %103, %101 ], [ %93, %91 ]
  %98 = icmp slt i64 %97, %2
  br i1 %98, label %83, label %.loopexit.loopexit

99:                                               ; preds = %87
  %100 = icmp samesign ult i8 %89, -62
...
104:                                              ; preds = %99
  %105 = icmp samesign ult i8 %89, -32
  br i1 %105, label %106, label %119

106:                                              ; preds = %104
  %107 = add nuw nsw i64 %86, 1
  %.not30 = icmp slt i64 %107, %2
  br i1 %.not30, label %110, label %108

108:                                              ; preds = %61, %106
  %.lcssa14 = phi i64 [ %84, %106 ], [ %6, %61 ]
  %.lcssa6 = phi i64 [ %85, %106 ], [ %7, %61 ]
  %109 = add i64 %.lcssa14, 1
  br label %.loopexit

110:                                              ; preds = %106
  %111 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %107
...
119:                                              ; preds = %104
  %120 = icmp samesign ult i8 %89, -16
  br i1 %120, label %121, label %138

121:                                              ; preds = %119
  %122 = add nuw nsw i64 %86, 2
  %.not27 = icmp slt i64 %122, %2
  br i1 %.not27, label %125, label %123

123:                                              ; preds = %46, %121
  %.lcssa13 = phi i64 [ %84, %121 ], [ %6, %46 ]
  %.lcssa5 = phi i64 [ %85, %121 ], [ %7, %46 ]
  %124 = add i64 %.lcssa13, 1
  br label %.loopexit

125:                                              ; preds = %121
  %126 = add nuw nsw i64 %86, 1
  %127 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %126
  %128 = load i8, ptr %127, align 1
  %129 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %122
  %130 = load i8, ptr %129, align 1
  %131 = icmp slt i8 %128, -64
  %132 = icmp slt i8 %130, -64
  %or.cond = select i1 %131, i1 %132, i1 false
  br i1 %or.cond, label %133, label %136

133:                                              ; preds = %125
  %134 = add i64 %85, 1
  %135 = add nuw i64 %86, 3
  br label %94
...
138:                                              ; preds = %119
  %139 = icmp samesign ult i8 %89, -11
  br i1 %139, label %140, label %164

140:                                              ; preds = %138
  %141 = add nuw i64 %86, 3
  %.not23 = icmp slt i64 %141, %2
  br i1 %.not23, label %144, label %142

142:                                              ; preds = %24, %140
  %.lcssa9 = phi i64 [ %84, %140 ], [ %6, %24 ]
  %.lcssa1 = phi i64 [ %85, %140 ], [ %7, %24 ]
  %143 = add i64 %.lcssa9, 1
  br label %.loopexit

144:                                              ; preds = %140
  %145 = add nuw nsw i64 %86, 1
  %.not24 = icmp slt i64 %145, %2
  br i1 %.not24, label %146, label %odessy.chk1, !prof !45

146:                                              ; preds = %144
  %147 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %145
  %148 = load i8, ptr %147, align 1
  %149 = add nuw nsw i64 %86, 2
  %.not25 = icmp slt i64 %149, %2
  br i1 true, label %150, label %odessy.chk2, !prof !45

150:                                              ; preds = %146
  %.not26 = icmp ult i64 %141, %2
  br i1 true, label %151, label %odessy.chk3, !prof !45

151:                                              ; preds = %150
  %152 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %149
  %153 = load i8, ptr %152, align 1
  %154 = getelementptr inbounds nuw %Ts5UInt8V, ptr %4, i64 %141
  %155 = load i8, ptr %154, align 1
  %156 = icmp slt i8 %148, -64
  %157 = icmp slt i8 %153, -64
  %or.cond9 = select i1 %156, i1 %157, i1 false
  %158 = icmp slt i8 %155, -64
  %or.cond11 = select i1 %or.cond9, i1 %158, i1 false
  br i1 %or.cond11, label %159, label %162

159:                                              ; preds = %151
  %160 = add i64 %85, 1
  %161 = add nuw i64 %86, 4
  br label %94
...
.loopexit.loopexit:                               ; preds = %78, %94
  %.lcssa17 = phi i64 [ %95, %94 ], [ %79, %78 ]
  %.lcssa16 = phi i64 [ %96, %94 ], [ %80, %78 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %142, %123, %108, %entry
  %167 = phi i64 [ %143, %142 ], [ %124, %123 ], [ %109, %108 ], [ 0, %entry ], [ %.lcssa17, %.loopexit.loopexit ]
  %168 = phi i64 [ %.lcssa1, %142 ], [ %.lcssa5, %123 ], [ %.lcssa6, %108 ], [ 0, %entry ], [ %.lcssa16, %.loopexit.loopexit ]
  %169 = insertvalue { i64, i64 } undef, i64 %168, 0
  %170 = insertvalue { i64, i64 } %169, i64 %167, 1
  ret { i64, i64 } %170
...
odessy.chk:                                       ; preds = %5, %83
  call void @odessy.chk(i32 9)
  unreachable

odessy.chk1:                                      ; preds = %144
  call void @odessy.chk(i32 10)
  unreachable

odessy.chk2:                                      ; preds = %28, %146
  call void @odessy.chk(i32 11)
  unreachable

odessy.chk3:                                      ; preds = %32, %150
  call void @odessy.chk(i32 12)
  unreachable

odessy.fasttrap:                                  ; preds = %26
