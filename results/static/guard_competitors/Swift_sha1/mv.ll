...
246:                                              ; preds = %258, %scalar.ph
  ...
  br i1 true, label %251, label %odessy.chk5, !prof !45

251:                                              ; preds = %246
  %252 = or disjoint i64 %250, 1
  %.not92 = icmp samesign ult i64 %252, %224
  br i1 true, label %253, label %odessy.chk6, !prof !45

253:                                              ; preds = %251
  %254 = or disjoint i64 %250, 2
  %.not93 = icmp samesign ult i64 %254, %224
  br i1 true, label %255, label %odessy.chk7, !prof !45

255:                                              ; preds = %253
  %256 = or disjoint i64 %250, 3
  %.not138 = icmp samesign ult i64 %256, %224
  br i1 true, label %257, label %odessy.chk8, !prof !45
