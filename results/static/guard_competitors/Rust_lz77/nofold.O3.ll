; ModuleID = 'results/static/guard_competitors/Rust_lz77/nofold.ll'
...
bb22.i:                                           ; preds = %bb17.i, %bb12.i, %bb10.i
  %len.sroa.0.1.i = phi i64 [ 255, %bb17.i ], [ %len.sroa.0.0.i, %bb12.i ], [ %4, %bb10.i ]
...
bb2:                                              ; preds = %start, %bb2
  ...
  %x.sroa.0.08 = phi i32 [ %5, %bb2 ], [ 123456789, %start ]
  %_7 = mul i32 %x.sroa.0.08, 1664525
  %5 = add i32 %_7, 1013904223
  %_8 = lshr i32 %5, 24
  %_10 = getelementptr inbounds nuw i8, ptr %1, i64 %k.sroa.0.09
  %6 = trunc nuw i32 %_8 to i8
  store i8 %6, ptr %_10, align 1
