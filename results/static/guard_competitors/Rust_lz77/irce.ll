; ModuleID = 'results/static/guard_competitors/Rust_lz77/tag.ll'
...
@alloc_8e3b5f3c2a23f456534f514f92877ad7 = private unnamed_addr constant [58 x i8] c"/Users/ebrah/Project/compiler/ODeSSy/native_bench/lz77.rs\00", align 1
@alloc_5c0687b868b3f12cb3b74594c35f93db = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc_8e3b5f3c2a23f456534f514f92877ad7, [16 x i8] c"9\00\00\00\00\00\00\00\1D\00\00\00\0D\00\00\00" }>, align 8
@alloc_278d8739bcf550b0c22f43aba37e4875 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc_8e3b5f3c2a23f456534f514f92877ad7, [16 x i8] c"9\00\00\00\00\00\00\00\1E\00\00\00\0D\00\00\00" }>, align 8
@alloc_32c6d04ec2c9e657f1fdf443aac2dce6 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc_8e3b5f3c2a23f456534f514f92877ad7, [16 x i8] c"9\00\00\00\00\00\00\00\11\00\00\00\22\00\00\00" }>, align 8
...
start:
  ...
  tail call fastcc void @_RINvNtNtCsa9BKTri5B3M_3std3sys9backtrace28___rust_begin_short_backtraceFEuuECs6gprlvleZk8_4lz77(ptr noundef nonnull %_4) #12
  ret i32 0
}
...
start:
  ...
  tail call fastcc void @_RINvNtNtCsa9BKTri5B3M_3std3sys9backtrace28___rust_begin_short_backtraceFEuuECs6gprlvleZk8_4lz77(ptr noundef nonnull readonly %0) #12, !noalias !5
  ret i32 0
}
...
start:
  ...
  %1 = tail call noundef dereferenceable_or_null(65536) ptr @_RNvCs9wFQrvczXsK_7___rustc19___rust_alloc_zeroed(i64 noundef 65536, i64 noundef 1) #12, !noalias !8
  %2 = icmp eq ptr %1, null
  br i1 %2, label %bb6.i, label %bb2.preheader, !prof !13

bb2.preheader:                                    ; preds = %start
  br label %bb2

bb6.i:                                            ; preds = %start
  tail call void @_RNvNtCslJsSqIQKwiA_5alloc7raw_vec12handle_error(i64 noundef 1, i64 65536) #13, !noalias !14
  unreachable
...
bb4:                                              ; preds = %bb2
  ...
  br i1 %_542.i, label %bb2.i.preheader, label %_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit

bb2.i.preheader:                                  ; preds = %bb4
  br label %bb2.i

bb2.i:                                            ; preds = %bb2.i.preheader, %bb33.i
  %matches.sroa.0.044.i = phi i64 [ %matches.sroa.0.1.i, %bb33.i ], [ 0, %bb2.i.preheader ]
  %i.sroa.0.043.i = phi i64 [ %i.sroa.0.1.i, %bb33.i ], [ 1, %bb2.i.preheader ]
...
bb9.preheader.i:                                  ; preds = %bb22.i, %bb9.preheader.preheader.i
  ...
  %smin = call i64 @llvm.smin.i64(i64 %start1.sroa.0.141.i, i64 0)
  %5 = mul i64 %smin, -1
  %exit.preloop.at = call i64 @llvm.umin.i64(i64 %5, i64 255)
  %smin1 = call i64 @llvm.smin.i64(i64 %_14.1, i64 %start1.sroa.0.141.i)
  %6 = sub i64 %_14.1, %smin1
  %exit.mainloop.at = call i64 @llvm.umin.i64(i64 %6, i64 255)
  %7 = icmp ult i64 0, %exit.preloop.at
  br i1 %7, label %bb10.i.preloop.preheader, label %preloop.pseudo.exit

bb10.i.preloop.preheader:                         ; preds = %bb9.preheader.i
  br label %bb10.i.preloop

bb27.i:                                           ; preds = %bb22.i
  %spec.select.i.lcssa = phi i64 [ %spec.select.i, %bb22.i ]
  %_42.i = icmp ugt i64 %spec.select.i.lcssa, 2
...
bb33.i:                                           ; preds = %bb30.i, %bb32.i
  ...
  br i1 %_5.i, label %bb2.i, label %_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit.loopexit

bb30.i:                                           ; preds = %bb28.i
  %_44.0.i = add nuw i64 %matches.sroa.0.044.i, 1
  %_45.0.i = add i64 %spec.select.i.lcssa, %i.sroa.0.043.i
  %_45.1.i = icmp ult i64 %_45.0.i, %i.sroa.0.043.i
  br i1 %_45.1.i, label %odessy.chk1, label %bb33.i

panic3.i:                                         ; No predecessors!
  call void @_RNvNtNtCsgtPOCBgevO_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_5c0687b868b3f12cb3b74594c35f93db) #13, !noalias !15
  unreachable

panic4.i:                                         ; No predecessors!
  call void @_RNvNtNtCsgtPOCBgevO_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_278d8739bcf550b0c22f43aba37e4875) #13, !noalias !15
  unreachable

mainloop:                                         ; preds = %preloop.pseudo.exit
  %8 = icmp ult i64 %indvar.end, %exit.mainloop.at
  br i1 %8, label %bb10.i.preheader, label %main.pseudo.exit

bb10.i.preheader:                                 ; preds = %mainloop
  br label %bb10.i

bb10.i:                                           ; preds = %bb10.i.preheader, %bb17.i
  %len.sroa.0.0.i = phi i64 [ %_35.0.i, %bb17.i ], [ %len.sroa.0.0.i.preloop.copy, %bb10.i.preheader ]
  %exitcond.not.i = icmp ne i64 %len.sroa.0.0.i, %4
  br i1 %exitcond.not.i, label %bb12.i, label %bb22.i.loopexit6

bb22.i.loopexit:                                  ; preds = %bb10.i.preloop, %bb13.i.preloop
  %len.sroa.0.1.i.ph = phi i64 [ %len.sroa.0.0.i.preloop, %bb13.i.preloop ], [ %4, %bb10.i.preloop ]
  br label %bb22.i

bb22.i.loopexit3:                                 ; preds = %bb10.i.postloop, %bb13.i.postloop, %bb17.i.postloop
  %len.sroa.0.1.i.ph4 = phi i64 [ %4, %bb10.i.postloop ], [ 255, %bb17.i.postloop ], [ %len.sroa.0.0.i.postloop, %bb13.i.postloop ]
  br label %bb22.i

bb22.i.loopexit6:                                 ; preds = %bb10.i, %bb13.i
  %len.sroa.0.1.i.ph7 = phi i64 [ %4, %bb10.i ], [ %len.sroa.0.0.i, %bb13.i ]
  br label %bb22.i

bb22.i:                                           ; preds = %bb22.i.loopexit6, %bb22.i.loopexit3, %bb22.i.loopexit, %main.exit.selector, %preloop.exit.selector
  %len.sroa.0.1.i = phi i64 [ 255, %main.exit.selector ], [ %len.sroa.0.1.i.ph, %bb22.i.loopexit ], [ %len.sroa.0.1.i.ph4, %bb22.i.loopexit3 ], [ 255, %preloop.exit.selector ], [ %len.sroa.0.1.i.ph7, %bb22.i.loopexit6 ]
...
bb12.i:                                           ; preds = %bb10.i
  %_27.0.i = add nuw nsw i64 %len.sroa.0.0.i, %start1.sroa.0.141.i
  %_28.i = icmp ult i64 %_27.0.i, %_14.1
  br i1 true, label %bb13.i, label %odessy.chk2.loopexit8

bb13.i:                                           ; preds = %bb12.i
  %9 = getelementptr inbounds nuw i8, ptr %_14.0, i64 %_27.0.i
  %_23.i = load i8, ptr %9, align 1, !alias.scope !15, !noundef !4
  ...
  br i1 %_22.i, label %bb17.i, label %bb22.i.loopexit6

panic7.i:                                         ; No predecessors!
  %umax47.i = call i64 @llvm.umax.i64(i64 range(i64 0, -9223372036854775808) %_14.1, i64 poison)
  call void @_RNvNtCsgtPOCBgevO_4core9panicking18panic_bounds_check(i64 noundef %umax47.i, i64 noundef range(i64 0, -9223372036854775808) %_14.1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_32c6d04ec2c9e657f1fdf443aac2dce6) #13, !noalias !15
  unreachable

bb17.i:                                           ; preds = %bb13.i
  %_35.0.i = add nuw nsw i64 %len.sroa.0.0.i, 1
  %exitcond48.i = icmp eq i64 %_35.0.i, 255
  %10 = icmp ult i64 %_35.0.i, %exit.mainloop.at
  %11 = xor i1 %10, true
  br i1 %11, label %main.exit.selector, label %bb10.i

main.exit.selector:                               ; preds = %bb17.i
  %_35.0.i.lcssa = phi i64 [ %_35.0.i, %bb17.i ]
  %12 = icmp ult i64 %_35.0.i.lcssa, 255
  br i1 %12, label %main.pseudo.exit, label %bb22.i

main.pseudo.exit:                                 ; preds = %main.exit.selector, %mainloop
  %len.sroa.0.0.i.copy = phi i64 [ %len.sroa.0.0.i.preloop.copy, %mainloop ], [ %_35.0.i.lcssa, %main.exit.selector ]
  %indvar.end2 = phi i64 [ %indvar.end, %mainloop ], [ %_35.0.i.lcssa, %main.exit.selector ]
  br label %postloop

_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit.loopexit: ; preds = %bb33.i
  %matches.sroa.0.1.i.lcssa = phi i64 [ %matches.sroa.0.1.i, %bb33.i ]
  br label %_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit

_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit: ; preds = %_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit.loopexit, %bb4
  %matches.sroa.0.0.lcssa.i = phi i64 [ 0, %bb4 ], [ %matches.sroa.0.1.i.lcssa, %_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VechEECs6gprlvleZk8_4lz77.exit.loopexit ]
  ...
  call void @_RNvCs9wFQrvczXsK_7___rustc14___rust_dealloc(ptr noundef nonnull %1, i64 noundef 65536, i64 noundef range(i64 1, -9223372036854775807) 1) #12
  ret void

bb2:                                              ; preds = %bb2.preheader, %bb2
  %k.sroa.0.09 = phi i64 [ %_12.0, %bb2 ], [ 0, %bb2.preheader ]
  %x.sroa.0.08 = phi i32 [ %13, %bb2 ], [ 123456789, %bb2.preheader ]
  %_7 = mul i32 %x.sroa.0.08, 1664525
  %13 = add i32 %_7, 1013904223
  %_8 = lshr i32 %13, 24
  %_10 = getelementptr inbounds nuw i8, ptr %1, i64 %k.sroa.0.09
  %14 = trunc nuw i32 %_8 to i8
  store i8 %14, ptr %_10, align 1
...
odessy.chk2.loopexit:                             ; preds = %bb12.i.preloop
  br label %odessy.chk2

odessy.chk2.loopexit5:                            ; preds = %bb12.i.postloop
  br label %odessy.chk2

odessy.chk2.loopexit8:                            ; preds = %bb12.i
  br label %odessy.chk2

odessy.chk2:                                      ; preds = %odessy.chk2.loopexit8, %odessy.chk2.loopexit5, %odessy.chk2.loopexit
  call void @odessy.chk(i32 2)
  unreachable

bb10.i.preloop:                                   ; preds = %bb10.i.preloop.preheader, %bb17.i.preloop
  %len.sroa.0.0.i.preloop = phi i64 [ %_35.0.i.preloop, %bb17.i.preloop ], [ 0, %bb10.i.preloop.preheader ]
  %exitcond.not.i.preloop = icmp ne i64 %len.sroa.0.0.i.preloop, %4
  br i1 %exitcond.not.i.preloop, label %bb12.i.preloop, label %bb22.i.loopexit
...
bb12.i.preloop:                                   ; preds = %bb10.i.preloop
  ...
  br i1 %_28.i.preloop, label %bb13.i.preloop, label %odessy.chk2.loopexit

bb13.i.preloop:                                   ; preds = %bb12.i.preloop
  %15 = getelementptr inbounds nuw i8, ptr %_14.0, i64 %_27.0.i.preloop
  %_23.i.preloop = load i8, ptr %15, align 1, !alias.scope !15, !noundef !4
  ...
  br i1 %_22.i.preloop, label %bb17.i.preloop, label %bb22.i.loopexit

bb17.i.preloop:                                   ; preds = %bb13.i.preloop
  %_35.0.i.preloop = add nuw nsw i64 %len.sroa.0.0.i.preloop, 1
  %exitcond48.i.preloop = icmp eq i64 %_35.0.i.preloop, 255
  %16 = icmp ult i64 %_35.0.i.preloop, %exit.preloop.at
  %17 = xor i1 %16, true
  br i1 %17, label %preloop.exit.selector, label %bb10.i.preloop, !llvm.loop !18, !loop_constrainer.loop.clone !4

preloop.exit.selector:                            ; preds = %bb17.i.preloop
  %_35.0.i.preloop.lcssa = phi i64 [ %_35.0.i.preloop, %bb17.i.preloop ]
  %18 = icmp ult i64 %_35.0.i.preloop.lcssa, 255
  br i1 %18, label %preloop.pseudo.exit, label %bb22.i

preloop.pseudo.exit:                              ; preds = %preloop.exit.selector, %bb9.preheader.i
  %len.sroa.0.0.i.preloop.copy = phi i64 [ 0, %bb9.preheader.i ], [ %_35.0.i.preloop.lcssa, %preloop.exit.selector ]
  %indvar.end = phi i64 [ 0, %bb9.preheader.i ], [ %_35.0.i.preloop.lcssa, %preloop.exit.selector ]
  br label %mainloop

postloop:                                         ; preds = %main.pseudo.exit
  br label %bb10.i.postloop

bb10.i.postloop:                                  ; preds = %postloop, %bb17.i.postloop
  %len.sroa.0.0.i.postloop = phi i64 [ %_35.0.i.postloop, %bb17.i.postloop ], [ %len.sroa.0.0.i.copy, %postloop ]
  %exitcond.not.i.postloop = icmp ne i64 %len.sroa.0.0.i.postloop, %4
  br i1 %exitcond.not.i.postloop, label %bb12.i.postloop, label %bb22.i.loopexit3
...
bb12.i.postloop:                                  ; preds = %bb10.i.postloop
  ...
  br i1 %_28.i.postloop, label %bb13.i.postloop, label %odessy.chk2.loopexit5

bb13.i.postloop:                                  ; preds = %bb12.i.postloop
  %19 = getelementptr inbounds nuw i8, ptr %_14.0, i64 %_27.0.i.postloop
  %_23.i.postloop = load i8, ptr %19, align 1, !alias.scope !15, !noundef !4
  ...
  br i1 %_22.i.postloop, label %bb17.i.postloop, label %bb22.i.loopexit3
...
bb17.i.postloop:                                  ; preds = %bb13.i.postloop
  ...
  br i1 %exitcond48.i.postloop, label %bb22.i.loopexit3, label %bb10.i.postloop, !llvm.loop !23, !loop_constrainer.loop.clone !4
}
...
declare void @_RNvNtNtCsgtPOCBgevO_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24)) unnamed_addr #6
...
attributes #6 = { cold noinline noreturn nounwind "frame-pointer"="non-leaf" "probe-stack"="inline-asm" "target-cpu"="apple-m1" }
