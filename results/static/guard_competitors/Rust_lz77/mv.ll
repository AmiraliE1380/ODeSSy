...
bb10.i:                                           ; preds = %bb17.i, %bb9.preheader.i
  %len.sroa.0.0.i = phi i64 [ %_35.0.i, %bb17.i ], [ 0, %bb9.preheader.i ]
  %exitcond.not.i = icmp eq i64 %len.sroa.0.0.i, %4
  br i1 %exitcond.not.i, label %bb22.i, label %bb12.i

bb22.i:                                           ; preds = %bb17.i, %bb13.i, %bb10.i
  %len.sroa.0.1.i = phi i64 [ 255, %bb17.i ], [ %len.sroa.0.0.i, %bb13.i ], [ %4, %bb10.i ]
...
bb12.i:                                           ; preds = %bb10.i
  ...
  br i1 true, label %bb13.i, label %odessy.chk2

bb13.i:                                           ; preds = %bb12.i
  %5 = getelementptr inbounds nuw i8, ptr %_14.0, i64 %_27.0.i
  %_23.i = load i8, ptr %5, align 1, !alias.scope !15, !noundef !4
...
panic7.i:                                         ; No predecessors!
  %umax47.i = call i64 @llvm.umax.i64(i64 range(i64 0, -9223372036854775808) %_14.1, i64 %start1.sroa.0.141.i)
...
bb17.i:                                           ; preds = %bb13.i
  ...
  br i1 %exitcond48.i, label %bb22.i, label %bb10.i
...
bb2:                                              ; preds = %bb2, %start
  ...
  %x.sroa.0.08 = phi i32 [ %6, %bb2 ], [ 123456789, %start ]
  %_7 = mul i32 %x.sroa.0.08, 1664525
  %6 = add i32 %_7, 1013904223
  %_8 = lshr i32 %6, 24
  %_10 = getelementptr inbounds nuw i8, ptr %1, i64 %k.sroa.0.09
  %7 = trunc nuw i32 %_8 to i8
  store i8 %7, ptr %_10, align 1
