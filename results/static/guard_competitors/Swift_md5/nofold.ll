...
.loopexit128:                                     ; preds = %92, %87, %84, %79, %73, %68, %65, %60, %55, %54, %50, %45, %42, %37, %31
...
.thread116:                                       ; preds = %184, %179, %176, %171, %167, %163, %158, %155, %150, %145, %143, %137, %132, %129, %124, %119, %.loopexit128
  %.sroa.0.1120 = phi i64 [ 0, %119 ], [ 0, %143 ], [ 0, %145 ], [ 0, %167 ], [ %32, %.loopexit128 ], [ 0, %171 ], [ %185, %184 ], [ 0, %179 ], [ 0, %176 ], [ 0, %124 ], [ %138, %137 ], [ 0, %132 ], [ 0, %129 ], [ 0, %150 ], [ %164, %163 ], [ 0, %158 ], [ 0, %155 ]
  %.sroa.6.1119 = phi i8 [ 1, %119 ], [ 1, %143 ], [ 1, %145 ], [ 0, %167 ], [ %33, %.loopexit128 ], [ 1, %171 ], [ 0, %184 ], [ 1, %179 ], [ 1, %176 ], [ 1, %124 ], [ 0, %137 ], [ 1, %132 ], [ 1, %129 ], [ 1, %150 ], [ 0, %163 ], [ 1, %158 ], [ 1, %155 ]
...
193:                                              ; preds = %188
  ...
  br i1 %.not100, label %200, label %353
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %216
  ...
  br i1 %243, label %.loopexit121, label %216
...
244:                                              ; preds = %291, %227
  ...
  br i1 false, label %odessy.chk4, label %scalar.ph, !prof !44
...
252:                                              ; preds = %263, %scalar.ph
  ...
  br i1 true, label %257, label %odessy.chk5, !prof !45

257:                                              ; preds = %252
  %258 = or disjoint i64 %256, 1
  %.not104 = icmp samesign ult i64 %258, %224
  br i1 true, label %259, label %odessy.chk6, !prof !45

259:                                              ; preds = %257
  %260 = or disjoint i64 %256, 2
  %.not105 = icmp samesign ult i64 %260, %224
  br i1 true, label %261, label %odessy.chk7, !prof !45

261:                                              ; preds = %259
  %262 = or disjoint i64 %256, 3
  %.not158 = icmp samesign ult i64 %262, %224
  br i1 true, label %263, label %odessy.chk8, !prof !45
...
263:                                              ; preds = %261
  ...
  br i1 %283, label %.preheader, label %252, !llvm.loop !48

.preheader:                                       ; preds = %342, %263
  %284 = phi i32 [ %285, %342 ], [ %248, %263 ]
  %285 = phi i32 [ %287, %342 ], [ %245, %263 ]
  %286 = phi i32 [ %351, %342 ], [ %247, %263 ]
  %287 = phi i32 [ %286, %342 ], [ %246, %263 ]
  %288 = phi i64 [ %289, %342 ], [ 0, %263 ]
  %289 = add nuw nsw i64 %288, 1
  %290 = icmp samesign ult i64 %288, 16
  br i1 %290, label %297, label %302
...
326:                                              ; preds = %320, %314, %304, %297
  ...
  %exitcond.not = icmp eq i64 %288, %235
  br i1 %exitcond.not, label %odessy.chk9, label %329, !prof !44
...
329:                                              ; preds = %326
  ...
  %336 = add i32 %333, %335
  %exitcond194.not = icmp eq i64 %288, %236
  br i1 %exitcond194.not, label %odessy.chk10, label %337, !prof !44
...
337:                                              ; preds = %329
  ...
  br i1 %341, label %odessy.chk11, label %342, !prof !44
...
342:                                              ; preds = %337
  ...
  br i1 %352, label %291, label %.preheader

353:                                              ; preds = %193
  %354 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %354, align 8, !invariant.load !41
...
odessy.chk9:                                      ; preds = %326
  call void @odessy.chk(i32 9)
  unreachable

odessy.chk10:                                     ; preds = %329
  call void @odessy.chk(i32 10)
  unreachable

odessy.chk11:                                     ; preds = %337
