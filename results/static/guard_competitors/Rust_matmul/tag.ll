; ModuleID = 'logs/rust_triage/matmul.ll'
...
bb3.preheader.i:                                  ; preds = %bb22.i, %bb6
  ...
  %invariant.gep = getelementptr inbounds nuw i64, ptr %6, i64 %19
...
bb19.i:                                           ; preds = %bb15.i
  ...
  store i64 %_35.0.i, ptr %gep, align 8, !alias.scope !36, !noalias !38
...
bb7.i:                                            ; preds = %bb15.i, %bb5.preheader.i
  ...
  %_22.0.i = add nuw nsw i64 %k.sroa.0.033.i, %19
  %_24.i = icmp samesign ult i64 %_22.0.i, %_21.1
  br i1 %_24.i, label %bb9.i, label %odessy.chk

bb9.i:                                            ; preds = %bb7.i
  %20 = shl nuw nsw i64 %k.sroa.0.033.i, 6
  %_31.0.i = add nuw nsw i64 %20, %j.sroa.0.035.i
  %_33.i = icmp samesign ult i64 %_31.0.i, %_23.1
  br i1 %_33.i, label %bb12.i, label %odessy.chk1

panic7.i:                                         ; No predecessors!
  %umax.i = call i64 @llvm.umax.i64(i64 range(i64 0, 1152921504606846976) %_21.1, i64 %indvars.iv.i)
...
bb12.i:                                           ; preds = %bb9.i
  %21 = getelementptr inbounds nuw i64, ptr %_21.0, i64 %_22.0.i
  %_16.i = load i64, ptr %21, align 8, !alias.scope !31, !noalias !40, !noundef !4
  %22 = getelementptr inbounds nuw i64, ptr %_23.0, i64 %_31.0.i
  %_25.i = load i64, ptr %22, align 8, !alias.scope !34, !noalias !41, !noundef !4
  %23 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %_16.i, i64 %_25.i)
  %_34.1.i = extractvalue { i64, i1 } %23, 1
  br i1 %_34.1.i, label %odessy.chk2, label %bb13.i

panic10.i:                                        ; No predecessors!
  call void @_RNvNtCsgtPOCBgevO_4core9panicking18panic_bounds_check(i64 noundef %_31.0.i, i64 noundef range(i64 0, 1152921504606846976) %_23.1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_082365f196abad5dc92e35811f7f83b4) #13, !noalias !39
  unreachable

bb13.i:                                           ; preds = %bb12.i
  %_34.0.i = extractvalue { i64, i1 } %23, 0
  %24 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %acc.sroa.0.034.i, i64 %_34.0.i)
  %_35.1.i = extractvalue { i64, i1 } %24, 1
...
bb15.i:                                           ; preds = %bb13.i
  %_35.0.i = extractvalue { i64, i1 } %24, 0
...
bb21:                                             ; preds = %bb22.i
  ...
  %25 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %_30, i64 %_32)
  %_34.1 = extractvalue { i64, i1 } %25, 1
...
_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VecxEECslKexJZJvg6E_6matmul.exit25: ; preds = %bb21
  %_34.0 = extractvalue { i64, i1 } %25, 0
