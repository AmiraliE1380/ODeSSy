...
vector.body:                                      ; preds = %vector.body, %_RINvXs_NtNtCslJsSqIQKwiA_5alloc3vec14spec_from_elemxNtB5_12SpecFromElem9from_elemNtNtB9_5alloc6GlobalECslKexJZJvg6E_6matmul.exit17
...
bb6:                                              ; preds = %vector.body
  ...
  %mv.h = icmp ugt i64 %_21.1, 4095
  %mv.h1 = icmp ugt i64 %_23.1, 4095
  %mv.h2 = and i1 %mv.h, %mv.h1
  br i1 %mv.h2, label %bb3.preheader.i.mv.ph.mv.fast, label %bb3.preheader.i.mv.ph

bb3.preheader.i.mv.ph.mv.fast:                    ; preds = %bb6
  br label %bb3.preheader.i.mv.fast

bb3.preheader.i.mv.fast:                          ; preds = %bb22.i.mv.fast, %bb3.preheader.i.mv.ph.mv.fast
  %indvars.iv.i.mv.fast = phi i64 [ 0, %bb3.preheader.i.mv.ph.mv.fast ], [ %indvars.iv.next.i.mv.fast, %bb22.i.mv.fast ]
  %i.sroa.0.036.i.mv.fast = phi i64 [ 0, %bb3.preheader.i.mv.ph.mv.fast ], [ %_46.0.i.mv.fast, %bb22.i.mv.fast ]
  %19 = shl nuw nsw i64 %i.sroa.0.036.i.mv.fast, 6
  %invariant.gep.mv.fast = getelementptr inbounds nuw i64, ptr %6, i64 %19
  br label %bb5.preheader.i.mv.fast

bb5.preheader.i.mv.fast:                          ; preds = %bb19.i.mv.fast, %bb3.preheader.i.mv.fast
  %j.sroa.0.035.i.mv.fast = phi i64 [ 0, %bb3.preheader.i.mv.fast ], [ %_45.0.i.mv.fast, %bb19.i.mv.fast ]
  br label %bb7.i.mv.fast

bb7.i.mv.fast:                                    ; preds = %bb15.i.mv.fast, %bb5.preheader.i.mv.fast
  %acc.sroa.0.034.i.mv.fast = phi i64 [ 0, %bb5.preheader.i.mv.fast ], [ %_35.0.i.mv.fast, %bb15.i.mv.fast ]
  %k.sroa.0.033.i.mv.fast = phi i64 [ 0, %bb5.preheader.i.mv.fast ], [ %_36.0.i.mv.fast, %bb15.i.mv.fast ]
  %_22.0.i.mv.fast = add nuw nsw i64 %k.sroa.0.033.i.mv.fast, %19
  %_24.i.mv.fast = icmp samesign ult i64 %_22.0.i.mv.fast, %_21.1
  br i1 %_24.i.mv.fast, label %bb9.i.mv.fast, label %odessy.fasttrap

bb9.i.mv.fast:                                    ; preds = %bb7.i.mv.fast
  %20 = shl nuw nsw i64 %k.sroa.0.033.i.mv.fast, 6
  %_31.0.i.mv.fast = add nuw nsw i64 %20, %j.sroa.0.035.i.mv.fast
  %_33.i.mv.fast = icmp samesign ult i64 %_31.0.i.mv.fast, %_23.1
  br i1 %_33.i.mv.fast, label %bb12.i.mv.fast, label %odessy.fasttrap3

bb12.i.mv.fast:                                   ; preds = %bb9.i.mv.fast
  %21 = getelementptr inbounds nuw i64, ptr %_21.0, i64 %_22.0.i.mv.fast
  %_16.i.mv.fast = load i64, ptr %21, align 8, !alias.scope !31, !noalias !38, !noundef !4
  %22 = getelementptr inbounds nuw i64, ptr %_23.0, i64 %_31.0.i.mv.fast
  %_25.i.mv.fast = load i64, ptr %22, align 8, !alias.scope !34, !noalias !39, !noundef !4
  %23 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %_16.i.mv.fast, i64 %_25.i.mv.fast)
  %_34.1.i.mv.fast = extractvalue { i64, i1 } %23, 1
  br i1 %_34.1.i.mv.fast, label %odessy.chk2, label %bb13.i.mv.fast

bb13.i.mv.fast:                                   ; preds = %bb12.i.mv.fast
  %_34.0.i.mv.fast = extractvalue { i64, i1 } %23, 0
  %24 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %acc.sroa.0.034.i.mv.fast, i64 %_34.0.i.mv.fast)
  %_35.1.i.mv.fast = extractvalue { i64, i1 } %24, 1
  br i1 %_35.1.i.mv.fast, label %odessy.chk3, label %bb15.i.mv.fast

bb15.i.mv.fast:                                   ; preds = %bb13.i.mv.fast
  %_35.0.i.mv.fast = extractvalue { i64, i1 } %24, 0
  %_36.0.i.mv.fast = add nuw nsw i64 %k.sroa.0.033.i.mv.fast, 1
  %exitcond.not.i.mv.fast = icmp eq i64 %_36.0.i.mv.fast, 64
  br i1 %exitcond.not.i.mv.fast, label %bb19.i.mv.fast, label %bb7.i.mv.fast

bb19.i.mv.fast:                                   ; preds = %bb15.i.mv.fast
  %_35.0.i.lcssa.mv.fast = phi i64 [ %_35.0.i.mv.fast, %bb15.i.mv.fast ]
  %gep.mv.fast = getelementptr inbounds nuw i64, ptr %invariant.gep.mv.fast, i64 %j.sroa.0.035.i.mv.fast
  store i64 %_35.0.i.lcssa.mv.fast, ptr %gep.mv.fast, align 8, !alias.scope !36, !noalias !40
  %_45.0.i.mv.fast = add nuw nsw i64 %j.sroa.0.035.i.mv.fast, 1
  %exitcond45.not.i.mv.fast = icmp eq i64 %_45.0.i.mv.fast, 64
  br i1 %exitcond45.not.i.mv.fast, label %bb22.i.mv.fast, label %bb5.preheader.i.mv.fast

bb22.i.mv.fast:                                   ; preds = %bb19.i.mv.fast
  %_46.0.i.mv.fast = add nuw nsw i64 %i.sroa.0.036.i.mv.fast, 1
  %indvars.iv.next.i.mv.fast = add nuw nsw i64 %indvars.iv.i.mv.fast, 64
  %exitcond46.not.i.mv.fast = icmp eq i64 %_46.0.i.mv.fast, 64
  br i1 %exitcond46.not.i.mv.fast, label %bb21, label %bb3.preheader.i.mv.fast

bb3.preheader.i.mv.ph:                            ; preds = %bb6
  br label %bb3.preheader.i

bb3.preheader.i:                                  ; preds = %bb22.i, %bb3.preheader.i.mv.ph
  %indvars.iv.i = phi i64 [ 0, %bb3.preheader.i.mv.ph ], [ %indvars.iv.next.i, %bb22.i ]
  %i.sroa.0.036.i = phi i64 [ 0, %bb3.preheader.i.mv.ph ], [ %_46.0.i, %bb22.i ]
  %25 = shl nuw nsw i64 %i.sroa.0.036.i, 6
  %invariant.gep = getelementptr inbounds nuw i64, ptr %6, i64 %25
...
bb19.i:                                           ; preds = %bb15.i
  %_35.0.i.lcssa = phi i64 [ %_35.0.i, %bb15.i ]
  %gep = getelementptr inbounds nuw i64, ptr %invariant.gep, i64 %j.sroa.0.035.i
  store i64 %_35.0.i.lcssa, ptr %gep, align 8, !alias.scope !36, !noalias !40
...
bb7.i:                                            ; preds = %bb15.i, %bb5.preheader.i
  %acc.sroa.0.034.i = phi i64 [ 0, %bb5.preheader.i ], [ %_35.0.i, %bb15.i ]
  %k.sroa.0.033.i = phi i64 [ 0, %bb5.preheader.i ], [ %_36.0.i, %bb15.i ]
  %_22.0.i = add nuw nsw i64 %k.sroa.0.033.i, %25
  %_24.i = icmp samesign ult i64 %_22.0.i, %_21.1
  br i1 %_24.i, label %bb9.i, label %odessy.chk

bb9.i:                                            ; preds = %bb7.i
  %26 = shl nuw nsw i64 %k.sroa.0.033.i, 6
  %_31.0.i = add nuw nsw i64 %26, %j.sroa.0.035.i
...
panic7.i:                                         ; No predecessors!
  ...
  call void @_RNvNtCsgtPOCBgevO_4core9panicking18panic_bounds_check(i64 noundef %umax.i, i64 noundef range(i64 0, 1152921504606846976) %_21.1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_9035f73269ad9d6a04233d91aa1930d9) #13, !noalias !41
  unreachable

bb12.i:                                           ; preds = %bb9.i
  %27 = getelementptr inbounds nuw i64, ptr %_21.0, i64 %_22.0.i
  %_16.i = load i64, ptr %27, align 8, !alias.scope !31, !noalias !38, !noundef !4
  %28 = getelementptr inbounds nuw i64, ptr %_23.0, i64 %_31.0.i
...
panic10.i:                                        ; No predecessors!
  call void @_RNvNtCsgtPOCBgevO_4core9panicking18panic_bounds_check(i64 noundef poison, i64 noundef range(i64 0, 1152921504606846976) %_23.1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_082365f196abad5dc92e35811f7f83b4) #13, !noalias !41
  unreachable
...
panic11.i:                                        ; No predecessors!
  call void @_RNvNtNtCsgtPOCBgevO_4core9panicking11panic_const24panic_const_mul_overflow(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_9035f73269ad9d6a04233d91aa1930d9) #13, !noalias !41
  unreachable

panic12.i:                                        ; No predecessors!
  call void @_RNvNtNtCsgtPOCBgevO_4core9panicking11panic_const24panic_const_add_overflow(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_a4389962baf420946623ad87f953b8a3) #13, !noalias !41
  unreachable
...
bb15.i:                                           ; preds = %bb13.i
  ...
  br i1 %exitcond.not.i, label %bb19.i, label %bb7.i

bb21:                                             ; preds = %bb22.i.mv.fast, %bb22.i
...
odessy.chk:                                       ; preds = %bb7.i
  call void @odessy.chk(i32 0)
  unreachable

odessy.chk1:                                      ; preds = %bb9.i
  call void @odessy.chk(i32 1)
  unreachable

odessy.chk2:                                      ; preds = %bb12.i.mv.fast, %bb12.i
  call void @odessy.chk(i32 2)
  unreachable

odessy.chk3:                                      ; preds = %bb13.i.mv.fast, %bb13.i
...
odessy.fasttrap:                                  ; preds = %bb7.i.mv.fast
  call void @odessy.fast.trap(i32 0)
  unreachable

odessy.fasttrap3:                                 ; preds = %bb9.i.mv.fast
...
; Function Attrs: cold noreturn nounwind
declare void @odessy.fast.trap(i32) #11
