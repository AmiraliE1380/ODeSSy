; ModuleID = 'results/static/guard_competitors/Rust_matmul/mv.ll'
...
bb3.preheader.i.mv.fast:                          ; preds = %bb6, %bb22.i.mv.fast
  ...
  %invariant.gep5 = getelementptr inbounds nuw [8 x i8], ptr %_21.0, i64 %19
...
bb5.preheader.i.mv.fast:                          ; preds = %bb19.i.mv.fast, %bb3.preheader.i.mv.fast
  ...
  %invariant.gep7 = getelementptr inbounds nuw [8 x i8], ptr %_23.0, i64 %j.sroa.0.035.i.mv.fast
...
bb7.i.mv.fast:                                    ; preds = %bb15.i.mv.fast, %bb5.preheader.i.mv.fast
  ...
  %gep6 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep5, i64 %k.sroa.0.033.i.mv.fast
  %_16.i.mv.fast = load i64, ptr %gep6, align 8, !alias.scope !31, !noalias !38, !noundef !4
  %.idx = shl nuw nsw i64 %k.sroa.0.033.i.mv.fast, 9
  %gep8 = getelementptr inbounds nuw i8, ptr %invariant.gep7, i64 %.idx
  %_25.i.mv.fast = load i64, ptr %gep8, align 8, !alias.scope !34, !noalias !39, !noundef !4
...
bb13.i.mv.fast:                                   ; preds = %bb7.i.mv.fast
...
odessy.chk2:                                      ; preds = %bb12.i, %bb7.i.mv.fast
