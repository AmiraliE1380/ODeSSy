; ModuleID = 'results/static/guard_competitors/Rust_matmul/nofold.ll'
...
bb6:                                              ; preds = %vector.body
  ...
  br i1 %mv.h2, label %bb3.preheader.i.mv.fast, label %bb3.preheader.i

bb3.preheader.i.mv.fast:                          ; preds = %bb6, %bb22.i.mv.fast
  %i.sroa.0.036.i.mv.fast = phi i64 [ %_46.0.i.mv.fast, %bb22.i.mv.fast ], [ 0, %bb6 ]
  %19 = shl nuw nsw i64 %i.sroa.0.036.i.mv.fast, 6
  %invariant.gep.mv.fast = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %19
  %invariant.gep13 = getelementptr inbounds nuw [8 x i8], ptr %_21.0, i64 %19
...
bb5.preheader.i.mv.fast:                          ; preds = %bb19.i.mv.fast, %bb3.preheader.i.mv.fast
  ...
  %invariant.gep15 = getelementptr inbounds nuw [8 x i8], ptr %_23.0, i64 %j.sroa.0.035.i.mv.fast
  br label %bb12.i.mv.fast

bb12.i.mv.fast:                                   ; preds = %bb15.i.mv.fast, %bb5.preheader.i.mv.fast
  ...
  %gep14 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep13, i64 %k.sroa.0.033.i.mv.fast
  %_16.i.mv.fast = load i64, ptr %gep14, align 8, !alias.scope !31, !noalias !38, !noundef !4
  %.idx = shl nuw nsw i64 %k.sroa.0.033.i.mv.fast, 9
  %gep16 = getelementptr inbounds nuw i8, ptr %invariant.gep15, i64 %.idx
  %_25.i.mv.fast = load i64, ptr %gep16, align 8, !alias.scope !34, !noalias !39, !noundef !4
  %20 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %_16.i.mv.fast, i64 %_25.i.mv.fast)
  %_34.1.i.mv.fast = extractvalue { i64, i1 } %20, 1
  br i1 %_34.1.i.mv.fast, label %odessy.chk2, label %bb13.i.mv.fast

bb13.i.mv.fast:                                   ; preds = %bb12.i.mv.fast
  %_34.0.i.mv.fast = extractvalue { i64, i1 } %20, 0
  %21 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %acc.sroa.0.034.i.mv.fast, i64 %_34.0.i.mv.fast)
  %_35.1.i.mv.fast = extractvalue { i64, i1 } %21, 1
  br i1 %_35.1.i.mv.fast, label %odessy.chk3, label %bb15.i.mv.fast

bb15.i.mv.fast:                                   ; preds = %bb13.i.mv.fast
  %_35.0.i.mv.fast = extractvalue { i64, i1 } %21, 0
  %_36.0.i.mv.fast = add nuw nsw i64 %k.sroa.0.033.i.mv.fast, 1
  %exitcond.not.i.mv.fast = icmp eq i64 %_36.0.i.mv.fast, 64
  br i1 %exitcond.not.i.mv.fast, label %bb19.i.mv.fast, label %bb12.i.mv.fast

bb19.i.mv.fast:                                   ; preds = %bb15.i.mv.fast
  %gep.mv.fast = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep.mv.fast, i64 %j.sroa.0.035.i.mv.fast
  store i64 %_35.0.i.mv.fast, ptr %gep.mv.fast, align 8, !alias.scope !36, !noalias !40
...
bb3.preheader.i:                                  ; preds = %bb6, %bb22.i
  %i.sroa.0.036.i = phi i64 [ %_46.0.i, %bb22.i ], [ 0, %bb6 ]
  %22 = shl nuw nsw i64 %i.sroa.0.036.i, 6
  %invariant.gep = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %22
...
bb19.i:                                           ; preds = %bb15.i
  ...
  store i64 %_35.0.i, ptr %gep, align 8, !alias.scope !36, !noalias !40
...
bb7.i:                                            ; preds = %bb15.i, %bb5.preheader.i
  ...
  %_22.0.i = add nuw nsw i64 %k.sroa.0.033.i, %22
  %_24.i = icmp samesign ult i64 %_22.0.i, %_21.1
  br i1 %_24.i, label %bb9.i, label %odessy.chk

bb9.i:                                            ; preds = %bb7.i
  %23 = shl nuw nsw i64 %k.sroa.0.033.i, 6
  %_31.0.i = add nuw nsw i64 %23, %j.sroa.0.035.i
  %_33.i = icmp samesign ult i64 %_31.0.i, %_23.1
  br i1 %_33.i, label %bb12.i, label %odessy.chk1

bb12.i:                                           ; preds = %bb9.i
  %24 = getelementptr inbounds nuw [8 x i8], ptr %_21.0, i64 %_22.0.i
  %_16.i = load i64, ptr %24, align 8, !alias.scope !31, !noalias !38, !noundef !4
  %25 = getelementptr inbounds nuw [8 x i8], ptr %_23.0, i64 %_31.0.i
  %_25.i = load i64, ptr %25, align 8, !alias.scope !34, !noalias !39, !noundef !4
  %26 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %_16.i, i64 %_25.i)
  %_34.1.i = extractvalue { i64, i1 } %26, 1
  br i1 %_34.1.i, label %odessy.chk2, label %bb13.i

bb13.i:                                           ; preds = %bb12.i
  %_34.0.i = extractvalue { i64, i1 } %26, 0
  %27 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %acc.sroa.0.034.i, i64 %_34.0.i)
  %_35.1.i = extractvalue { i64, i1 } %27, 1
  br i1 %_35.1.i, label %odessy.chk3, label %bb15.i

bb15.i:                                           ; preds = %bb13.i
  %_35.0.i = extractvalue { i64, i1 } %27, 0
...
bb21:                                             ; preds = %bb22.i, %bb22.i.mv.fast
  ...
  %28 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %_30, i64 %_32)
  %_34.1 = extractvalue { i64, i1 } %28, 1
...
_RINvNtCsgtPOCBgevO_4core3ptr9drop_glueINtNtCslJsSqIQKwiA_5alloc3vec3VecxEECslKexJZJvg6E_6matmul.exit25: ; preds = %bb21
  %_34.0 = extractvalue { i64, i1 } %28, 0
...
odessy.chk2:                                      ; preds = %bb12.i, %bb12.i.mv.fast
  call void @odessy.chk(i32 2)
  unreachable

odessy.chk3:                                      ; preds = %bb13.i, %bb13.i.mv.fast
