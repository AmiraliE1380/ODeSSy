; ModuleID = 'results/static/guard_competitors/Julia_lz77_bounded2/nofold.ll'
...
L31.preheader:                                    ; preds = %L80, %L31.preheader.lr.ph
  ...
  %smin19 = call i64 @llvm.smin.i64(i64 %smin, i64 255), !dbg !47
  %11 = add i64 %smin19, -1, !dbg !47
...
L31.preloop.preheader:                            ; preds = %L31.preheader
  %invariant.gep10 = getelementptr i8, ptr %invariant.gep, i64 %value_phi557, !dbg !47
...
L31:                                              ; preds = %L31.preheader5, %L75
  ...
  %.not43.not = icmp sgt i64 %16, %"data::Array.size.0.copyload", !dbg !50
  br i1 %.not43.not, label %L80, label %L69, !dbg !47
...
L75:                                              ; preds = %L69
  ...
  %exitcond.not24 = icmp eq i64 %19, %smin19, !dbg !69
  br i1 %exitcond.not24, label %main.exit.selector, label %L31, !dbg !69
...
main.pseudo.exit:                                 ; preds = %preloop.pseudo.exit, %main.exit.selector
  %value_phi7.copy = phi i64 [ %value_phi7.preloop.copy, %preloop.pseudo.exit ], [ %smin19, %main.exit.selector ]
  %21 = call i64 @llvm.smax.i64(i64 %value_phi7.copy, i64 254)
  %smax95 = add nuw nsw i64 %21, 1
  %invariant.gep14 = getelementptr i8, ptr %invariant.gep, i64 %value_phi557
  br label %L31.postloop

L80:                                              ; preds = %L35.preloop, %L31.preloop, %L69, %L31, %L75.postloop, %L35.postloop, %L31.postloop, %preloop.exit.selector, %main.exit.selector
  %value_phi25 = phi i64 [ %smin19, %main.exit.selector ], [ %smax94, %preloop.exit.selector ], [ %smax95, %L75.postloop ], [ %value_phi7, %L69 ], [ %value_phi7.postloop, %L31.postloop ], [ %value_phi7.postloop, %L35.postloop ], [ %value_phi7, %L31 ], [ %value_phi7.preloop, %L31.preloop ], [ %value_phi7.preloop, %L35.preloop ]
...
L97:                                              ; preds = %L6
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load177, i32 424, i32 16, i64 4845914096) #8, !dbg !36
...
L100:                                             ; preds = %top
  ...
  %"box::ArgumentError36" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load181, i32 424, i32 16, i64 4845914096) #8, !dbg !35
...
L31.preloop:                                      ; preds = %L31.preloop.preheader, %L75.preloop
  %value_phi7.preloop = phi i64 [ %32, %L75.preloop ], [ 0, %L31.preloop.preheader ]
  %29 = add i64 %value_phi7.preloop, %value_phi160, !dbg !48
  %.not43.preloop.not = icmp sgt i64 %29, %"data::Array.size.0.copyload", !dbg !50
  br i1 %.not43.preloop.not, label %L80, label %L35.preloop, !dbg !47

L35.preloop:                                      ; preds = %L31.preloop
  %gep11 = getelementptr i8, ptr %invariant.gep10, i64 %value_phi7.preloop, !dbg !51
  %30 = load i8, ptr %gep11, align 1, !dbg !51, !tbaa !53, !alias.scope !56, !noalias !59
  %gep64.preloop = getelementptr i8, ptr %invariant.gep, i64 %29, !dbg !51
  %31 = load i8, ptr %gep64.preloop, align 1, !dbg !51, !tbaa !53, !alias.scope !56, !noalias !59
  %.not46.preloop = icmp eq i8 %30, %31, !dbg !64
  br i1 %.not46.preloop, label %L75.preloop, label %L80, !dbg !47

L75.preloop:                                      ; preds = %L35.preloop
  %32 = add nuw nsw i64 %value_phi7.preloop, 1, !dbg !67
  %exitcond.not = icmp eq i64 %smin93, %32, !dbg !69
  br i1 %exitcond.not, label %preloop.exit.selector, label %L31.preloop, !dbg !69, !llvm.loop !83, !loop_constrainer.loop.clone !10

preloop.exit.selector:                            ; preds = %L75.preloop
  %33 = icmp sgt i64 %12, -255, !dbg !69
  br i1 %33, label %preloop.pseudo.exit, label %L80, !dbg !69
...
preloop.pseudo.exit:                              ; preds = %preloop.exit.selector, %L31.preheader
  ...
  %34 = icmp sgt i64 %smin73, %value_phi7.preloop.copy
  br i1 %34, label %L31.preheader5, label %main.pseudo.exit
...
L31.postloop:                                     ; preds = %L75.postloop, %main.pseudo.exit
  %value_phi7.postloop = phi i64 [ %38, %L75.postloop ], [ %value_phi7.copy, %main.pseudo.exit ]
  %35 = add i64 %value_phi7.postloop, %value_phi160, !dbg !48
  %.not43.postloop.not = icmp sgt i64 %35, %"data::Array.size.0.copyload", !dbg !50
  br i1 %.not43.postloop.not, label %L80, label %L35.postloop, !dbg !47

L35.postloop:                                     ; preds = %L31.postloop
  %gep = getelementptr i8, ptr %invariant.gep14, i64 %value_phi7.postloop, !dbg !51
  %36 = load i8, ptr %gep, align 1, !dbg !51, !tbaa !53, !alias.scope !56, !noalias !59
  %gep64.postloop = getelementptr i8, ptr %invariant.gep, i64 %35, !dbg !51
  %37 = load i8, ptr %gep64.postloop, align 1, !dbg !51, !tbaa !53, !alias.scope !56, !noalias !59
  %.not46.postloop = icmp eq i8 %36, %37, !dbg !64
  br i1 %.not46.postloop, label %L75.postloop, label %L80, !dbg !47

L75.postloop:                                     ; preds = %L35.postloop
  %38 = add nuw nsw i64 %value_phi7.postloop, 1, !dbg !67
  %39 = icmp samesign ult i64 %value_phi7.postloop, 254, !dbg !88
  br i1 %39, label %L31.postloop, label %L80, !dbg !69, !llvm.loop !90, !loop_constrainer.loop.clone !10
}
...
top:
  %pgcstack = call ptr inttoptr (i64 4308303644 to ptr)(i64 4308303680) #9
  ...
  %box_Int64 = call nonnull align 8 dereferenceable(8) ptr @ijl_box_int64(i64 signext %4) #10
  ret ptr %box_Int64
}
...
!89 = !DILocation(line: 472, scope: !75, inlinedAt: !69)
