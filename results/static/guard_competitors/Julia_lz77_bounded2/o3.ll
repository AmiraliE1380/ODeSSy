...
L80:                                              ; preds = %L69.preloop, %L31.preloop, %L69, %L31, %L75.postloop, %L69.postloop, %L31.postloop, %preloop.exit.selector, %main.exit.selector
  %value_phi25 = phi i64 [ %smin20, %main.exit.selector ], [ %smax94, %preloop.exit.selector ], [ %smax95, %L75.postloop ], [ %value_phi7, %L69 ], [ %value_phi7.postloop, %L31.postloop ], [ %value_phi7.postloop, %L69.postloop ], [ %value_phi7, %L31 ], [ %value_phi7.preloop, %L31.preloop ], [ %value_phi7.preloop, %L69.preloop ]
...
L31.postloop:                                     ; preds = %L75.postloop, %main.pseudo.exit
  ...
  %.not43.postloop.not = icmp sgt i64 %38, %"data::Array.size.0.copyload", !dbg !50
