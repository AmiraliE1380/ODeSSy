...
L31:                                              ; preds = %preloop.pseudo.exit, %L75
  %value_phi7 = phi i64 [ %19, %L75 ], [ %value_phi7.preloop.copy, %preloop.pseudo.exit ]
  %15 = add i64 %value_phi7, %value_phi160, !dbg !48
  %.not43.not = icmp sgt i64 %15, %"data::Array.size.0.copyload", !dbg !50
  br i1 %.not43.not, label %L80, label %L69, !dbg !47

L47:                                              ; No predecessors!
  store i64 %31, ptr %"new::Tuple27", align 8, !dbg !51, !tbaa !53, !alias.scope !55, !noalias !58
...
L66:                                              ; No predecessors!
  store i64 %9, ptr %"new::Tuple", align 8, !dbg !51, !tbaa !53, !alias.scope !55, !noalias !58
...
main.exit.selector:                               ; preds = %L75
  %21 = icmp ult i64 %value_phi7, 254, !dbg !74
  br i1 %21, label %main.pseudo.exit, label %L80, !dbg !74

main.pseudo.exit:                                 ; preds = %preloop.pseudo.exit, %main.exit.selector
  %value_phi7.copy = phi i64 [ %value_phi7.preloop.copy, %preloop.pseudo.exit ], [ %19, %main.exit.selector ]
  %22 = call i64 @llvm.smax.i64(i64 %value_phi7.copy, i64 254)
  %smax95 = add nuw nsw i64 %22, 1
  br label %L31.postloop

L80:                                              ; preds = %L75.postloop, %L69.postloop, %L31.postloop, %preloop.exit.selector, %L69.preloop, %L31.preloop, %main.exit.selector, %L69, %L31
  %value_phi25 = phi i64 [ %19, %main.exit.selector ], [ %smax94, %preloop.exit.selector ], [ %smax95, %L75.postloop ], [ %value_phi7.postloop, %L69.postloop ], [ %value_phi7.postloop, %L31.postloop ], [ %value_phi7, %L69 ], [ %value_phi7, %L31 ], [ %value_phi7.preloop, %L69.preloop ], [ %value_phi7.preloop, %L31.preloop ]
...
L31.preloop:                                      ; preds = %L75.preloop, %L31.preheader
  %value_phi7.preloop = phi i64 [ %36, %L75.preloop ], [ 0, %L31.preheader ]
  %30 = add i64 %value_phi7.preloop, %value_phi160, !dbg !48
  %.not43.preloop.not = icmp sgt i64 %30, %"data::Array.size.0.copyload", !dbg !50
...
preloop.pseudo.exit:                              ; preds = %preloop.exit.selector, %L31.preheader
  ...
  br i1 %38, label %L31, label %main.pseudo.exit
...
L31.postloop:                                     ; preds = %L75.postloop, %main.pseudo.exit
  ...
  %.not43.postloop.not = icmp sgt i64 %39, %"data::Array.size.0.copyload", !dbg !50
...
L75.postloop:                                     ; preds = %L69.postloop
  ...
  br i1 %46, label %L31.postloop, label %L80, !dbg !74, !llvm.loop !95, !loop_constrainer.loop.clone !10
