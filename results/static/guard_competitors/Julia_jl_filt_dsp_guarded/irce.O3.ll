; ModuleID = 'results/static/guard_competitors/Julia_jl_filt_dsp_guarded/irce.ll'
...
top:
  ...
  %pgcstack = tail call ptr inttoptr (i64 4299603740 to ptr)(i64 4299603776) #8
...
L46.us255.us.us.us:                               ; preds = %L288.us.us.us.us, %L46.preheader.split.split.split.us.split.us.split.us.split.us
  ...
  %exitcond.not.not = icmp eq i64 %value_phi15.us256.us.us.us, %17, !dbg !87
  br i1 %exitcond.not.not, label %odessy.chk2, label %L288.us.us.us.us, !dbg !87
...
L288.us.us.us.us:                                 ; preds = %L46.us255.us.us.us
  ...
  br i1 %.not229.not.us.us.us.us, label %L304, label %L46.us255.us.us.us, !dbg !121
...
L46.us265.us.us:                                  ; preds = %L288.us278.us.us, %L46.preheader.split.split.split.split.us.split.us.split.us
  ...
  %exitcond322.not.not = icmp eq i64 %value_phi15.us266.us.us, %29, !dbg !87
  br i1 %exitcond322.not.not, label %odessy.chk1, label %L62.us268.us.us, !dbg !87
...
L62.us268.us.us:                                  ; preds = %L46.us265.us.us
  ...
  %39 = add nuw nsw i64 %umin405, 1, !dbg !122
  %min.iters.check408 = icmp ult i64 %umin405, 12, !dbg !122
  br i1 %min.iters.check408, label %L121.us.us.us.preheader, label %vector.scevcheck377, !dbg !122
...
vector.scevcheck377:                              ; preds = %L62.us268.us.us
  ...
  %42 = or i1 %mul.overflow383, %41, !dbg !122
  br i1 %42, label %L121.us.us.us.preheader, label %vector.memcheck384
...
vector.ph409:                                     ; preds = %vector.memcheck384
  ...
  %n.vec411 = sub nuw nsw i64 %39, %44, !dbg !122
...
vector.body414:                                   ; preds = %vector.body414, %vector.ph409
  ...
  %47 = getelementptr inbounds nuw i8, ptr %46, i64 16, !dbg !124
  %48 = getelementptr inbounds nuw i8, ptr %46, i64 32, !dbg !124
  %49 = getelementptr inbounds nuw i8, ptr %46, i64 48, !dbg !124
  ...
  %51 = getelementptr inbounds nuw i8, ptr %50, i64 16, !dbg !124
  %52 = getelementptr inbounds nuw i8, ptr %50, i64 32, !dbg !124
  %53 = getelementptr inbounds nuw i8, ptr %50, i64 48, !dbg !124
  ...
  %63 = getelementptr inbounds nuw i8, ptr %62, i64 16, !dbg !124
  %64 = getelementptr inbounds nuw i8, ptr %62, i64 32, !dbg !124
  %65 = getelementptr inbounds nuw i8, ptr %62, i64 48, !dbg !124
...
scalar.ph407.loopexit:                            ; preds = %vector.body414
  %ind.end412 = add nuw nsw i64 %n.vec411, 1, !dbg !122
  br label %L121.us.us.us.preheader, !dbg !122

L121.us.us.us.preheader:                          ; preds = %scalar.ph407.loopexit, %vector.memcheck384, %vector.scevcheck377, %L62.us268.us.us
  %value_phi47.us.us.us.ph = phi i64 [ %ind.end412, %scalar.ph407.loopexit ], [ 1, %vector.memcheck384 ], [ 1, %vector.scevcheck377 ], [ 1, %L62.us268.us.us ]
  br label %L121.us.us.us, !dbg !122

L121.us.us.us:                                    ; preds = %L121.us.us.us.preheader, %L198.us.us.us
  %value_phi47.us.us.us = phi i64 [ %86, %L198.us.us.us ], [ %value_phi47.us.us.us.ph, %L121.us.us.us.preheader ]
  %exitcond317.not.not = icmp eq i64 %value_phi47.us.us.us, %.size.0.copyload.fr, !dbg !122
  br i1 %exitcond317.not.not, label %odessy.chk4, label %L138.us.us.us, !dbg !122

L138.us.us.us:                                    ; preds = %L121.us.us.us
  %exitcond319.not.not = icmp eq i64 %value_phi47.us.us.us, %umax318, !dbg !122
  br i1 %exitcond319.not.not, label %odessy.chk6, label %L157.us.us.us, !dbg !122

L157.us.us.us:                                    ; preds = %L138.us.us.us
  %exitcond321.not.not = icmp eq i64 %value_phi47.us.us.us, %umax320, !dbg !122
  br i1 %exitcond321.not.not, label %odessy.chk7, label %L198.us.us.us, !dbg !122
...
L288.us278.us.us:                                 ; preds = %L198.us.us.us
  ...
  br i1 %.not229.not.us280.us.us, label %L304, label %L46.us265.us.us, !dbg !121
...
L62:                                              ; preds = %L46.preheader.split.split.split
  ...
  %98 = add nsw i64 %.size4.0.copyload.fr, -1, !dbg !122
  %99 = add nsw i64 %.size.0.copyload.fr, -2, !dbg !122
  %umin363 = call i64 @llvm.umin.i64(i64 %98, i64 %99), !dbg !122
  %100 = add nuw nsw i64 %umin363, 1, !dbg !122
  %min.iters.check = icmp samesign ult i64 %umin363, 16, !dbg !122
  br i1 %min.iters.check, label %L121.preheader, label %vector.scevcheck, !dbg !122

vector.scevcheck:                                 ; preds = %L62
  %mul.result = shl i64 %umin363, 3, !dbg !122
  %mul.overflow = icmp samesign ugt i64 %umin363, 2305843009213693951, !dbg !122
  %101 = getelementptr i8, ptr %memoryref_data24, i64 %mul.result, !dbg !122
  %102 = icmp ult ptr %101, %memoryref_data24, !dbg !122
  %103 = or i1 %mul.overflow, %102, !dbg !122
  br i1 %103, label %L121.preheader, label %vector.memcheck
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %n.vec = sub nuw nsw i64 %100, %106, !dbg !122
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %109 = getelementptr inbounds nuw i8, ptr %108, i64 16, !dbg !124
  %110 = getelementptr inbounds nuw i8, ptr %108, i64 32, !dbg !124
  %111 = getelementptr inbounds nuw i8, ptr %108, i64 48, !dbg !124
  %wide.load = load <2 x double>, ptr %108, align 8, !dbg !124, !tbaa !96, !alias.scope !145, !noalias !148
  %wide.load364 = load <2 x double>, ptr %109, align 8, !dbg !124, !tbaa !96, !alias.scope !145, !noalias !148
  %wide.load365 = load <2 x double>, ptr %110, align 8, !dbg !124, !tbaa !96, !alias.scope !145, !noalias !148
  %wide.load366 = load <2 x double>, ptr %111, align 8, !dbg !124, !tbaa !96, !alias.scope !145, !noalias !148
  %112 = getelementptr inbounds i8, ptr %memoryref_data35, i64 %107, !dbg !124
  %113 = getelementptr inbounds nuw i8, ptr %112, i64 16, !dbg !124
  %114 = getelementptr inbounds nuw i8, ptr %112, i64 32, !dbg !124
  %115 = getelementptr inbounds nuw i8, ptr %112, i64 48, !dbg !124
  %wide.load367 = load <2 x double>, ptr %112, align 8, !dbg !124, !tbaa !96, !alias.scope !151, !noalias !100
  %wide.load368 = load <2 x double>, ptr %113, align 8, !dbg !124, !tbaa !96, !alias.scope !151, !noalias !100
  %wide.load369 = load <2 x double>, ptr %114, align 8, !dbg !124, !tbaa !96, !alias.scope !151, !noalias !100
  %wide.load370 = load <2 x double>, ptr %115, align 8, !dbg !124, !tbaa !96, !alias.scope !151, !noalias !100
  ...
  %125 = getelementptr inbounds nuw i8, ptr %124, i64 16, !dbg !124
  %126 = getelementptr inbounds nuw i8, ptr %124, i64 32, !dbg !124
  %127 = getelementptr inbounds nuw i8, ptr %124, i64 48, !dbg !124
  %wide.load371 = load <2 x double>, ptr %124, align 8, !dbg !124, !tbaa !96, !alias.scope !152, !noalias !100
  %wide.load372 = load <2 x double>, ptr %125, align 8, !dbg !124, !tbaa !96, !alias.scope !152, !noalias !100
  %wide.load373 = load <2 x double>, ptr %126, align 8, !dbg !124, !tbaa !96, !alias.scope !152, !noalias !100
  %wide.load374 = load <2 x double>, ptr %127, align 8, !dbg !124, !tbaa !96, !alias.scope !152, !noalias !100
  ...
  store <2 x double> %132, ptr %136, align 8, !dbg !136, !tbaa !96, !alias.scope !145, !noalias !148
  store <2 x double> %133, ptr %137, align 8, !dbg !136, !tbaa !96, !alias.scope !145, !noalias !148
  store <2 x double> %134, ptr %138, align 8, !dbg !136, !tbaa !96, !alias.scope !145, !noalias !148
  store <2 x double> %135, ptr %139, align 8, !dbg !136, !tbaa !96, !alias.scope !145, !noalias !148
  %index.next = add nuw i64 %index, 8
  %140 = icmp eq i64 %index.next, %n.vec
  br i1 %140, label %scalar.ph.loopexit, label %vector.body, !llvm.loop !153

scalar.ph.loopexit:                               ; preds = %vector.body
  %ind.end = add nuw nsw i64 %n.vec, 1, !dbg !122
  br label %L121.preheader, !dbg !122
...
L121:                                             ; preds = %L121.preheader, %L198
  %value_phi47 = phi i64 [ %148, %L198 ], [ %value_phi47.ph, %L121.preheader ]
  %exitcond331.not.not = icmp eq i64 %value_phi47, %.size.0.copyload.fr, !dbg !122
  br i1 %exitcond331.not.not, label %odessy.chk3, label %L138, !dbg !122

L138:                                             ; preds = %L121
  %exitcond333.not.not = icmp eq i64 %value_phi47, %.size4.0.copyload.fr, !dbg !122
  br i1 %exitcond333.not.not, label %odessy.chk5, label %L198, !dbg !122
...
L198:                                             ; preds = %L138
  ...
  %141 = load double, ptr %memoryref_data61, align 8, !dbg !124, !tbaa !96, !alias.scope !99, !noalias !100
  %memoryref_data74 = getelementptr inbounds i8, ptr %memoryref_data35, i64 %memoryref_byteoffset56, !dbg !124
  %142 = load double, ptr %memoryref_data74, align 8, !dbg !124, !tbaa !96, !alias.scope !99, !noalias !100
  %143 = fmul double %93, %142, !dbg !132
  %144 = fadd double %141, %143, !dbg !133
  %memoryref_data87 = getelementptr inbounds i8, ptr %memoryref_data123, i64 %memoryref_byteoffset56, !dbg !124
  %145 = load double, ptr %memoryref_data87, align 8, !dbg !124, !tbaa !96, !alias.scope !99, !noalias !100
  %146 = fmul double %97, %145, !dbg !132
  %147 = fsub double %144, %146, !dbg !135
  %memoryref_data100 = getelementptr i8, ptr %memoryref_data61, i64 -8, !dbg !136
  store double %147, ptr %memoryref_data100, align 8, !dbg !136, !tbaa !96, !alias.scope !99, !noalias !100
  %.not224.not = icmp eq i64 %value_phi47, %15, !dbg !141
  %148 = add i64 %value_phi47, 1, !dbg !142
  br i1 %.not224.not, label %odessy.chk8, label %L121, !dbg !143, !llvm.loop !154

L304:                                             ; preds = %L288.us278.us.us, %L288.us.us.us.us, %L29
  %frame.prev488 = load ptr, ptr %frame.prev, align 8, !tbaa !24
  store ptr %frame.prev488, ptr %pgcstack, align 8, !tbaa !24
  ret ptr %0, !dbg !155

L305:                                             ; preds = %L26
  %149 = call swiftcc [1 x ptr] @j_ArgumentError_147(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#148.jit"), !dbg !70
  %gc_slot_addr_0 = getelementptr inbounds nuw i8, ptr %gcframe1, i64 16
  %150 = extractvalue [1 x ptr] %149, 0, !dbg !70
  store ptr %150, ptr %gc_slot_addr_0, align 16
  ...
  store atomic i64 4833101808, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !70, !tbaa !156
  store ptr %150, ptr %"box::ArgumentError", align 8, !dbg !70, !tbaa !158, !alias.scope !99, !noalias !100
  store ptr null, ptr %gc_slot_addr_0, align 16
  call void @ijl_throw(ptr nonnull %"box::ArgumentError"), !dbg !70
  unreachable, !dbg !70

L308:                                             ; preds = %L20
  %151 = call swiftcc [1 x ptr] @j_DimensionMismatch_150(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#151.jit"), !dbg !63
  %gc_slot_addr_0445 = getelementptr inbounds nuw i8, ptr %gcframe1, i64 16
  %152 = extractvalue [1 x ptr] %151, 0, !dbg !63
  store ptr %152, ptr %gc_slot_addr_0445, align 16
  ...
  store atomic i64 4748420416, ptr %"box::DimensionMismatch.tag_addr" unordered, align 8, !dbg !63, !tbaa !156
  store ptr %152, ptr %"box::DimensionMismatch", align 8, !dbg !63, !tbaa !158, !alias.scope !99, !noalias !100
  store ptr null, ptr %gc_slot_addr_0445, align 16
  call void @ijl_throw(ptr nonnull %"box::DimensionMismatch"), !dbg !63
  unreachable, !dbg !63

L311:                                             ; preds = %L13
  %153 = call swiftcc [1 x ptr] @j_DimensionMismatch_150(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#153.jit"), !dbg !60
  %gc_slot_addr_0447 = getelementptr inbounds nuw i8, ptr %gcframe1, i64 16
  %154 = extractvalue [1 x ptr] %153, 0, !dbg !60
  store ptr %154, ptr %gc_slot_addr_0447, align 16
  ...
  store atomic i64 4748420416, ptr %"box::DimensionMismatch191.tag_addr" unordered, align 8, !dbg !60, !tbaa !156
  store ptr %154, ptr %"box::DimensionMismatch191", align 8, !dbg !60, !tbaa !158, !alias.scope !99, !noalias !100
  store ptr null, ptr %gc_slot_addr_0447, align 16
  call void @ijl_throw(ptr nonnull %"box::DimensionMismatch191"), !dbg !60
  unreachable, !dbg !60

L314:                                             ; preds = %top
  %155 = call swiftcc [1 x ptr] @j_DimensionMismatch_150(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#154.jit"), !dbg !52
  %gc_slot_addr_0449 = getelementptr inbounds nuw i8, ptr %gcframe1, i64 16
  %156 = extractvalue [1 x ptr] %155, 0, !dbg !52
  store ptr %156, ptr %gc_slot_addr_0449, align 16
  ...
  store atomic i64 4748420416, ptr %"box::DimensionMismatch197.tag_addr" unordered, align 8, !dbg !52, !tbaa !156
  store ptr %156, ptr %"box::DimensionMismatch197", align 8, !dbg !52, !tbaa !158, !alias.scope !99, !noalias !100
...
!148 = !{!34, !35, !37, !31, !149, !150}
!149 = distinct !{!149, !147}
!150 = distinct !{!150, !147}
!151 = !{!36, !149}
!152 = !{!36, !150}
!153 = distinct !{!153, !139, !140}
!154 = distinct !{!154, !139}
!155 = !DILocation(line: 24, scope: !4)
!156 = !{!157, !157, i64 0}
!157 = !{!"jtbaa_tag", !98, i64 0}
!158 = !{!159, !159, i64 0}
!159 = !{!"jtbaa_immut", !160, i64 0}
!160 = !{!"jtbaa_value", !98, i64 0}
