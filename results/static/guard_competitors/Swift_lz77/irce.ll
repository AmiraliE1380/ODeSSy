...
.loopexit94.loopexit:                             ; preds = %79, %84, %87, %92
  %.ph12 = phi i64 [ 0, %84 ], [ 0, %87 ], [ %93, %92 ], [ 0, %79 ]
  %.ph13 = phi i8 [ 1, %84 ], [ 1, %87 ], [ 0, %92 ], [ 1, %79 ]
  br label %.loopexit94

.loopexit94.loopexit14:                           ; preds = %37, %42, %45, %50
  %.ph15 = phi i64 [ 0, %42 ], [ 0, %45 ], [ %51, %50 ], [ 0, %37 ]
  %.ph16 = phi i8 [ 1, %42 ], [ 1, %45 ], [ 0, %50 ], [ 1, %37 ]
  br label %.loopexit94

.loopexit94.loopexit17:                           ; preds = %60, %65, %68, %73
  %.ph18 = phi i64 [ 0, %65 ], [ 0, %68 ], [ %74, %73 ], [ 0, %60 ]
  %.ph19 = phi i8 [ 1, %65 ], [ 1, %68 ], [ 0, %73 ], [ 1, %60 ]
  br label %.loopexit94

.loopexit94:                                      ; preds = %.loopexit94.loopexit17, %.loopexit94.loopexit14, %.loopexit94.loopexit, %55, %54, %31
  %32 = phi i64 [ 0, %55 ], [ 0, %31 ], [ 0, %54 ], [ %.ph12, %.loopexit94.loopexit ], [ %.ph15, %.loopexit94.loopexit14 ], [ %.ph18, %.loopexit94.loopexit17 ]
  %33 = phi i8 [ 1, %55 ], [ 1, %31 ], [ 1, %54 ], [ %.ph13, %.loopexit94.loopexit ], [ %.ph16, %.loopexit94.loopexit14 ], [ %.ph19, %.loopexit94.loopexit17 ]
...
37:                                               ; preds = %50, %34
  ...
  br i1 %or.cond, label %42, label %.loopexit94.loopexit14, !prof !47

42:                                               ; preds = %37
  %43 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %39, i64 10)
  %44 = extractvalue { i64, i1 } %43, 1
  br i1 %44, label %.loopexit94.loopexit14, label %45
...
45:                                               ; preds = %42
  ...
  br i1 %49, label %.loopexit94.loopexit14, label %50, !prof !44

50:                                               ; preds = %45
  %51 = extractvalue { i64, i1 } %48, 0
  %52 = getelementptr inbounds nuw i8, ptr %38, i64 1
  %53 = icmp eq ptr %52, %36
  br i1 %53, label %.loopexit94.loopexit14, label %37
...
60:                                               ; preds = %73, %57
  ...
  br i1 %or.cond20, label %65, label %.loopexit94.loopexit17, !prof !47

65:                                               ; preds = %60
  %66 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %62, i64 10)
  %67 = extractvalue { i64, i1 } %66, 1
  br i1 %67, label %.loopexit94.loopexit17, label %68
...
68:                                               ; preds = %65
  ...
  br i1 %72, label %.loopexit94.loopexit17, label %73, !prof !44

73:                                               ; preds = %68
  %74 = extractvalue { i64, i1 } %71, 0
  %75 = getelementptr inbounds nuw i8, ptr %61, i64 1
  %76 = icmp eq ptr %75, %59
  br i1 %76, label %.loopexit94.loopexit17, label %60
...
79:                                               ; preds = %92, %77
  ...
  br i1 %or.cond21, label %84, label %.loopexit94.loopexit, !prof !47

84:                                               ; preds = %79
  %85 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %81, i64 10)
  %86 = extractvalue { i64, i1 } %85, 1
  br i1 %86, label %.loopexit94.loopexit, label %87
...
87:                                               ; preds = %84
  ...
  br i1 %91, label %.loopexit94.loopexit, label %92, !prof !44

92:                                               ; preds = %87
  %93 = extractvalue { i64, i1 } %90, 0
  %94 = getelementptr inbounds nuw i8, ptr %80, i64 1
  %95 = icmp eq ptr %94, %78
  br i1 %95, label %.loopexit94.loopexit, label %79
...
.thread81.loopexit:                               ; preds = %171, %176, %179, %184
  %.sroa.0.185.ph = phi i64 [ 0, %176 ], [ 0, %179 ], [ %185, %184 ], [ 0, %171 ]
  %.sroa.6.184.ph = phi i8 [ 1, %176 ], [ 1, %179 ], [ 0, %184 ], [ 1, %171 ]
  br label %.thread81

.thread81.loopexit6:                              ; preds = %124, %129, %132, %137
  %.sroa.0.185.ph7 = phi i64 [ 0, %129 ], [ 0, %132 ], [ %138, %137 ], [ 0, %124 ]
  %.sroa.6.184.ph8 = phi i8 [ 1, %129 ], [ 1, %132 ], [ 0, %137 ], [ 1, %124 ]
  br label %.thread81

.thread81.loopexit9:                              ; preds = %150, %155, %158, %163
  %.sroa.0.185.ph10 = phi i64 [ 0, %155 ], [ 0, %158 ], [ %164, %163 ], [ 0, %150 ]
  %.sroa.6.184.ph11 = phi i8 [ 1, %155 ], [ 1, %158 ], [ 0, %163 ], [ 1, %150 ]
  br label %.thread81

.thread81:                                        ; preds = %.thread81.loopexit9, %.thread81.loopexit6, %.thread81.loopexit, %167, %145, %143, %119, %.loopexit94
  %.sroa.0.185 = phi i64 [ 0, %119 ], [ 0, %143 ], [ 0, %145 ], [ 0, %167 ], [ %32, %.loopexit94 ], [ %.sroa.0.185.ph, %.thread81.loopexit ], [ %.sroa.0.185.ph7, %.thread81.loopexit6 ], [ %.sroa.0.185.ph10, %.thread81.loopexit9 ]
  %.sroa.6.184 = phi i8 [ 1, %119 ], [ 1, %143 ], [ 1, %145 ], [ 0, %167 ], [ %33, %.loopexit94 ], [ %.sroa.6.184.ph, %.thread81.loopexit ], [ %.sroa.6.184.ph8, %.thread81.loopexit6 ], [ %.sroa.6.184.ph11, %.thread81.loopexit9 ]
...
124:                                              ; preds = %137, %121
  ...
  br i1 %or.cond22, label %129, label %.thread81.loopexit6, !prof !47

129:                                              ; preds = %124
  %130 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %126, i64 10)
  %131 = extractvalue { i64, i1 } %130, 1
  br i1 %131, label %.thread81.loopexit6, label %132
...
150:                                              ; preds = %163, %147
  ...
  br i1 %or.cond23, label %155, label %.thread81.loopexit9, !prof !47

155:                                              ; preds = %150
  %156 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %152, i64 10)
  %157 = extractvalue { i64, i1 } %156, 1
  br i1 %157, label %.thread81.loopexit9, label %158
...
171:                                              ; preds = %184, %169
  ...
  br i1 %or.cond24, label %176, label %.thread81.loopexit, !prof !47
...
.loopexit87.loopexit:                             ; preds = %.loopexit
  %.lcssa5 = phi i64 [ %299, %.loopexit ]
  br label %.loopexit87

.loopexit87:                                      ; preds = %.loopexit87.loopexit, %220
  %226 = phi i64 [ 0, %220 ], [ %.lcssa5, %.loopexit87.loopexit ]
  ...
  %228 = call noalias ptr @swift_allocObject(ptr %227, i64 64, i64 7) #2
  ...
  call void @swift_release(ptr %228) #2
  call void @llvm.lifetime.end.p0(ptr %7)
  ret i32 0

232:                                              ; preds = %.loopexit, %222
...
.preheader86.preheader:                           ; preds = %232
  br label %.preheader86

.preheader86:                                     ; preds = %.preheader86.preheader, %286
  %236 = phi i64 [ %289, %286 ], [ 0, %.preheader86.preheader ]
  %237 = phi i64 [ %288, %286 ], [ 0, %.preheader86.preheader ]
  %238 = phi i64 [ %287, %286 ], [ %234, %.preheader86.preheader ]
...
253:                                              ; preds = %251
  ...
  br i1 %.not76, label %255, label %odessy.chk9, !prof !45

255:                                              ; preds = %253
  %exitcond135.not = icmp ne i64 %252, %245
  br i1 %exitcond135.not, label %256, label %odessy.chk10, !prof !45
...
266:                                              ; preds = %264
  ...
  %.not20 = xor i1 %269, true
  br i1 %.not20, label %270, label %odessy.chk8, !prof !45
...
276:                                              ; preds = %270
  %.lcssa2 = phi i64 [ %271, %270 ]
  %.lcssa1 = phi i64 [ %272, %270 ]
  %277 = icmp sgt i64 %.lcssa1, 3
...
281:                                              ; preds = %278
  %282 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %237, i64 %.lcssa1)
  %283 = extractvalue { i64, i1 } %282, 1
  br i1 %283, label %odessy.chk7, label %284, !prof !44

284:                                              ; preds = %281
  %285 = add i64 %.lcssa2, %238
...
286:                                              ; preds = %294, %284
  ...
  br i1 %290, label %.preheader86, label %.loopexit.loopexit

291:                                              ; preds = %276, %242
  %292 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %236, i64 1)
  %293 = extractvalue { i64, i1 } %292, 1
  br i1 %293, label %odessy.chk4, label %294, !prof !44

294:                                              ; preds = %291
  %295 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %237, i64 1)
  %296 = extractvalue { i64, i1 } %295, 1
  br i1 %296, label %odessy.chk5, label %286, !prof !44

.loopexit.loopexit:                               ; preds = %286
  %.lcssa4 = phi i64 [ %287, %286 ]
  %.lcssa3 = phi i64 [ %289, %286 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %232
  %297 = phi i64 [ 0, %232 ], [ %.lcssa3, %.loopexit.loopexit ]
  %298 = phi i64 [ %234, %232 ], [ %.lcssa4, %.loopexit.loopexit ]
  %299 = add i64 %298, %297
  store i64 %299, ptr @"$s4lz775totalSivp", align 8
  %300 = icmp eq i64 %235, %218
  br i1 %300, label %.loopexit87.loopexit, label %232

301:                                              ; preds = %193
  %302 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %302, align 8, !invariant.load !41
...
18:                                               ; preds = %12, %10
  ...
  %21 = icmp eq i64 %2, %4
  br i1 %21, label %odessy.chk1, label %.thread
