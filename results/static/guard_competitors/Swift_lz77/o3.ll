...
193:                                              ; preds = %188
  ...
  br i1 %.not73, label %200, label %299
...
224:                                              ; preds = %222
  ...
  br i1 %.not74, label %.split.us, label %.preheader86.preheader

.split.us:                                        ; preds = %224
  store i64 0, ptr @"$s4lz775totalSivp", align 8
  br label %.loopexit87

.loopexit87:                                      ; preds = %.loopexit.loopexit, %.split.us, %222
  %228 = phi i64 [ 0, %222 ], [ 0, %.split.us ], [ %297, %.loopexit.loopexit ]
  %229 = call ptr @__swift_instantiateConcreteTypeFromMangledNameV2(ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMd", ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMR") #15
  %230 = call noalias ptr @swift_allocObject(ptr %229, i64 64, i64 7) #2
  %231 = getelementptr inbounds nuw i8, ptr %230, i64 16
  store <2 x i64> <i64 1, i64 2>, ptr %231, align 8
  %232 = getelementptr inbounds nuw i8, ptr %230, i64 32
  %233 = getelementptr inbounds nuw i8, ptr %230, i64 56
  store ptr @"$sSiN", ptr %233, align 8
  store i64 %228, ptr %232, align 8
  call swiftcc void @"$ss5print_9separator10terminatoryypd_S2StF"(ptr %230, i64 32, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr), i64 10, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr))
  call void @swift_release(ptr %230) #2
  call void @llvm.lifetime.end.p0(ptr nonnull %7)
  ret i32 0

.preheader86.preheader:                           ; preds = %224, %.loopexit.loopexit
  %234 = phi i64 [ %236, %.loopexit.loopexit ], [ 0, %224 ]
  %235 = phi i64 [ %297, %.loopexit.loopexit ], [ 0, %224 ]
  %236 = add nuw nsw i64 %234, 1
  br label %.preheader86

.preheader86:                                     ; preds = %.preheader86.preheader, %287
  %237 = phi i64 [ %290, %287 ], [ 0, %.preheader86.preheader ]
  %238 = phi i64 [ %289, %287 ], [ 0, %.preheader86.preheader ]
  %239 = phi i64 [ %288, %287 ], [ %235, %.preheader86.preheader ]
  %240 = icmp sgt i64 %238, 1024
  br i1 %240, label %241, label %243

241:                                              ; preds = %.preheader86
  %242 = add nsw i64 %238, -1024
  br label %.preheader

243:                                              ; preds = %.preheader86
  %244 = icmp sgt i64 %238, 0
  br i1 %244, label %.preheader, label %292

.preheader:                                       ; preds = %243, %241
  %.ph = phi i64 [ %242, %241 ], [ 0, %243 ]
  %smax = call i64 @llvm.smax.i64(i64 %238, i64 %226)
  %245 = sub nsw i64 %smax, %238
  %246 = call i64 @llvm.usub.sat.i64(i64 %226, i64 %238)
  %247 = getelementptr inbounds nuw i8, ptr %227, i64 %238
  br label %248

248:                                              ; preds = %271, %.preheader
  %249 = phi i64 [ %272, %271 ], [ 0, %.preheader ]
  %250 = phi i64 [ %273, %271 ], [ 0, %.preheader ]
  %251 = phi i64 [ %274, %271 ], [ %.ph, %.preheader ]
  br label %252

252:                                              ; preds = %263, %248
  %253 = phi i64 [ 0, %248 ], [ %264, %263 ]
  %exitcond.not = icmp eq i64 %253, %245
  br i1 %exitcond.not, label %265, label %254

254:                                              ; preds = %252
  %255 = add nuw nsw i64 %253, %251
  %.not76 = icmp ult i64 %255, %226
  br i1 %.not76, label %256, label %odessy.chk9, !prof !45

256:                                              ; preds = %254
  %exitcond135.not = icmp eq i64 %253, %246
  br i1 %exitcond135.not, label %odessy.chk10, label %257, !prof !44

257:                                              ; preds = %256
  %258 = getelementptr inbounds nuw i8, ptr %227, i64 %255
  %259 = load i8, ptr %258, align 1
  %260 = getelementptr inbounds nuw i8, ptr %247, i64 %253
...
263:                                              ; preds = %257
  ...
  %exitcond136.not = icmp eq i64 %264, 255
  br i1 %exitcond136.not, label %265, label %252

265:                                              ; preds = %263, %257, %252
  %.lcssa = phi i64 [ %253, %257 ], [ %245, %252 ], [ 255, %263 ]
  %266 = icmp slt i64 %250, %.lcssa
  br i1 %266, label %267, label %271

267:                                              ; preds = %265
  %268 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %238, i64 %251)
  %269 = extractvalue { i64, i1 } %268, 0
  %270 = extractvalue { i64, i1 } %268, 1
  br i1 %270, label %odessy.chk8, label %271, !prof !44

271:                                              ; preds = %267, %265
  %272 = phi i64 [ %269, %267 ], [ %249, %265 ]
  %273 = phi i64 [ %.lcssa, %267 ], [ %250, %265 ]
  %274 = add nuw nsw i64 %251, 1
  %275 = icmp slt i64 %273, 255
  %276 = icmp slt i64 %274, %238
  %or.cond27 = select i1 %275, i1 %276, i1 false
  br i1 %or.cond27, label %248, label %277

277:                                              ; preds = %271
  %278 = icmp sgt i64 %273, 3
  br i1 %278, label %279, label %292

279:                                              ; preds = %277
  %280 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %237, i64 3)
  %281 = extractvalue { i64, i1 } %280, 1
  br i1 %281, label %odessy.chk6, label %282, !prof !44

282:                                              ; preds = %279
  %283 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %238, i64 %273)
  %284 = extractvalue { i64, i1 } %283, 1
  br i1 %284, label %odessy.chk7, label %285, !prof !44

285:                                              ; preds = %282
  %286 = add i64 %272, %239
  store i64 %286, ptr @"$s4lz775totalSivp", align 8
  br label %287

287:                                              ; preds = %295, %285
  %.pn = phi { i64, i1 } [ %280, %285 ], [ %293, %295 ]
  %.pn78 = phi { i64, i1 } [ %283, %285 ], [ %296, %295 ]
  %288 = phi i64 [ %286, %285 ], [ %239, %295 ]
  %289 = extractvalue { i64, i1 } %.pn78, 0
  %290 = extractvalue { i64, i1 } %.pn, 0
  %291 = icmp slt i64 %289, %226
  br i1 %291, label %.preheader86, label %.loopexit.loopexit

292:                                              ; preds = %277, %243
  %293 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %237, i64 1)
  %294 = extractvalue { i64, i1 } %293, 1
  br i1 %294, label %odessy.chk4, label %295, !prof !44

295:                                              ; preds = %292
  %296 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %238, i64 1)
  br label %287

.loopexit.loopexit:                               ; preds = %287
  %297 = add i64 %288, %290
  store i64 %297, ptr @"$s4lz775totalSivp", align 8
  %298 = icmp eq i64 %236, %220
  br i1 %298, label %.loopexit87, label %.preheader86.preheader

299:                                              ; preds = %193
  %300 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %300, align 8, !invariant.load !41
