; ModuleID = 'results/static/guard_competitors/Swift_lz77/irce.ll'
...
.loopexit94:                                      ; preds = %60, %65, %68, %73, %37, %42, %45, %50, %79, %84, %87, %92, %55, %54, %31
...
.thread81:                                        ; preds = %150, %155, %158, %163, %124, %129, %132, %137, %171, %176, %179, %184, %167, %145, %143, %119, %.loopexit94
  %.sroa.0.185 = phi i64 [ 0, %119 ], [ 0, %143 ], [ 0, %145 ], [ 0, %167 ], [ %32, %.loopexit94 ], [ 0, %124 ], [ 0, %171 ], [ %185, %184 ], [ 0, %179 ], [ 0, %176 ], [ %138, %137 ], [ 0, %132 ], [ 0, %129 ], [ 0, %150 ], [ %164, %163 ], [ 0, %158 ], [ 0, %155 ]
  %.sroa.6.184 = phi i8 [ 1, %119 ], [ 1, %143 ], [ 1, %145 ], [ 0, %167 ], [ %33, %.loopexit94 ], [ 1, %124 ], [ 1, %171 ], [ 0, %184 ], [ 1, %179 ], [ 1, %176 ], [ 0, %137 ], [ 1, %132 ], [ 1, %129 ], [ 1, %150 ], [ 0, %163 ], [ 1, %158 ], [ 1, %155 ]
...
256:                                              ; preds = %254
  %exitcond135.not.not = icmp eq i64 %253, %246
  br i1 %exitcond135.not.not, label %odessy.chk10, label %257, !prof !44
