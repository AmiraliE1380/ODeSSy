; ModuleID = 'results/static/guard_competitors/Swift_lz77/nofold.ll'
...
193:                                              ; preds = %188
  ...
  br i1 %.not73, label %200, label %346
...
.mv.ph.mv.fast:                                   ; preds = %.mv.ph.mv.fast.preheader, %.loopexit.mv.fast.loopexit
  ...
  %229 = phi i64 [ %282, %.loopexit.mv.fast.loopexit ], [ 0, %.mv.ph.mv.fast.preheader ]
  %230 = add nuw nsw i64 %228, 1
  br label %.preheader86.mv.fast

.preheader86.mv.fast:                             ; preds = %.mv.ph.mv.fast, %277
  %231 = phi i64 [ %280, %277 ], [ 0, %.mv.ph.mv.fast ]
  %232 = phi i64 [ %279, %277 ], [ 0, %.mv.ph.mv.fast ]
  %233 = phi i64 [ %278, %277 ], [ %229, %.mv.ph.mv.fast ]
...
272:                                              ; preds = %269
  ...
  br i1 %274, label %odessy.fasttrap, label %275, !prof !44

275:                                              ; preds = %272
  %276 = add i64 %spec.select, %233
  store i64 %276, ptr @"$s4lz775totalSivp", align 8
  br label %277

277:                                              ; preds = %267, %275
  %.pn.mv.fast = phi { i64, i1 } [ %270, %275 ], [ %265, %267 ]
  %.pn78.mv.fast = phi { i64, i1 } [ %273, %275 ], [ %268, %267 ]
  %278 = phi i64 [ %276, %275 ], [ %233, %267 ]
  %279 = extractvalue { i64, i1 } %.pn78.mv.fast, 0
  %280 = extractvalue { i64, i1 } %.pn.mv.fast, 0
  %281 = icmp slt i64 %279, %226
  br i1 %281, label %.preheader86.mv.fast, label %.loopexit.mv.fast.loopexit

.loopexit.mv.fast.loopexit:                       ; preds = %277
  %282 = add i64 %278, %280
  store i64 %282, ptr @"$s4lz775totalSivp", align 8
  %283 = icmp eq i64 %230, %220
  br i1 %283, label %.loopexit87, label %.mv.ph.mv.fast

.loopexit87:                                      ; preds = %.loopexit.loopexit, %.loopexit.mv.fast.loopexit, %.mv.ph.mv.fast.preheader.split.us, %222
  %284 = phi i64 [ 0, %222 ], [ 0, %.mv.ph.mv.fast.preheader.split.us ], [ %282, %.loopexit.mv.fast.loopexit ], [ %344, %.loopexit.loopexit ]
  %285 = call ptr @__swift_instantiateConcreteTypeFromMangledNameV2(ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMd", ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMR") #15
  %286 = call noalias ptr @swift_allocObject(ptr %285, i64 64, i64 7) #2
  %287 = getelementptr inbounds nuw i8, ptr %286, i64 16
  store <2 x i64> <i64 1, i64 2>, ptr %287, align 8
  %288 = getelementptr inbounds nuw i8, ptr %286, i64 32
  %289 = getelementptr inbounds nuw i8, ptr %286, i64 56
  store ptr @"$sSiN", ptr %289, align 8
  store i64 %284, ptr %288, align 8
  call swiftcc void @"$ss5print_9separator10terminatoryypd_S2StF"(ptr %286, i64 32, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr), i64 10, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr))
  call void @swift_release(ptr %286) #2
  call void @llvm.lifetime.end.p0(ptr nonnull %7)
  ret i32 0

.mv.ph:                                           ; preds = %224, %.loopexit.loopexit
  %290 = phi i64 [ %292, %.loopexit.loopexit ], [ 0, %224 ]
  %291 = phi i64 [ %344, %.loopexit.loopexit ], [ 0, %224 ]
  %292 = add nuw nsw i64 %290, 1
  br label %.preheader86

.preheader86:                                     ; preds = %.mv.ph, %334
  %293 = phi i64 [ %337, %334 ], [ 0, %.mv.ph ]
  %294 = phi i64 [ %336, %334 ], [ 0, %.mv.ph ]
  %295 = phi i64 [ %335, %334 ], [ %291, %.mv.ph ]
  %296 = icmp sgt i64 %294, 1024
  br i1 %296, label %297, label %299

297:                                              ; preds = %.preheader86
  %298 = add nsw i64 %294, -1024
  br label %.preheader

299:                                              ; preds = %.preheader86
  %300 = icmp sgt i64 %294, 0
  br i1 %300, label %.preheader, label %339

.preheader:                                       ; preds = %299, %297
  %.ph = phi i64 [ %298, %297 ], [ 0, %299 ]
  %smax = call i64 @llvm.smax.i64(i64 %294, i64 %226)
  %301 = sub nsw i64 %smax, %294
  %302 = getelementptr inbounds nuw i8, ptr %227, i64 %294
  br label %303

303:                                              ; preds = %318, %.preheader
  %304 = phi i64 [ %spec.select39, %318 ], [ 0, %.preheader ]
  %305 = phi i64 [ %spec.select40, %318 ], [ 0, %.preheader ]
  %306 = phi i64 [ %321, %318 ], [ %.ph, %.preheader ]
  %307 = getelementptr inbounds nuw i8, ptr %227, i64 %306
  br label %308

308:                                              ; preds = %316, %303
  %309 = phi i64 [ 0, %303 ], [ %317, %316 ]
  %exitcond.not = icmp eq i64 %309, %301
  br i1 %exitcond.not, label %318, label %310

310:                                              ; preds = %308
  %311 = getelementptr inbounds nuw i8, ptr %307, i64 %309
  %312 = load i8, ptr %311, align 1
  %313 = getelementptr inbounds nuw i8, ptr %302, i64 %309
...
316:                                              ; preds = %310
  ...
  %exitcond136.not = icmp eq i64 %317, 255
  br i1 %exitcond136.not, label %318, label %308

318:                                              ; preds = %316, %310, %308
  %.lcssa = phi i64 [ %309, %310 ], [ %301, %308 ], [ 255, %316 ]
  %319 = icmp slt i64 %305, %.lcssa
  %320 = sub i64 %294, %306
  %spec.select39 = select i1 %319, i64 %320, i64 %304
  %spec.select40 = call i64 @llvm.smax.i64(i64 %305, i64 %.lcssa)
  %321 = add nuw nsw i64 %306, 1
  %322 = icmp slt i64 %spec.select40, 255
  %323 = icmp slt i64 %321, %294
  %or.cond27 = select i1 %322, i1 %323, i1 false
  br i1 %or.cond27, label %303, label %324

324:                                              ; preds = %318
  %325 = icmp sgt i64 %spec.select40, 3
  br i1 %325, label %326, label %339

326:                                              ; preds = %324
  %327 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %293, i64 3)
  %328 = extractvalue { i64, i1 } %327, 1
  br i1 %328, label %odessy.chk6, label %329, !prof !44

329:                                              ; preds = %326
  %330 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %294, i64 %spec.select40)
  %331 = extractvalue { i64, i1 } %330, 1
  br i1 %331, label %odessy.chk7, label %332, !prof !44

332:                                              ; preds = %329
  %333 = add i64 %spec.select39, %295
  store i64 %333, ptr @"$s4lz775totalSivp", align 8
  br label %334

334:                                              ; preds = %342, %332
  %.pn = phi { i64, i1 } [ %327, %332 ], [ %340, %342 ]
  %.pn78 = phi { i64, i1 } [ %330, %332 ], [ %343, %342 ]
  %335 = phi i64 [ %333, %332 ], [ %295, %342 ]
  %336 = extractvalue { i64, i1 } %.pn78, 0
  %337 = extractvalue { i64, i1 } %.pn, 0
  %338 = icmp slt i64 %336, %226
  br i1 %338, label %.preheader86, label %.loopexit.loopexit

339:                                              ; preds = %324, %299
  %340 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %293, i64 1)
  %341 = extractvalue { i64, i1 } %340, 1
  br i1 %341, label %odessy.chk4, label %342, !prof !44

342:                                              ; preds = %339
  %343 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %294, i64 1)
  br label %334

.loopexit.loopexit:                               ; preds = %334
  %344 = add i64 %335, %337
  store i64 %344, ptr @"$s4lz775totalSivp", align 8
  %345 = icmp eq i64 %292, %220
  br i1 %345, label %.loopexit87, label %.mv.ph

346:                                              ; preds = %193
  %347 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %347, align 8, !invariant.load !41
...
odessy.chk4:                                      ; preds = %339, %264
  call void @odessy.chk(i32 4)
  unreachable

odessy.chk6:                                      ; preds = %326, %269
  call void @odessy.chk(i32 6)
  unreachable

odessy.chk7:                                      ; preds = %329
