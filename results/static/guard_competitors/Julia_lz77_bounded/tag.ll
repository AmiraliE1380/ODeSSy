; ModuleID = 'logs/julia_triage/lz77_bounded.ll'
...
L23:                                              ; preds = %preloop.pseudo.exit, %L67
  %value_phi6 = phi i64 [ %18, %L67 ], [ %value_phi6.preloop.copy, %preloop.pseudo.exit ]
  %14 = add i64 %value_phi6, %value_phi53, !dbg !47
  %.not36.not = icmp sgt i64 %14, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.not, label %L72, label %L61, !dbg !46

L39:                                              ; No predecessors!
  store i64 %28, ptr %"new::Tuple26", align 8, !dbg !50, !tbaa !52, !alias.scope !54, !noalias !57
...
L58:                                              ; No predecessors!
  store i64 %8, ptr %"new::Tuple", align 8, !dbg !50, !tbaa !52, !alias.scope !54, !noalias !57
...
main.exit.selector:                               ; preds = %L67
  %20 = icmp ult i64 %value_phi6, 254, !dbg !73
  br i1 %20, label %main.pseudo.exit, label %L72, !dbg !73

main.pseudo.exit:                                 ; preds = %preloop.pseudo.exit, %main.exit.selector
  %value_phi6.copy = phi i64 [ %value_phi6.preloop.copy, %preloop.pseudo.exit ], [ %18, %main.exit.selector ]
  %21 = call i64 @llvm.smax.i64(i64 %value_phi6.copy, i64 254)
  %smax88 = add nuw nsw i64 %21, 1
  br label %L23.postloop

L72:                                              ; preds = %L67.postloop, %L61.postloop, %L23.postloop, %preloop.exit.selector, %L61.preloop, %L23.preloop, %main.exit.selector, %L61, %L23
  %value_phi24 = phi i64 [ %18, %main.exit.selector ], [ %smax87, %preloop.exit.selector ], [ %smax88, %L67.postloop ], [ %value_phi6.postloop, %L61.postloop ], [ %value_phi6.postloop, %L23.postloop ], [ %value_phi6, %L61 ], [ %value_phi6, %L23 ], [ %value_phi6.preloop, %L61.preloop ], [ %value_phi6.preloop, %L23.preloop ]
...
L23.preloop:                                      ; preds = %L67.preloop, %L23.preheader
  %value_phi6.preloop = phi i64 [ %33, %L67.preloop ], [ 0, %L23.preheader ]
  %27 = add i64 %value_phi6.preloop, %value_phi53, !dbg !47
  %.not36.preloop.not = icmp sgt i64 %27, %"data::Array.size.0.copyload", !dbg !49
...
preloop.pseudo.exit:                              ; preds = %preloop.exit.selector, %L23.preheader
  ...
  br i1 %35, label %L23, label %main.pseudo.exit
...
L23.postloop:                                     ; preds = %L67.postloop, %main.pseudo.exit
  ...
  %.not36.postloop.not = icmp sgt i64 %36, %"data::Array.size.0.copyload", !dbg !49
...
L67.postloop:                                     ; preds = %L61.postloop
  ...
  br i1 %43, label %L23.postloop, label %L72, !dbg !73, !llvm.loop !94, !loop_constrainer.loop.clone !10
