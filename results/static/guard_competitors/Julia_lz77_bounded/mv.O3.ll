; ModuleID = 'results/static/guard_competitors/Julia_lz77_bounded/mv.ll'
...
L23.preheader.mv.fast:                            ; preds = %L72.mv.fast, %L23.preheader.lr.ph.mv.fast
  ...
  %value_phi450.mv.fast = phi i64 [ %value_phi3.mv.fast, %L23.preheader.lr.ph.mv.fast ], [ %32, %L72.mv.fast ]
  %smax42 = call i64 @llvm.smax.i64(i64 %indvars.iv.mv.fast, i64 %3), !dbg !46
  %9 = sub i64 %"data::Array.size.0.copyload", %smax42, !dbg !46
  %smin43 = call i64 @llvm.smin.i64(i64 %9, i64 %7), !dbg !46
  %smin44 = call i64 @llvm.smin.i64(i64 %smin43, i64 255), !dbg !46
  %10 = add i64 %smin44, -1, !dbg !46
  ...
  br i1 %.not107.mv.fast, label %preloop.pseudo.exit.mv.fast, label %L23.preloop.mv.fast.preheader, !dbg !46

L23.preloop.mv.fast.preheader:                    ; preds = %L23.preheader.mv.fast
  %invariant.gep25 = getelementptr i8, ptr %invariant.gep, i64 %value_phi450.mv.fast, !dbg !46
  br label %L23.preloop.mv.fast, !dbg !46

L23.preloop.mv.fast:                              ; preds = %L23.preloop.mv.fast.preheader, %L67.preloop.mv.fast
  %value_phi6.preloop.mv.fast = phi i64 [ %18, %L67.preloop.mv.fast ], [ 0, %L23.preloop.mv.fast.preheader ]
...
L27.preloop.mv.fast:                              ; preds = %L23.preloop.mv.fast
  %gep = getelementptr i8, ptr %invariant.gep25, i64 %value_phi6.preloop.mv.fast, !dbg !50
  %16 = load i8, ptr %gep, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %gep57.preloop.mv.fast = getelementptr i8, ptr %invariant.gep, i64 %15, !dbg !50
  %17 = load i8, ptr %gep57.preloop.mv.fast, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %.not39.preloop.mv.fast = icmp eq i8 %16, %17, !dbg !63
  br i1 %.not39.preloop.mv.fast, label %L67.preloop.mv.fast, label %L72.mv.fast, !dbg !46

L67.preloop.mv.fast:                              ; preds = %L27.preloop.mv.fast
  %18 = add nuw nsw i64 %value_phi6.preloop.mv.fast, 1, !dbg !66
  %exitcond.not.mv.fast = icmp eq i64 %smin86.mv.fast, %18, !dbg !68
  br i1 %exitcond.not.mv.fast, label %preloop.exit.selector.mv.fast, label %L23.preloop.mv.fast, !dbg !68, !llvm.loop !69, !loop_constrainer.loop.clone !10

preloop.exit.selector.mv.fast:                    ; preds = %L67.preloop.mv.fast
  %19 = icmp sgt i64 %11, -255, !dbg !68
  br i1 %19, label %preloop.pseudo.exit.mv.fast, label %L72.mv.fast, !dbg !68
...
preloop.pseudo.exit.mv.fast:                      ; preds = %preloop.exit.selector.mv.fast, %L23.preheader.mv.fast
  ...
  %20 = icmp sgt i64 %smin66.mv.fast, %value_phi6.preloop.copy.mv.fast
  br i1 %20, label %L23.mv.fast.preheader, label %main.pseudo.exit.mv.fast
...
L23.mv.fast:                                      ; preds = %L23.mv.fast.preheader, %L67.mv.fast
  %value_phi6.mv.fast = phi i64 [ %24, %L67.mv.fast ], [ %value_phi6.preloop.copy.mv.fast, %L23.mv.fast.preheader ]
  %21 = add i64 %value_phi6.mv.fast, %value_phi53.mv.fast, !dbg !47
  %.not36.not.mv.fast = icmp sgt i64 %21, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.not.mv.fast, label %L72.mv.fast, label %L61.mv.fast, !dbg !46

L61.mv.fast:                                      ; preds = %L23.mv.fast
  %gep27 = getelementptr i8, ptr %invariant.gep26, i64 %value_phi6.mv.fast, !dbg !50
  %22 = load i8, ptr %gep27, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %gep57.mv.fast = getelementptr i8, ptr %invariant.gep, i64 %21, !dbg !50
  %23 = load i8, ptr %gep57.mv.fast, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %.not39.mv.fast = icmp eq i8 %22, %23, !dbg !63
  br i1 %.not39.mv.fast, label %L67.mv.fast, label %L72.mv.fast, !dbg !46

L67.mv.fast:                                      ; preds = %L61.mv.fast
  %24 = add nuw nsw i64 %value_phi6.mv.fast, 1, !dbg !66
  %exitcond45.not = icmp eq i64 %24, %smin44, !dbg !68
  br i1 %exitcond45.not, label %main.exit.selector.mv.fast, label %L23.mv.fast, !dbg !68

main.exit.selector.mv.fast:                       ; preds = %L67.mv.fast
  %25 = icmp samesign ult i64 %10, 254, !dbg !68
  br i1 %25, label %main.pseudo.exit.mv.fast, label %L72.mv.fast, !dbg !68

main.pseudo.exit.mv.fast:                         ; preds = %main.exit.selector.mv.fast, %preloop.pseudo.exit.mv.fast
  %value_phi6.copy.mv.fast = phi i64 [ %value_phi6.preloop.copy.mv.fast, %preloop.pseudo.exit.mv.fast ], [ %smin44, %main.exit.selector.mv.fast ]
  %26 = call i64 @llvm.smax.i64(i64 %value_phi6.copy.mv.fast, i64 254)
  %smax88.mv.fast = add nuw nsw i64 %26, 1
  %invariant.gep28 = getelementptr i8, ptr %invariant.gep, i64 %value_phi450.mv.fast
  br label %L23.postloop.mv.fast

L23.postloop.mv.fast:                             ; preds = %L67.postloop.mv.fast, %main.pseudo.exit.mv.fast
  %value_phi6.postloop.mv.fast = phi i64 [ %30, %L67.postloop.mv.fast ], [ %value_phi6.copy.mv.fast, %main.pseudo.exit.mv.fast ]
  %27 = add i64 %value_phi6.postloop.mv.fast, %value_phi53.mv.fast, !dbg !47
  %.not36.postloop.not.mv.fast = icmp sgt i64 %27, %"data::Array.size.0.copyload", !dbg !49
...
L27.postloop.mv.fast:                             ; preds = %L23.postloop.mv.fast
  %gep29 = getelementptr i8, ptr %invariant.gep28, i64 %value_phi6.postloop.mv.fast, !dbg !50
  %28 = load i8, ptr %gep29, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %gep57.postloop.mv.fast = getelementptr i8, ptr %invariant.gep, i64 %27, !dbg !50
  %29 = load i8, ptr %gep57.postloop.mv.fast, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %.not39.postloop.mv.fast = icmp eq i8 %28, %29, !dbg !63
  br i1 %.not39.postloop.mv.fast, label %L67.postloop.mv.fast, label %L72.mv.fast, !dbg !46

L67.postloop.mv.fast:                             ; preds = %L27.postloop.mv.fast
  %30 = add nuw nsw i64 %value_phi6.postloop.mv.fast, 1, !dbg !66
  %31 = icmp samesign ult i64 %value_phi6.postloop.mv.fast, 254, !dbg !74
  br i1 %31, label %L23.postloop.mv.fast, label %L72.mv.fast, !dbg !68, !llvm.loop !77, !loop_constrainer.loop.clone !10

L72.mv.fast:                                      ; preds = %L23.preloop.mv.fast, %L27.preloop.mv.fast, %L23.mv.fast, %L61.mv.fast, %L23.postloop.mv.fast, %L27.postloop.mv.fast, %L67.postloop.mv.fast, %main.exit.selector.mv.fast, %preloop.exit.selector.mv.fast
  %value_phi24.mv.fast = phi i64 [ %smin44, %main.exit.selector.mv.fast ], [ %smax87.mv.fast, %preloop.exit.selector.mv.fast ], [ %smax88.mv.fast, %L67.postloop.mv.fast ], [ %value_phi6.mv.fast, %L23.mv.fast ], [ %value_phi6.postloop.mv.fast, %L27.postloop.mv.fast ], [ %value_phi6.postloop.mv.fast, %L23.postloop.mv.fast ], [ %value_phi6.mv.fast, %L61.mv.fast ], [ %value_phi6.preloop.mv.fast, %L27.preloop.mv.fast ], [ %value_phi6.preloop.mv.fast, %L23.preloop.mv.fast ]
  %value_phi5.value_phi24.mv.fast = call i64 @llvm.smax.i64(i64 %value_phi551.mv.fast, i64 %value_phi24.mv.fast), !dbg !78
  %32 = add nsw i64 %value_phi450.mv.fast, 1, !dbg !79
...
L79.mv.fast:                                      ; preds = %L72.mv.fast, %L12.mv.fast
  ...
  %33 = icmp sgt i64 %value_phi5.lcssa.mv.fast, 2, !dbg !81
  %value_phi28.v.mv.fast = select i1 %33, i64 %value_phi5.lcssa.mv.fast, i64 1, !dbg !83
  %value_phi28.mv.fast = add i64 %value_phi28.v.mv.fast, %value_phi53.mv.fast, !dbg !83
  %34 = zext i1 %33 to i64, !dbg !83
  %value_phi29.mv.fast = add i64 %value_phi154.mv.fast, %34, !dbg !83
...
L12:                                              ; preds = %L12.lr.ph, %L79
  ...
  %35 = sub i64 %value_phi53, %"window::Int64", !dbg !43
  %value_phi3 = select i1 %.not34, i64 %35, i64 1, !dbg !43
...
L23.preheader.lr.ph:                              ; preds = %L12
  %36 = add i64 %value_phi3, -1, !dbg !45
  %37 = add nsw i64 %value_phi53, -1, !dbg !45
  %smax59 = call i64 @llvm.smax.i64(i64 %37, i64 -9223372036854775807), !dbg !45
  %smax64 = call i64 @llvm.smax.i64(i64 %37, i64 %3), !dbg !45
  %38 = sub i64 %"data::Array.size.0.copyload", %smax64, !dbg !45
  %39 = sub i64 %value_phi53, %value_phi3, !dbg !45
  br label %L23.preheader, !dbg !45

L23.preheader:                                    ; preds = %L72, %L23.preheader.lr.ph
  %indvars.iv = phi i64 [ %36, %L23.preheader.lr.ph ], [ %indvars.iv.next, %L72 ]
  ...
  %value_phi450 = phi i64 [ %value_phi3, %L23.preheader.lr.ph ], [ %52, %L72 ]
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv, i64 %3), !dbg !46
  %40 = sub i64 %"data::Array.size.0.copyload", %smax, !dbg !46
  %smin = call i64 @llvm.smin.i64(i64 %40, i64 %38), !dbg !46
  %smin41 = call i64 @llvm.smin.i64(i64 %smin, i64 255), !dbg !46
  %41 = add i64 %smin41, -1, !dbg !46
  %smax84 = call i64 @llvm.smax.i64(i64 %indvars.iv, i64 -9223372036854775807), !dbg !46
  %42 = call i64 @llvm.smin.i64(i64 %smax84, i64 %smax59), !dbg !46
  %smax85 = sub nsw i64 0, %42, !dbg !46
  %smin86 = call i64 @llvm.smin.i64(i64 %smax85, i64 255), !dbg !46
  %smax87 = call i64 @llvm.smax.i64(i64 %smin86, i64 0), !dbg !46
  %43 = add i64 %indvar, %36, !dbg !46
  %smax58 = call i64 @llvm.smax.i64(i64 %43, i64 -9223372036854775807), !dbg !46
  %44 = call i64 @llvm.smin.i64(i64 %smax58, i64 %smax59), !dbg !46
  %smax63 = call i64 @llvm.smax.i64(i64 %43, i64 %3), !dbg !46
  %45 = sub i64 %"data::Array.size.0.copyload", %smax63, !dbg !46
  %smin65 = call i64 @llvm.smin.i64(i64 %45, i64 %38), !dbg !46
  %smin66 = call i64 @llvm.smin.i64(i64 %smin65, i64 255), !dbg !46
  %.not107 = icmp sgt i64 %44, -1, !dbg !46
  br i1 %.not107, label %preloop.pseudo.exit, label %L23.preloop, !dbg !46

L23:                                              ; preds = %L23.preheader13, %L67
  %value_phi6 = phi i64 [ %49, %L67 ], [ %value_phi6.preloop.copy, %L23.preheader13 ]
  %46 = add i64 %value_phi6, %value_phi53, !dbg !47
  %.not36.not = icmp sgt i64 %46, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.not, label %L72, label %L61, !dbg !46

L61:                                              ; preds = %L23
  %gep24 = getelementptr i8, ptr %invariant.gep23, i64 %value_phi6, !dbg !50
  %47 = load i8, ptr %gep24, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %gep57 = getelementptr i8, ptr %invariant.gep, i64 %46, !dbg !50
  %48 = load i8, ptr %gep57, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %.not39 = icmp eq i8 %47, %48, !dbg !63
  br i1 %.not39, label %L67, label %L72, !dbg !46

L67:                                              ; preds = %L61
  %49 = add nuw nsw i64 %value_phi6, 1, !dbg !66
  %exitcond.not55 = icmp eq i64 %49, %smin41, !dbg !68
  br i1 %exitcond.not55, label %main.exit.selector, label %L23, !dbg !68

main.exit.selector:                               ; preds = %L67
  %50 = icmp samesign ult i64 %41, 254, !dbg !68
  br i1 %50, label %main.pseudo.exit, label %L72, !dbg !68

main.pseudo.exit:                                 ; preds = %preloop.pseudo.exit, %main.exit.selector
  %value_phi6.copy = phi i64 [ %value_phi6.preloop.copy, %preloop.pseudo.exit ], [ %smin41, %main.exit.selector ]
  %51 = call i64 @llvm.smax.i64(i64 %value_phi6.copy, i64 254)
  %smax88 = add nuw nsw i64 %51, 1
...
L72:                                              ; preds = %L23.preloop, %L42.preloop, %L23, %L61, %L23.postloop, %L42.postloop, %L67.postloop, %preloop.exit.selector, %main.exit.selector
  %value_phi24 = phi i64 [ %smin41, %main.exit.selector ], [ %smax87, %preloop.exit.selector ], [ %smax88, %L67.postloop ], [ %value_phi6, %L23 ], [ %value_phi6.postloop, %L42.postloop ], [ %value_phi6.postloop, %L23.postloop ], [ %value_phi6, %L61 ], [ %value_phi6.preloop, %L42.preloop ], [ %value_phi6.preloop, %L23.preloop ]
  %value_phi5.value_phi24 = call i64 @llvm.smax.i64(i64 %value_phi551, i64 %value_phi24), !dbg !78
  %52 = add nsw i64 %value_phi450, 1, !dbg !79
  %indvar.next = add nuw i64 %indvar, 1, !dbg !45
  %indvars.iv.next = add i64 %indvars.iv, 1, !dbg !45
  %exitcond89.not = icmp eq i64 %indvar.next, %39, !dbg !44
  br i1 %exitcond89.not, label %L79, label %L23.preheader, !dbg !45

L79:                                              ; preds = %L72, %L12
  %value_phi5.lcssa = phi i64 [ 0, %L12 ], [ %value_phi5.value_phi24, %L72 ]
  %53 = icmp sgt i64 %value_phi5.lcssa, 2, !dbg !81
  %value_phi28.v = select i1 %53, i64 %value_phi5.lcssa, i64 1, !dbg !83
  %value_phi28 = add i64 %value_phi28.v, %value_phi53, !dbg !83
  %54 = zext i1 %53 to i64, !dbg !83
  %value_phi29 = add i64 %value_phi154, %54, !dbg !83
...
L88:                                              ; preds = %L79, %L79.mv.fast, %L8.preheader
  ...
  ret i64 %value_phi1.lcssa, !dbg !84

L89:                                              ; preds = %top
  %55 = call swiftcc [1 x ptr] @j_ArgumentError_148(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#149.jit"), !dbg !35
  %gc_slot_addr_0 = getelementptr inbounds nuw i8, ptr %gcframe1, i64 16
  %56 = extractvalue [1 x ptr] %55, 0, !dbg !35
  store ptr %56, ptr %gc_slot_addr_0, align 16
  ...
  store atomic i64 4839720944, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !35, !tbaa !85
  store ptr %56, ptr %"box::ArgumentError", align 8, !dbg !35, !tbaa !87, !alias.scope !55, !noalias !58
...
L23.preloop:                                      ; preds = %L23.preheader, %L67.preloop
  %value_phi6.preloop = phi i64 [ %62, %L67.preloop ], [ 0, %L23.preheader ]
  %57 = add i64 %value_phi6.preloop, %value_phi53, !dbg !47
  %.not36.preloop.not = icmp sgt i64 %57, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.preloop.not, label %L72, label %L27.preloop, !dbg !46

L27.preloop:                                      ; preds = %L23.preloop
  %58 = add i64 %value_phi6.preloop, %value_phi450, !dbg !47
  %59 = add i64 %58, -1, !dbg !90
  %.not37.preloop = icmp ult i64 %59, %"data::Array.size.0.copyload", !dbg !90
  br i1 %.not37.preloop, label %L42.preloop, label %odessy.chk1, !dbg !90

L42.preloop:                                      ; preds = %L27.preloop
  %gep.preloop = getelementptr i8, ptr %invariant.gep, i64 %58, !dbg !50
  %60 = load i8, ptr %gep.preloop, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %gep57.preloop = getelementptr i8, ptr %invariant.gep, i64 %57, !dbg !50
  %61 = load i8, ptr %gep57.preloop, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %.not39.preloop = icmp eq i8 %60, %61, !dbg !63
  br i1 %.not39.preloop, label %L67.preloop, label %L72, !dbg !46

L67.preloop:                                      ; preds = %L42.preloop
  %62 = add nuw nsw i64 %value_phi6.preloop, 1, !dbg !66
  %exitcond.not = icmp eq i64 %smin86, %62, !dbg !68
  br i1 %exitcond.not, label %preloop.exit.selector, label %L23.preloop, !dbg !68, !llvm.loop !69, !loop_constrainer.loop.clone !10

preloop.exit.selector:                            ; preds = %L67.preloop
  %63 = icmp sgt i64 %42, -255, !dbg !68
  br i1 %63, label %preloop.pseudo.exit, label %L72, !dbg !68
...
preloop.pseudo.exit:                              ; preds = %preloop.exit.selector, %L23.preheader
  ...
  %64 = icmp sgt i64 %smin66, %value_phi6.preloop.copy
  br i1 %64, label %L23.preheader13, label %main.pseudo.exit

L23.preheader13:                                  ; preds = %preloop.pseudo.exit
  %invariant.gep23 = getelementptr i8, ptr %invariant.gep, i64 %value_phi450, !dbg !46
  br label %L23, !dbg !46

L23.postloop:                                     ; preds = %L67.postloop, %main.pseudo.exit
  %value_phi6.postloop = phi i64 [ %70, %L67.postloop ], [ %value_phi6.copy, %main.pseudo.exit ]
  %65 = add i64 %value_phi6.postloop, %value_phi53, !dbg !47
  %.not36.postloop.not = icmp sgt i64 %65, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.postloop.not, label %L72, label %L27.postloop, !dbg !46

L27.postloop:                                     ; preds = %L23.postloop
  %66 = add i64 %value_phi6.postloop, %value_phi450, !dbg !47
  %67 = add i64 %66, -1, !dbg !90
  %.not37.postloop = icmp ult i64 %67, %"data::Array.size.0.copyload", !dbg !90
  br i1 %.not37.postloop, label %L42.postloop, label %odessy.chk, !dbg !90

L42.postloop:                                     ; preds = %L27.postloop
  %gep.postloop = getelementptr i8, ptr %invariant.gep, i64 %66, !dbg !50
  %68 = load i8, ptr %gep.postloop, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %gep57.postloop = getelementptr i8, ptr %invariant.gep, i64 %65, !dbg !50
  %69 = load i8, ptr %gep57.postloop, align 1, !dbg !50, !tbaa !52, !alias.scope !55, !noalias !58
  %.not39.postloop = icmp eq i8 %68, %69, !dbg !63
  br i1 %.not39.postloop, label %L67.postloop, label %L72, !dbg !46

L67.postloop:                                     ; preds = %L42.postloop
  %70 = add nuw nsw i64 %value_phi6.postloop, 1, !dbg !66
  %71 = icmp samesign ult i64 %value_phi6.postloop, 254, !dbg !74
  br i1 %71, label %L23.postloop, label %L72, !dbg !68, !llvm.loop !77, !loop_constrainer.loop.clone !10
...
top:
  ...
  %.unbox = load i64, ptr %3, align 8, !tbaa !87, !alias.scope !55, !noalias !58
...
!69 = distinct !{!69, !70, !71, !72, !73}
!70 = !{!"llvm.loop.unroll.disable"}
!71 = !{!"llvm.loop.vectorize.enable", i1 false}
!72 = !{!"llvm.loop.licm_versioning.disable"}
!73 = !{!"llvm.loop.distribute.enable", i1 false}
!74 = !DILocation(line: 520, scope: !33, inlinedAt: !75)
!75 = !DILocation(line: 472, scope: !76, inlinedAt: !68)
!76 = distinct !DISubprogram(name: ">=;", linkageName: ">=", scope: !42, file: !42, type: !30, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2)
!77 = distinct !{!77, !70, !71, !72, !73}
!78 = !DILocation(line: 22, scope: !4)
!79 = !DILocation(line: 87, scope: !48, inlinedAt: !80)
!80 = !DILocation(line: 25, scope: !4)
!81 = !DILocation(line: 520, scope: !33, inlinedAt: !82)
!82 = !DILocation(line: 472, scope: !76, inlinedAt: !83)
!83 = !DILocation(line: 27, scope: !4)
!84 = !DILocation(line: 34, scope: !4)
!85 = !{!86, !86, i64 0}
!86 = !{!"jtbaa_tag", !54, i64 0}
!87 = !{!88, !88, i64 0}
!88 = !{!"jtbaa_immut", !89, i64 0}
!89 = !{!"jtbaa_value", !54, i64 0}
!90 = !DILocation(line: 919, scope: !51, inlinedAt: !46)
!91 = !{!62}
!92 = !{!59, !60, !56, !61}
!93 = !{i64 24}
!94 = !{i64 8}
