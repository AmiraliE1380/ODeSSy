; ModuleID = 'results/static/guard_competitors/Julia_lz77_bounded/irce.ll'
...
L23:                                              ; preds = %L23.preheader5, %L67
  ...
  %.not36.not.not = icmp sgt i64 %15, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.not.not, label %L72, label %L61, !dbg !46
...
L72:                                              ; preds = %L23.preloop, %L61.preloop, %L23, %L61, %L23.postloop, %L61.postloop, %L67.postloop, %preloop.exit.selector, %main.exit.selector
  %value_phi24 = phi i64 [ %smin20, %main.exit.selector ], [ %smax87, %preloop.exit.selector ], [ %smax88, %L67.postloop ], [ %value_phi6, %L23 ], [ %value_phi6.postloop, %L61.postloop ], [ %value_phi6.postloop, %L23.postloop ], [ %value_phi6, %L61 ], [ %value_phi6.preloop, %L61.preloop ], [ %value_phi6.preloop, %L23.preloop ]
...
L23.preloop:                                      ; preds = %L23.preheader, %L67.preloop
  ...
  %.not36.preloop.not.not = icmp sgt i64 %26, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.preloop.not.not, label %L72, label %L27.preloop, !dbg !46
...
L23.postloop:                                     ; preds = %L67.postloop, %main.pseudo.exit
  ...
  %.not36.postloop.not.not = icmp sgt i64 %35, %"data::Array.size.0.copyload", !dbg !49
  br i1 %.not36.postloop.not.not, label %L72, label %L27.postloop, !dbg !46
