...
L27.preloop.mv.fast:                              ; preds = %L23.preloop.mv.fast
  ...
  br i1 true, label %L42.preloop.mv.fast, label %odessy.chk1, !dbg !50
...
L27.postloop.mv.fast:                             ; preds = %L23.postloop.mv.fast
  ...
  br i1 true, label %L42.postloop.mv.fast, label %odessy.chk, !dbg !50
...
odessy.chk:                                       ; preds = %L27.postloop.mv.fast, %L27.postloop
  call void @odessy.chk(i32 0)
  unreachable

odessy.chk1:                                      ; preds = %L27.preloop.mv.fast, %L27.preloop
