; ModuleID = 'results/static/guard_competitors/Swift_sha256/mv.ll'
...
.loopexit..loopexit.thread_crit_edge:             ; preds = %.loopexit
  %.pre168 = load i32, ptr %219, align 8
  br label %.loopexit.thread

.loopexit.thread:                                 ; preds = %400, %.loopexit..loopexit.thread_crit_edge
  %258 = phi i32 [ %.pre168, %.loopexit..loopexit.thread_crit_edge ], [ %401, %400 ]
...
.preheader.preheader.preheader:                   ; preds = %323
  ...
  br i1 %mv.h, label %.preheader.preheader.mv.fast, label %.preheader.preheader.preheader25.split

.preheader.preheader.preheader25.split:           ; preds = %.preheader.preheader.preheader
  %.not13891 = icmp samesign ugt i64 %267, 16
  br i1 %.not13891, label %.preheader.preheader, label %odessy.chk12, !prof !49

.preheader.preheader.mv.fast:                     ; preds = %.preheader.preheader.preheader, %.preheader.preheader.mv.fast
  %330 = phi i64 [ %331, %.preheader.preheader.mv.fast ], [ 16, %.preheader.preheader.preheader ]
  %331 = add nuw nsw i64 %330, 1
  %332 = getelementptr [4 x i8], ptr %229, i64 %330
  %333 = getelementptr i8, ptr %332, i64 -60
  %334 = load i32, ptr %333, align 4
  %335 = call i32 @llvm.fshl.i32(i32 %334, i32 %334, i32 25)
  %336 = call i32 @llvm.fshl.i32(i32 %334, i32 %334, i32 14)
  %337 = xor i32 %335, %336
  %338 = lshr i32 %334, 3
  %339 = xor i32 %337, %338
  ...
  %352 = icmp eq i64 %331, 64
  br i1 %352, label %.loopexit24, label %.preheader.preheader.mv.fast

.loopexit24:                                      ; preds = %.preheader.preheader.mv.fast
...
.preheader.preheader:                             ; preds = %.preheader.preheader.preheader25.split, %.preheader.preheader
  %378 = phi i64 [ %387, %.preheader.preheader ], [ 16, %.preheader.preheader.preheader25.split ]
...
odessy.chk12:                                     ; preds = %.preheader.preheader, %.preheader.preheader.preheader25.split
