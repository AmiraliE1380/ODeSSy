...
.preheader.preheader:                             ; preds = %.preheader.preheader.preheader, %310
  ...
  br i1 %exitcond.not111, label %odessy.chk10, label %300, !prof !44
...
300:                                              ; preds = %.preheader.preheader
  ...
  br i1 %exitcond77.not, label %odessy.chk11, label %309, !prof !44

309:                                              ; preds = %300
  %exitcond79.not = icmp eq i64 %298, %umax78
  br i1 %exitcond79.not, label %odessy.chk12, label %310, !prof !44
...
odessy.chk19:                                     ; preds = %290
  call void @odessy.chk(i32 19)
  unreachable

odessy.chk20:                                     ; preds = %293
  call void @odessy.chk(i32 20)
  unreachable

odessy.chk21:                                     ; preds = %296
