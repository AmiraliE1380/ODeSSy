; ModuleID = 'logs/swift_triage/sha256.ll'
...
315:                                              ; preds = %.preheader.preheader
  ...
  br i1 %.not135, label %324, label %odessy.chk11, !prof !45

324:                                              ; preds = %315
  %.not138 = icmp samesign ult i64 %312, %264
  br i1 %.not138, label %325, label %odessy.chk12, !prof !45
...
390:                                              ; preds = %193
  ...
  %Destroy = load ptr, ptr %391, align 8, !invariant.load !41
