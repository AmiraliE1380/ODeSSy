; ModuleID = 'results/static/guard_competitors/Julia_jl_poly/tag.ll'
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %34, label %scalar.ph.loopexit, label %vector.body, !llvm.loop !73

scalar.ph.loopexit:                               ; preds = %vector.body
  br label %scalar.ph, !dbg !46

scalar.ph:                                        ; preds = %scalar.ph.loopexit, %vector.scevcheck, %L16
  %bc.resume.val = phi i64 [ 1, %L16 ], [ 1, %vector.scevcheck ], [ %ind.end, %scalar.ph.loopexit ]
  br label %L36, !dbg !46

L36:                                              ; preds = %L74, %scalar.ph
  %value_phi8 = phi i64 [ %40, %L74 ], [ %bc.resume.val, %scalar.ph ]
  %exitcond.not = icmp ne i64 %value_phi8, %5, !dbg !46
  br i1 %exitcond.not, label %L74, label %odessy.chk, !dbg !46
...
L90.loopexit:                                     ; preds = %L74
  ...
  br i1 %.not40.not, label %L100.loopexit, label %L16, !dbg !88

L100.loopexit:                                    ; preds = %L90.loopexit
  br label %L100, !dbg !89

L100:                                             ; preds = %L100.loopexit, %L16.preheader, %top
