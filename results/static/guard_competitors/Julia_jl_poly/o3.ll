...
L36.us:                                           ; preds = %L74.us, %L16.us
  ...
  %exitcond.not.us = icmp eq i64 %value_phi8.us, %5, !dbg !46
  br i1 %exitcond.not.us, label %odessy.chk, label %L74.us, !dbg !46
...
L36.us7:                                          ; preds = %L74.us10, %L16.us1
  ...
  %exitcond.not.us9 = icmp eq i64 %value_phi8.us8, %5, !dbg !46
  br i1 %exitcond.not.us9, label %odessy.chk, label %L74.us10, !dbg !46
