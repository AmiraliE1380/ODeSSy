; ModuleID = 'results/static/guard_competitors/Julia_jl_poly/nofold.ll'
...
L16.preheader.split:                              ; preds = %L16.preheader
  %5 = add nsw i64 %value_phi4, -1, !dbg !45
  %umin = tail call i64 @llvm.umin.i64(i64 %3, i64 %5), !dbg !45
  %umin.fr = freeze i64 %umin
  %6 = add nuw i64 %umin.fr, 1, !dbg !45
  %min.iters.check = icmp ult i64 %umin.fr, 8
  %mul.result = shl i64 %umin.fr, 3
  %n.mod.vf = and i64 %6, 7
  %7 = icmp eq i64 %n.mod.vf, 0
  %8 = select i1 %7, i64 8, i64 %n.mod.vf
  %n.vec = sub nuw nsw i64 %6, %8
...
L16.us:                                           ; preds = %L16.preheader.split, %L90.loopexit.us
  %value_phi3.us = phi i64 [ %15, %L90.loopexit.us ], [ 1, %L16.preheader.split ]
...
L36.us:                                           ; preds = %L36.us, %L16.us
  %value_phi8.us = phi i64 [ %14, %L36.us ], [ 1, %L16.us ]
  ...
  %9 = load double, ptr %gep.us, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %10 = fmul double %"c3::Float64", %9, !dbg !62
  %11 = fadd double %"c2::Float64", %10, !dbg !66
  %12 = fmul double %9, %11, !dbg !62
  %13 = fadd double %"c1::Float64", %12, !dbg !66
  store double %13, ptr %gep.us, align 8, !dbg !68, !tbaa !51, !alias.scope !54, !noalias !57
  %.not39.not.us = icmp eq i64 %value_phi8.us, %value_phi4, !dbg !73
  %14 = add nuw i64 %value_phi8.us, 1, !dbg !76
  br i1 %.not39.not.us, label %L90.loopexit.us, label %L36.us, !dbg !77, !llvm.loop !78

L90.loopexit.us:                                  ; preds = %L36.us
  %.not40.not.us = icmp eq i64 %value_phi3.us, %".iters::Int64", !dbg !80
  %15 = add nuw i64 %value_phi3.us, 1, !dbg !81
...
L16.us1:                                          ; preds = %L16.preheader.split.split, %L90.loopexit.us12
  %value_phi3.us2 = phi i64 [ %22, %L90.loopexit.us12 ], [ 1, %L16.preheader.split.split ]
...
L36.us7:                                          ; preds = %L36.us7, %L16.us1
  %value_phi8.us8 = phi i64 [ %21, %L36.us7 ], [ 1, %L16.us1 ]
  %memoryref_offset.us9 = shl i64 %value_phi8.us8, 3, !dbg !50
  %gep.us10 = getelementptr i8, ptr %invariant.gep.us4, i64 %memoryref_offset.us9, !dbg !50
  %16 = load double, ptr %gep.us10, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %17 = fmul double %"c3::Float64", %16, !dbg !62
  %18 = fadd double %"c2::Float64", %17, !dbg !66
  %19 = fmul double %16, %18, !dbg !62
  %20 = fadd double %"c1::Float64", %19, !dbg !66
  store double %20, ptr %gep.us10, align 8, !dbg !68, !tbaa !51, !alias.scope !54, !noalias !57
  %.not39.not.us11 = icmp eq i64 %value_phi8.us8, %value_phi4, !dbg !73
  %21 = add nuw i64 %value_phi8.us8, 1, !dbg !76
  br i1 %.not39.not.us11, label %L90.loopexit.us12, label %L36.us7, !dbg !77, !llvm.loop !78

L90.loopexit.us12:                                ; preds = %L36.us7
  %.not40.not.us13 = icmp eq i64 %value_phi3.us2, %".iters::Int64", !dbg !80
  %22 = add nuw i64 %value_phi3.us2, 1, !dbg !81
  br i1 %.not40.not.us13, label %L100, label %L16.us1, !dbg !82

L16:                                              ; preds = %L16.preheader.split.split, %L90.loopexit
  %value_phi3 = phi i64 [ %52, %L90.loopexit ], [ 1, %L16.preheader.split.split ]
  %memoryref_data = load ptr, ptr %"a::Array", align 8
  %invariant.gep = getelementptr i8, ptr %memoryref_data, i64 -8, !dbg !46
  %23 = getelementptr i8, ptr %memoryref_data, i64 %mul.result, !dbg !46
  %24 = icmp ult ptr %23, %memoryref_data, !dbg !46
  br i1 %24, label %L36.preheader, label %vector.body

vector.body:                                      ; preds = %L16, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %L16 ]
  %offset.idx = shl i64 %index, 3, !dbg !50
  %25 = getelementptr i8, ptr %memoryref_data, i64 %offset.idx, !dbg !50
  %26 = getelementptr i8, ptr %25, i64 16, !dbg !50
  %27 = getelementptr i8, ptr %25, i64 32, !dbg !50
  %28 = getelementptr i8, ptr %25, i64 48, !dbg !50
  %wide.load = load <2 x double>, ptr %25, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %wide.load44 = load <2 x double>, ptr %26, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %wide.load45 = load <2 x double>, ptr %27, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %wide.load46 = load <2 x double>, ptr %28, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %29 = fmul <2 x double> %broadcast.splat, %wide.load, !dbg !62
  %30 = fmul <2 x double> %broadcast.splat, %wide.load44, !dbg !62
  %31 = fmul <2 x double> %broadcast.splat, %wide.load45, !dbg !62
  %32 = fmul <2 x double> %broadcast.splat, %wide.load46, !dbg !62
  %33 = fadd <2 x double> %broadcast.splat48, %29, !dbg !66
  ...
  %37 = fmul <2 x double> %wide.load, %33, !dbg !62
  %38 = fmul <2 x double> %wide.load44, %34, !dbg !62
  %39 = fmul <2 x double> %wide.load45, %35, !dbg !62
  %40 = fmul <2 x double> %wide.load46, %36, !dbg !62
  %41 = fadd <2 x double> %broadcast.splat50, %37, !dbg !66
  ...
  store <2 x double> %41, ptr %25, align 8, !dbg !68, !tbaa !51, !alias.scope !54, !noalias !57
  ...
  br i1 %45, label %L36.preheader, label %vector.body, !llvm.loop !83
...
L36:                                              ; preds = %L36.preheader, %L36
  %value_phi8 = phi i64 [ %51, %L36 ], [ %value_phi8.ph, %L36.preheader ]
  %memoryref_offset = shl i64 %value_phi8, 3, !dbg !50
  %gep = getelementptr i8, ptr %invariant.gep, i64 %memoryref_offset, !dbg !50
  %46 = load double, ptr %gep, align 8, !dbg !50, !tbaa !51, !alias.scope !54, !noalias !57
  %47 = fmul double %"c3::Float64", %46, !dbg !62
  %48 = fadd double %"c2::Float64", %47, !dbg !66
  %49 = fmul double %46, %48, !dbg !62
  %50 = fadd double %"c1::Float64", %49, !dbg !66
  store double %50, ptr %gep, align 8, !dbg !68, !tbaa !51, !alias.scope !54, !noalias !57
  %.not39.not = icmp eq i64 %value_phi8, %value_phi4, !dbg !73
  %51 = add nuw i64 %value_phi8, 1, !dbg !76
  br i1 %.not39.not, label %L90.loopexit, label %L36, !dbg !77, !llvm.loop !78

L90.loopexit:                                     ; preds = %L36
  %.not40.not = icmp eq i64 %value_phi3, %".iters::Int64", !dbg !80
  %52 = add nuw i64 %value_phi3, 1, !dbg !81
  br i1 %.not40.not, label %L100, label %L16, !dbg !82

L100:                                             ; preds = %L90.loopexit, %L90.loopexit.us12, %L90.loopexit.us, %L16.preheader, %top
...
top:
  %pgcstack = call ptr inttoptr (i64 4339269404 to ptr)(i64 4339269440) #3
...
attributes #0 = { nofree norecurse nounwind "julia.fsig"="poly!(Array{Float64, 1}, Float64, Float64, Float64, Int64)" "probe-stack"="inline-asm" }
