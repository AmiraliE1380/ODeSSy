; ModuleID = 'results/static/guard_competitors/Swift_crc32/mv.ll'
...
.mv.ph.mv.fast:                                   ; preds = %5, %.mv.ph.mv.fast
  %23 = phi i32 [ %49, %.mv.ph.mv.fast ], [ -1, %5 ]
  %24 = phi i64 [ %38, %.mv.ph.mv.fast ], [ 0, %5 ]
  ...
  %41 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %29
  %42 = load i32, ptr %41, align 4
  %43 = xor i32 %42, %40
  %44 = getelementptr inbounds nuw [4 x i8], ptr %12, i64 %35
  %45 = load i32, ptr %44, align 4
  %46 = xor i32 %43, %45
  %47 = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %37
  %48 = load i32, ptr %47, align 4
  %49 = xor i32 %46, %48
  %50 = add nuw i64 %24, 8
  %.not39.mv.fast = icmp slt i64 %2, %50
  br i1 %.not39.mv.fast, label %.loopexit12, label %.mv.ph.mv.fast

.mv.ph:                                           ; preds = %5, %72
  %51 = phi i32 [ %84, %72 ], [ -1, %5 ]
  %52 = phi i64 [ %73, %72 ], [ 0, %5 ]
  %53 = getelementptr inbounds nuw i8, ptr %6, i64 %52
  %54 = load i32, ptr %53, align 1
  %55 = xor i32 %54, %51
  %56 = and i32 %55, 255
  %57 = zext nneg i32 %56 to i64
  %.not35 = icmp samesign ugt i64 %19, %57
  br i1 %.not35, label %58, label %odessy.chk6, !prof !45

58:                                               ; preds = %.mv.ph
  %59 = lshr i32 %55, 8
  %60 = and i32 %59, 255
  %61 = zext nneg i32 %60 to i64
  %.not36 = icmp samesign ugt i64 %20, %61
  br i1 %.not36, label %62, label %odessy.chk7, !prof !45

62:                                               ; preds = %58
  %63 = lshr i32 %55, 16
  %64 = and i32 %63, 255
  %65 = zext nneg i32 %64 to i64
  %.not37 = icmp samesign ugt i64 %21, %65
  br i1 %.not37, label %66, label %odessy.chk8, !prof !45

66:                                               ; preds = %62
  %67 = lshr i32 %55, 24
  %68 = zext nneg i32 %67 to i64
  %.not38 = icmp samesign ugt i64 %22, %68
  br i1 %.not38, label %69, label %odessy.chk9, !prof !45

69:                                               ; preds = %66
  %70 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %52, i64 8)
  %71 = extractvalue { i64, i1 } %70, 1
  br i1 %71, label %odessy.chk10, label %72, !prof !44

72:                                               ; preds = %69
  %73 = add nuw nsw i64 %52, 4
  %74 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %61
  %75 = load i32, ptr %74, align 4
  %76 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %57
  %77 = load i32, ptr %76, align 4
  %78 = xor i32 %77, %75
  %79 = getelementptr inbounds nuw [4 x i8], ptr %12, i64 %65
  %80 = load i32, ptr %79, align 4
  %81 = xor i32 %78, %80
  %82 = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %68
  %83 = load i32, ptr %82, align 4
  %84 = xor i32 %81, %83
  %85 = extractvalue { i64, i1 } %70, 0
  %.not39 = icmp slt i64 %2, %85
  br i1 %.not39, label %.loopexit12, label %.mv.ph

.loopexit12:                                      ; preds = %72, %.mv.ph.mv.fast
  %.lcssa1 = phi i64 [ %38, %.mv.ph.mv.fast ], [ %73, %72 ]
  %.lcssa = phi i32 [ %49, %.mv.ph.mv.fast ], [ %84, %72 ]
  %86 = icmp samesign ult i64 %.lcssa1, %2
  br i1 %86, label %87, label %.loopexit

87:                                               ; preds = %.loopexit12, %4
  %88 = phi i32 [ -1, %4 ], [ %.lcssa, %.loopexit12 ]
  %89 = phi i64 [ 0, %4 ], [ %.lcssa1, %.loopexit12 ]
  %90 = getelementptr inbounds nuw i8, ptr %0, i64 32
  call void @llvm.lifetime.start.p0(ptr nonnull %access-scratch)
  call void @swift_beginAccess(ptr nonnull @"$s5crc322t0Says6UInt32VGvp", ptr nonnull %access-scratch, i64 0, ptr null) #2
  %91 = load ptr, ptr @"$s5crc322t0Says6UInt32VGvp", align 8
  %92 = getelementptr inbounds nuw i8, ptr %91, i64 32
  %93 = getelementptr inbounds nuw i8, ptr %91, i64 16
  %94 = load i64, ptr %93, align 8, !range !43
  %umax = call i64 @llvm.umax.i64(i64 %89, i64 %2)
  %mv.h11 = icmp samesign ugt i64 %94, 255
  br i1 %mv.h11, label %.mv.ph12.mv.fast.preheader, label %.mv.ph12

.mv.ph12.mv.fast.preheader:                       ; preds = %87
  %95 = sub nsw i64 %umax, %89
  %96 = add nuw nsw i64 %89, 1
  %umax29 = call i64 @llvm.umax.i64(i64 %2, i64 %96)
  %97 = xor i64 %89, -1
  %98 = add i64 %umax29, %97
  %.not40 = icmp ugt i64 %95, %98
  br i1 %.not40, label %.mv.ph12.mv.fast, label %odessy.chk, !prof !45

.mv.ph12.mv.fast:                                 ; preds = %.mv.ph12.mv.fast.preheader, %.mv.ph12.mv.fast
  %99 = phi i32 [ %108, %.mv.ph12.mv.fast ], [ %88, %.mv.ph12.mv.fast.preheader ]
  %100 = phi i64 [ %104, %.mv.ph12.mv.fast ], [ %89, %.mv.ph12.mv.fast.preheader ]
  %101 = getelementptr inbounds nuw i8, ptr %90, i64 %100
  %102 = load i8, ptr %101, align 1
  %.tr.mv.fast = trunc i32 %99 to i8
  %.narrow.mv.fast = xor i8 %102, %.tr.mv.fast
  %103 = zext i8 %.narrow.mv.fast to i64
  %104 = add i64 %100, 1
  %105 = getelementptr inbounds nuw [4 x i8], ptr %92, i64 %103
  %106 = load i32, ptr %105, align 4
  %107 = lshr i32 %99, 8
  %108 = xor i32 %106, %107
  %exitcond.not41 = icmp eq i64 %104, %umax29
  br i1 %exitcond.not41, label %.loopexit, label %.mv.ph12.mv.fast

.mv.ph12:                                         ; preds = %87, %115
  %109 = phi i32 [ %120, %115 ], [ %88, %87 ]
  %110 = phi i64 [ %116, %115 ], [ %89, %87 ]
  %exitcond.not = icmp eq i64 %110, %umax
  br i1 %exitcond.not, label %odessy.chk, label %111, !prof !44

111:                                              ; preds = %.mv.ph12
  %112 = getelementptr inbounds nuw i8, ptr %90, i64 %110
  %113 = load i8, ptr %112, align 1
  %.tr = trunc i32 %109 to i8
  %.narrow = xor i8 %113, %.tr
  %114 = zext i8 %.narrow to i64
  %.not41 = icmp samesign ugt i64 %94, %114
  br i1 %.not41, label %115, label %odessy.chk1, !prof !45

115:                                              ; preds = %111
  %116 = add nuw nsw i64 %110, 1
  %117 = getelementptr inbounds nuw [4 x i8], ptr %92, i64 %114
  %118 = load i32, ptr %117, align 4
  %119 = lshr i32 %109, 8
  %120 = xor i32 %118, %119
  %121 = icmp samesign ult i64 %116, %2
  br i1 %121, label %.mv.ph12, label %.loopexit

.loopexit:                                        ; preds = %115, %.mv.ph12.mv.fast, %.loopexit12, %4
  %122 = phi i32 [ %.lcssa, %.loopexit12 ], [ -1, %4 ], [ %108, %.mv.ph12.mv.fast ], [ %120, %115 ]
  %123 = xor i32 %122, -1
  ret i32 %123

odessy.chk:                                       ; preds = %.mv.ph12, %.mv.ph12.mv.fast.preheader
  call void @odessy.chk(i32 17)
  unreachable

odessy.chk1:                                      ; preds = %111
...
odessy.chk7:                                      ; preds = %58
  call void @odessy.chk(i32 24)
  unreachable

odessy.chk8:                                      ; preds = %62
  call void @odessy.chk(i32 25)
  unreachable

odessy.chk9:                                      ; preds = %66
  call void @odessy.chk(i32 26)
  unreachable

odessy.chk10:                                     ; preds = %69
