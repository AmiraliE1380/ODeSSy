; ModuleID = 'logs/swift_triage/crc32.ll'
...
65:                                               ; preds = %62
  ...
  %67 = extractvalue { i64, i1 } %66, 1
  br i1 %67, label %odessy.chk10, label %68, !prof !44
...
82:                                               ; preds = %68
  %83 = icmp samesign ult i64 %69, %2
  br i1 %83, label %84, label %.loopexit

84:                                               ; preds = %82, %4
  %85 = phi i32 [ -1, %4 ], [ %80, %82 ]
  %86 = phi i64 [ 0, %4 ], [ %69, %82 ]
...
92:                                               ; preds = %99, %84
  ...
  br i1 %exitcond.not, label %odessy.chk, label %95, !prof !44
...
99:                                               ; preds = %95
  ...
  br i1 %105, label %92, label %.loopexit

.loopexit:                                        ; preds = %99, %82, %4
  %106 = phi i32 [ %80, %82 ], [ -1, %4 ], [ %104, %99 ]
  %107 = xor i32 %106, -1
  ret i32 %107
