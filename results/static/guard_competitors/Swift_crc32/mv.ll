...
32:                                               ; preds = %30
  ...
  br i1 true, label %54, label %odessy.chk6, !prof !45
...
54:                                               ; preds = %32
  ...
  br i1 true, label %58, label %odessy.chk7, !prof !45
...
58:                                               ; preds = %54
  ...
  br i1 true, label %62, label %odessy.chk8, !prof !45

62:                                               ; preds = %58
  %63 = lshr i32 %51, 24
  %64 = zext nneg i32 %63 to i64
  %.not38.mv.fast = icmp samesign ugt i64 %22, %64
  br i1 true, label %65, label %odessy.chk9, !prof !45

65:                                               ; preds = %62
  %66 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %25, i64 8)
  %67 = extractvalue { i64, i1 } %66, 1
  br i1 false, label %odessy.chk10, label %68, !prof !44
...
143:                                              ; preds = %141, %4
  ...
  %mv.h11 = icmp ugt i64 %150, 255
  br i1 %mv.h11, label %.mv.ph12.mv.fast, label %.mv.ph12

.mv.ph12.mv.fast:                                 ; preds = %143
  br label %151

151:                                              ; preds = %158, %.mv.ph12.mv.fast
  %152 = phi i32 [ %144, %.mv.ph12.mv.fast ], [ %163, %158 ]
  %153 = phi i64 [ %145, %.mv.ph12.mv.fast ], [ %159, %158 ]
...
154:                                              ; preds = %151
  ...
  br i1 true, label %158, label %odessy.chk1, !prof !45
...
165:                                              ; preds = %172, %.mv.ph12
  %166 = phi i32 [ %144, %.mv.ph12 ], [ %177, %172 ]
  %167 = phi i64 [ %145, %.mv.ph12 ], [ %173, %172 ]
...
.loopexit.loopexit:                               ; preds = %158, %172
  %.lcssa10 = phi i32 [ %177, %172 ], [ %163, %158 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %141, %4
  %179 = phi i32 [ %.lcssa, %141 ], [ -1, %4 ], [ %.lcssa10, %.loopexit.loopexit ]
  %180 = xor i32 %179, -1
  ret i32 %180
...
odessy.chk6:                                      ; preds = %32, %91
  call void @odessy.chk(i32 23)
  unreachable

odessy.chk7:                                      ; preds = %54, %113
  call void @odessy.chk(i32 24)
  unreachable

odessy.chk8:                                      ; preds = %58, %117
  call void @odessy.chk(i32 25)
  unreachable

odessy.chk9:                                      ; preds = %62, %121
  call void @odessy.chk(i32 26)
  unreachable

odessy.chk10:                                     ; preds = %65, %124
