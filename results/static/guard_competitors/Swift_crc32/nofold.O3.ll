; ModuleID = 'results/static/guard_competitors/Swift_crc32/nofold.ll'
...
5:                                                ; preds = %entry
  ...
  %mv.h = icmp samesign ugt i64 %19, 255
  %mv.h2 = icmp samesign ugt i64 %20, 255
  %mv.h3 = and i1 %mv.h, %mv.h2
  %mv.h4 = icmp samesign ugt i64 %21, 255
  %mv.h5 = and i1 %mv.h3, %mv.h4
  %mv.h6 = icmp samesign ugt i64 %22, 255
  %mv.h7 = and i1 %mv.h5, %mv.h6
  %mv.h8 = icmp samesign ult i64 %2, 4611686018427387905
  %mv.h9 = and i1 %mv.h8, %mv.h7
  br i1 %mv.h9, label %.mv.ph.mv.fast.preheader.preheader, label %.mv.ph

.mv.ph.mv.fast.preheader:                         ; preds = %.mv.ph.mv.fast.preheader.preheader
  %23 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %26, i64 12)
  %24 = extractvalue { i64, i1 } %23, 1
  br i1 %24, label %odessy.fasttrap13, label %.mv.ph.mv.fast.preheader.preheader, !prof !52

.mv.ph.mv.fast.preheader.preheader:               ; preds = %5, %.mv.ph.mv.fast.preheader
  %25 = phi { i64, i1 } [ %23, %.mv.ph.mv.fast.preheader ], [ { i64 8, i1 false }, %5 ]
  %26 = phi i64 [ %41, %.mv.ph.mv.fast.preheader ], [ 0, %5 ]
  %27 = phi i32 [ %52, %.mv.ph.mv.fast.preheader ], [ -1, %5 ]
  ...
  %42 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %38
  %43 = load i32, ptr %42, align 4
  %44 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %40
  %45 = load i32, ptr %44, align 4
  %46 = xor i32 %45, %43
  %47 = getelementptr inbounds nuw [4 x i8], ptr %12, i64 %35
  %48 = load i32, ptr %47, align 4
  %49 = xor i32 %46, %48
  %50 = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %32
  %51 = load i32, ptr %50, align 4
  %52 = xor i32 %49, %51
  %53 = extractvalue { i64, i1 } %25, 0
  %.not39.mv.fast = icmp slt i64 %2, %53
  br i1 %.not39.mv.fast, label %.loopexit17, label %.mv.ph.mv.fast.preheader

.mv.ph:                                           ; preds = %5, %75
  %54 = phi i32 [ %87, %75 ], [ -1, %5 ]
  %55 = phi i64 [ %76, %75 ], [ 0, %5 ]
  %56 = getelementptr inbounds nuw i8, ptr %6, i64 %55
  %57 = load i32, ptr %56, align 1
  %58 = xor i32 %57, %54
  %59 = and i32 %58, 255
  %60 = zext nneg i32 %59 to i64
  %.not35 = icmp samesign ugt i64 %19, %60
  br i1 %.not35, label %61, label %odessy.chk6, !prof !45

61:                                               ; preds = %.mv.ph
  %62 = lshr i32 %58, 8
  %63 = and i32 %62, 255
  %64 = zext nneg i32 %63 to i64
  %.not36 = icmp samesign ugt i64 %20, %64
  br i1 %.not36, label %65, label %odessy.chk7, !prof !45

65:                                               ; preds = %61
  %66 = lshr i32 %58, 16
  %67 = and i32 %66, 255
  %68 = zext nneg i32 %67 to i64
  %.not37 = icmp samesign ugt i64 %21, %68
  br i1 %.not37, label %69, label %odessy.chk8, !prof !45

69:                                               ; preds = %65
  %70 = lshr i32 %58, 24
  %71 = zext nneg i32 %70 to i64
  %.not38 = icmp samesign ugt i64 %22, %71
  br i1 %.not38, label %72, label %odessy.chk9, !prof !45

72:                                               ; preds = %69
  %73 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %55, i64 8)
  %74 = extractvalue { i64, i1 } %73, 1
  br i1 %74, label %odessy.chk10, label %75, !prof !44

75:                                               ; preds = %72
  %76 = add nuw nsw i64 %55, 4
  %77 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %64
  %78 = load i32, ptr %77, align 4
  %79 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %60
  %80 = load i32, ptr %79, align 4
  %81 = xor i32 %80, %78
  %82 = getelementptr inbounds nuw [4 x i8], ptr %12, i64 %68
  %83 = load i32, ptr %82, align 4
  %84 = xor i32 %81, %83
  %85 = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %71
  %86 = load i32, ptr %85, align 4
  %87 = xor i32 %84, %86
  %88 = extractvalue { i64, i1 } %73, 0
  %.not39 = icmp slt i64 %2, %88
  br i1 %.not39, label %.loopexit17, label %.mv.ph

.loopexit17:                                      ; preds = %75, %.mv.ph.mv.fast.preheader.preheader
  %.lcssa1 = phi i64 [ %41, %.mv.ph.mv.fast.preheader.preheader ], [ %76, %75 ]
  %.lcssa = phi i32 [ %52, %.mv.ph.mv.fast.preheader.preheader ], [ %87, %75 ]
  %89 = icmp samesign ult i64 %.lcssa1, %2
  br i1 %89, label %90, label %.loopexit

90:                                               ; preds = %.loopexit17, %4
  %91 = phi i32 [ -1, %4 ], [ %.lcssa, %.loopexit17 ]
  %92 = phi i64 [ 0, %4 ], [ %.lcssa1, %.loopexit17 ]
  %93 = getelementptr inbounds nuw i8, ptr %0, i64 32
  call void @llvm.lifetime.start.p0(ptr nonnull %access-scratch)
  call void @swift_beginAccess(ptr nonnull @"$s5crc322t0Says6UInt32VGvp", ptr nonnull %access-scratch, i64 0, ptr null) #2
  %94 = load ptr, ptr @"$s5crc322t0Says6UInt32VGvp", align 8
  %95 = getelementptr inbounds nuw i8, ptr %94, i64 32
  %96 = getelementptr inbounds nuw i8, ptr %94, i64 16
  %97 = load i64, ptr %96, align 8, !range !43
  %umax = call i64 @llvm.umax.i64(i64 %92, i64 %2)
  %mv.h15 = icmp samesign ugt i64 %97, 255
  br i1 %mv.h15, label %.mv.ph16.mv.fast.preheader, label %.mv.ph16

.mv.ph16.mv.fast.preheader:                       ; preds = %90
  %98 = sub nsw i64 %umax, %92
  %99 = add nuw nsw i64 %92, 1
  %umax34 = call i64 @llvm.umax.i64(i64 %2, i64 %99)
  %100 = xor i64 %92, -1
  %101 = add i64 %umax34, %100
  %.not44 = icmp ugt i64 %98, %101
  br i1 %.not44, label %.mv.ph16.mv.fast.preheader.split, label %odessy.chk, !prof !45

.mv.ph16.mv.fast.preheader.split:                 ; preds = %.mv.ph16.mv.fast.preheader, %.mv.ph16.mv.fast.preheader.split
  %102 = phi i32 [ %111, %.mv.ph16.mv.fast.preheader.split ], [ %91, %.mv.ph16.mv.fast.preheader ]
  %103 = phi i64 [ %107, %.mv.ph16.mv.fast.preheader.split ], [ %92, %.mv.ph16.mv.fast.preheader ]
  %104 = getelementptr inbounds nuw i8, ptr %93, i64 %103
  %105 = load i8, ptr %104, align 1
  %.tr.mv.fast = trunc i32 %102 to i8
  %.narrow.mv.fast = xor i8 %105, %.tr.mv.fast
  %106 = zext i8 %.narrow.mv.fast to i64
  %107 = add nuw i64 %103, 1
  %108 = getelementptr inbounds nuw [4 x i8], ptr %95, i64 %106
  %109 = load i32, ptr %108, align 4
  %110 = lshr i32 %102, 8
  %111 = xor i32 %109, %110
  %exitcond.not45 = icmp eq i64 %107, %umax34
  br i1 %exitcond.not45, label %.loopexit, label %.mv.ph16.mv.fast.preheader.split

.mv.ph16:                                         ; preds = %90, %118
  %112 = phi i32 [ %123, %118 ], [ %91, %90 ]
  %113 = phi i64 [ %119, %118 ], [ %92, %90 ]
  %exitcond.not = icmp eq i64 %113, %umax
  br i1 %exitcond.not, label %odessy.chk, label %114, !prof !44

114:                                              ; preds = %.mv.ph16
  %115 = getelementptr inbounds nuw i8, ptr %93, i64 %113
  %116 = load i8, ptr %115, align 1
  %.tr = trunc i32 %112 to i8
  %.narrow = xor i8 %116, %.tr
  %117 = zext i8 %.narrow to i64
  %.not41 = icmp samesign ugt i64 %97, %117
  br i1 %.not41, label %118, label %odessy.chk1, !prof !45

118:                                              ; preds = %114
  %119 = add nuw nsw i64 %113, 1
  %120 = getelementptr inbounds nuw [4 x i8], ptr %95, i64 %117
  %121 = load i32, ptr %120, align 4
  %122 = lshr i32 %112, 8
  %123 = xor i32 %121, %122
  %124 = icmp samesign ult i64 %119, %2
  br i1 %124, label %.mv.ph16, label %.loopexit

.loopexit:                                        ; preds = %118, %.mv.ph16.mv.fast.preheader.split, %.loopexit17, %4
  %125 = phi i32 [ %.lcssa, %.loopexit17 ], [ -1, %4 ], [ %111, %.mv.ph16.mv.fast.preheader.split ], [ %123, %118 ]
  %126 = xor i32 %125, -1
  ret i32 %126

odessy.chk:                                       ; preds = %.mv.ph16, %.mv.ph16.mv.fast.preheader
  call void @odessy.chk(i32 17)
  unreachable

odessy.chk1:                                      ; preds = %114
  call void @odessy.chk(i32 18)
  unreachable

odessy.chk6:                                      ; preds = %.mv.ph
  call void @odessy.chk(i32 23)
  unreachable

odessy.chk7:                                      ; preds = %61
  call void @odessy.chk(i32 24)
  unreachable

odessy.chk8:                                      ; preds = %65
  call void @odessy.chk(i32 25)
  unreachable

odessy.chk9:                                      ; preds = %69
  call void @odessy.chk(i32 26)
  unreachable

odessy.chk10:                                     ; preds = %72
  call void @odessy.chk(i32 27)
  unreachable

odessy.fasttrap13:                                ; preds = %.mv.ph.mv.fast.preheader
...
; Function Attrs: cold noreturn nounwind
declare void @odessy.fast.trap(i32) local_unnamed_addr #16
