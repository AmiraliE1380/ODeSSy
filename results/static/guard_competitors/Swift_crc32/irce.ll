...
.loopexit118.loopexit:                            ; preds = %79, %84, %87, %92
  %.ph = phi i64 [ 0, %84 ], [ 0, %87 ], [ %93, %92 ], [ 0, %79 ]
  %.ph7 = phi i8 [ 1, %84 ], [ 1, %87 ], [ 0, %92 ], [ 1, %79 ]
  br label %.loopexit118

.loopexit118.loopexit8:                           ; preds = %37, %42, %45, %50
  %.ph9 = phi i64 [ 0, %42 ], [ 0, %45 ], [ %51, %50 ], [ 0, %37 ]
  %.ph10 = phi i8 [ 1, %42 ], [ 1, %45 ], [ 0, %50 ], [ 1, %37 ]
  br label %.loopexit118

.loopexit118.loopexit11:                          ; preds = %60, %65, %68, %73
  %.ph12 = phi i64 [ 0, %65 ], [ 0, %68 ], [ %74, %73 ], [ 0, %60 ]
  %.ph13 = phi i8 [ 1, %65 ], [ 1, %68 ], [ 0, %73 ], [ 1, %60 ]
  br label %.loopexit118

.loopexit118:                                     ; preds = %.loopexit118.loopexit11, %.loopexit118.loopexit8, %.loopexit118.loopexit, %55, %54, %31
  %32 = phi i64 [ 0, %55 ], [ 0, %31 ], [ 0, %54 ], [ %.ph, %.loopexit118.loopexit ], [ %.ph9, %.loopexit118.loopexit8 ], [ %.ph12, %.loopexit118.loopexit11 ]
  %33 = phi i8 [ 1, %55 ], [ 1, %31 ], [ 1, %54 ], [ %.ph7, %.loopexit118.loopexit ], [ %.ph10, %.loopexit118.loopexit8 ], [ %.ph13, %.loopexit118.loopexit11 ]
...
37:                                               ; preds = %50, %34
  ...
  br i1 %or.cond, label %42, label %.loopexit118.loopexit8, !prof !47

42:                                               ; preds = %37
  %43 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %39, i64 10)
  %44 = extractvalue { i64, i1 } %43, 1
  br i1 %44, label %.loopexit118.loopexit8, label %45
...
45:                                               ; preds = %42
  ...
  br i1 %49, label %.loopexit118.loopexit8, label %50, !prof !44

50:                                               ; preds = %45
  %51 = extractvalue { i64, i1 } %48, 0
  %52 = getelementptr inbounds nuw i8, ptr %38, i64 1
  %53 = icmp eq ptr %52, %36
  br i1 %53, label %.loopexit118.loopexit8, label %37
...
60:                                               ; preds = %73, %57
  ...
  br i1 %or.cond42, label %65, label %.loopexit118.loopexit11, !prof !47

65:                                               ; preds = %60
  %66 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %62, i64 10)
  %67 = extractvalue { i64, i1 } %66, 1
  br i1 %67, label %.loopexit118.loopexit11, label %68
...
68:                                               ; preds = %65
  ...
  br i1 %72, label %.loopexit118.loopexit11, label %73, !prof !44

73:                                               ; preds = %68
  %74 = extractvalue { i64, i1 } %71, 0
  %75 = getelementptr inbounds nuw i8, ptr %61, i64 1
  %76 = icmp eq ptr %75, %59
  br i1 %76, label %.loopexit118.loopexit11, label %60
...
79:                                               ; preds = %92, %77
  ...
  br i1 %or.cond43, label %84, label %.loopexit118.loopexit, !prof !47

84:                                               ; preds = %79
  %85 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %81, i64 10)
  %86 = extractvalue { i64, i1 } %85, 1
  br i1 %86, label %.loopexit118.loopexit, label %87
...
87:                                               ; preds = %84
  ...
  br i1 %91, label %.loopexit118.loopexit, label %92, !prof !44

92:                                               ; preds = %87
  %93 = extractvalue { i64, i1 } %90, 0
  %94 = getelementptr inbounds nuw i8, ptr %80, i64 1
  %95 = icmp eq ptr %94, %78
  br i1 %95, label %.loopexit118.loopexit, label %79
...
.thread107.loopexit:                              ; preds = %171, %176, %179, %184
  %.sroa.0.1111.ph = phi i64 [ 0, %176 ], [ 0, %179 ], [ %185, %184 ], [ 0, %171 ]
  %.sroa.6.1110.ph = phi i8 [ 1, %176 ], [ 1, %179 ], [ 0, %184 ], [ 1, %171 ]
  br label %.thread107

.thread107.loopexit1:                             ; preds = %124, %129, %132, %137
  %.sroa.0.1111.ph2 = phi i64 [ 0, %129 ], [ 0, %132 ], [ %138, %137 ], [ 0, %124 ]
  %.sroa.6.1110.ph3 = phi i8 [ 1, %129 ], [ 1, %132 ], [ 0, %137 ], [ 1, %124 ]
  br label %.thread107

.thread107.loopexit4:                             ; preds = %150, %155, %158, %163
  %.sroa.0.1111.ph5 = phi i64 [ 0, %155 ], [ 0, %158 ], [ %164, %163 ], [ 0, %150 ]
  %.sroa.6.1110.ph6 = phi i8 [ 1, %155 ], [ 1, %158 ], [ 0, %163 ], [ 1, %150 ]
  br label %.thread107

.thread107:                                       ; preds = %.thread107.loopexit4, %.thread107.loopexit1, %.thread107.loopexit, %167, %145, %143, %119, %.loopexit118
  %.sroa.0.1111 = phi i64 [ 0, %119 ], [ 0, %143 ], [ 0, %145 ], [ 0, %167 ], [ %32, %.loopexit118 ], [ %.sroa.0.1111.ph, %.thread107.loopexit ], [ %.sroa.0.1111.ph2, %.thread107.loopexit1 ], [ %.sroa.0.1111.ph5, %.thread107.loopexit4 ]
  %.sroa.6.1110 = phi i8 [ 1, %119 ], [ 1, %143 ], [ 1, %145 ], [ 0, %167 ], [ %33, %.loopexit118 ], [ %.sroa.6.1110.ph, %.thread107.loopexit ], [ %.sroa.6.1110.ph3, %.thread107.loopexit1 ], [ %.sroa.6.1110.ph6, %.thread107.loopexit4 ]
...
124:                                              ; preds = %137, %121
  ...
  br i1 %or.cond44, label %129, label %.thread107.loopexit1, !prof !47

129:                                              ; preds = %124
  %130 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %126, i64 10)
  %131 = extractvalue { i64, i1 } %130, 1
  br i1 %131, label %.thread107.loopexit1, label %132
...
150:                                              ; preds = %163, %147
  ...
  br i1 %or.cond45, label %155, label %.thread107.loopexit4, !prof !47

155:                                              ; preds = %150
  %156 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %152, i64 10)
  %157 = extractvalue { i64, i1 } %156, 1
  br i1 %157, label %.thread107.loopexit4, label %158
...
171:                                              ; preds = %184, %169
  ...
  br i1 %or.cond46, label %176, label %.thread107.loopexit, !prof !47

176:                                              ; preds = %171
  %177 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %173, i64 10)
  %178 = extractvalue { i64, i1 } %177, 1
  br i1 %178, label %.thread107.loopexit, label %179
...
.loopexit.loopexit:                               ; preds = %351
  %.lcssa = phi i32 [ %356, %351 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %268
  %345 = phi i32 [ 0, %268 ], [ %.lcssa, %.loopexit.loopexit ]
...
351:                                              ; preds = %351, %270
  ...
  br i1 %357, label %.loopexit.loopexit, label %351
...
23:                                               ; preds = %68, %5
  %24 = phi i32 [ -1, %5 ], [ %80, %68 ]
  %25 = phi i64 [ 0, %5 ], [ %69, %68 ]
  %.not31 = icmp samesign ult i64 %25, %2
  br i1 %.not31, label %26, label %odessy.chk2, !prof !45
...
28:                                               ; preds = %26
  ...
  %.not33 = icmp samesign ult i64 %29, %2
  br i1 %.not33, label %30, label %odessy.chk4, !prof !45

30:                                               ; preds = %28
  %31 = or disjoint i64 %25, 3
  %.not34 = icmp samesign ult i64 %31, %2
  br i1 %.not34, label %32, label %odessy.chk5, !prof !45
...
32:                                               ; preds = %30
  ...
  %.not35 = icmp samesign ugt i64 %19, %53
  br i1 %.not35, label %54, label %odessy.chk6, !prof !45

54:                                               ; preds = %32
  %55 = lshr i32 %51, 8
  %56 = and i32 %55, 255
  %57 = zext nneg i32 %56 to i64
  %.not36 = icmp samesign ugt i64 %20, %57
  br i1 %.not36, label %58, label %odessy.chk7, !prof !45

58:                                               ; preds = %54
  %59 = lshr i32 %51, 16
  %60 = and i32 %59, 255
  %61 = zext nneg i32 %60 to i64
  %.not37 = icmp samesign ugt i64 %21, %61
  br i1 %.not37, label %62, label %odessy.chk8, !prof !45

62:                                               ; preds = %58
  %63 = lshr i32 %51, 24
  %64 = zext nneg i32 %63 to i64
  %.not38 = icmp samesign ugt i64 %22, %64
  br i1 %.not38, label %65, label %odessy.chk9, !prof !45

65:                                               ; preds = %62
  %66 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %25, i64 8)
  %67 = extractvalue { i64, i1 } %66, 1
  %.not3 = xor i1 %67, true
  br i1 %.not3, label %68, label %odessy.chk10, !prof !45
...
68:                                               ; preds = %65
  ...
  %.not39 = icmp slt i64 %2, %81
  br i1 %.not39, label %82, label %23

82:                                               ; preds = %68
  %.lcssa2 = phi i64 [ %69, %68 ]
  %.lcssa1 = phi i32 [ %80, %68 ]
  %83 = icmp samesign ult i64 %.lcssa2, %2
  br i1 %83, label %84, label %.loopexit

84:                                               ; preds = %82, %4
  %85 = phi i32 [ -1, %4 ], [ %.lcssa1, %82 ]
  %86 = phi i64 [ 0, %4 ], [ %.lcssa2, %82 ]
  %87 = getelementptr inbounds nuw i8, ptr %0, i64 32
  call void @llvm.lifetime.start.p0(ptr %access-scratch)
  call void @swift_beginAccess(ptr nonnull @"$s5crc322t0Says6UInt32VGvp", ptr nonnull %access-scratch, i64 0, ptr null) #2
  %88 = load ptr, ptr @"$s5crc322t0Says6UInt32VGvp", align 8
  %89 = getelementptr inbounds nuw i8, ptr %88, i64 32
  %90 = getelementptr inbounds nuw i8, ptr %88, i64 16
  %91 = load i64, ptr %90, align 8, !range !43
  %umax = call i64 @llvm.umax.i64(i64 %86, i64 %2)
  br label %92

92:                                               ; preds = %99, %84
  %93 = phi i32 [ %85, %84 ], [ %104, %99 ]
  %94 = phi i64 [ %86, %84 ], [ %100, %99 ]
  %exitcond.not = icmp ne i64 %94, %umax
  br i1 %exitcond.not, label %95, label %odessy.chk, !prof !45

95:                                               ; preds = %92
  %96 = getelementptr inbounds nuw %Ts5UInt8V, ptr %87, i64 %94
  %97 = load i8, ptr %96, align 1
  %.tr = trunc i32 %93 to i8
  %.narrow = xor i8 %97, %.tr
  %98 = zext i8 %.narrow to i64
  %.not41 = icmp samesign ugt i64 %91, %98
  br i1 %.not41, label %99, label %odessy.chk1, !prof !45

99:                                               ; preds = %95
  %100 = add nuw nsw i64 %94, 1
  %101 = getelementptr inbounds nuw %Ts6UInt32V, ptr %89, i64 %98
  %102 = load i32, ptr %101, align 4
  %103 = lshr i32 %93, 8
  %104 = xor i32 %102, %103
  %105 = icmp samesign ult i64 %100, %2
  br i1 %105, label %92, label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %99
  %.lcssa = phi i32 [ %104, %99 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %82, %4
  %106 = phi i32 [ %.lcssa1, %82 ], [ -1, %4 ], [ %.lcssa, %.loopexit.loopexit ]
  %107 = xor i32 %106, -1
  ret i32 %107
