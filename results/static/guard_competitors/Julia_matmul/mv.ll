...
L14.mv.fast24:                                    ; preds = %L14.mv.ph.mv.fast36, %L52.mv.fast30
  ...
  br i1 true, label %L31.mv.fast28, label %odessy.chk, !dbg !39
...
L10.L60_crit_edge.mv.fast:                        ; preds = %L52.mv.fast.mv.fast, %L52.mv.fast30
  ...
  br i1 true, label %L77.mv.fast, label %odessy.chk2, !dbg !64
...
L14.mv.fast.mv.fast:                              ; preds = %L52.mv.fast.mv.fast, %L14.mv.ph.mv.fast.mv.fast
  ...
  br i1 true, label %L31.mv.fast.mv.fast, label %odessy.chk, !dbg !39
...
L31.mv.fast.mv.fast:                              ; preds = %L14.mv.fast.mv.fast
  ...
  br i1 true, label %L52.mv.fast.mv.fast, label %odessy.chk1, !dbg !39
...
L31.mv.fast:                                      ; preds = %L14.mv.fast
  ...
  br i1 true, label %L52.mv.fast, label %odessy.chk1, !dbg !39
...
odessy.chk:                                       ; preds = %L14.mv.fast.mv.fast, %L14.mv.fast24, %L14.mv.fast, %L14
  call void @odessy.chk(i32 0)
  unreachable

odessy.chk1:                                      ; preds = %L31.mv.fast.mv.fast, %L31.mv.fast28, %L31.mv.fast, %L31
  call void @odessy.chk(i32 1)
  unreachable

odessy.chk2:                                      ; preds = %L10.L60_crit_edge.mv.fast, %L10.L60_crit_edge
