...
L6.preheader:                                     ; preds = %L6.L84_crit_edge.split, %L6.preheader.lr.ph.split.split
  ...
  %value_phi45 = phi i64 [ 1, %L6.preheader.lr.ph.split.split ], [ %19, %L6.L84_crit_edge.split ]
...
L10.preheader:                                    ; preds = %L77, %L6.preheader
  %value_phi143 = phi i64 [ 1, %L6.preheader ], [ %18, %L77 ]
...
L14:                                              ; preds = %L52, %L10.preheader
  %value_phi341 = phi i64 [ 0, %L10.preheader ], [ %14, %L52 ]
  %value_phi240 = phi i64 [ 1, %L10.preheader ], [ %15, %L52 ]
...
L28:                                              ; No predecessors!
  %umax = call i64 @llvm.umax.i64(i64 poison, i64 poison), !dbg !34
  %6 = add i64 %umax, 1, !dbg !34
  store i64 %6, ptr %"new::Tuple15", align 8, !dbg !39, !tbaa !42, !alias.scope !44, !noalias !47
...
L31:                                              ; preds = %L14
  %7 = add i64 %value_phi240, -1, !dbg !52
  %8 = mul i64 %7, %"n::Int64", !dbg !54
  %9 = add i64 %8, %value_phi143, !dbg !36
  %10 = add i64 %9, -1, !dbg !39
  %.not32 = icmp ult i64 %10, %"b::Array.size.0.copyload", !dbg !39
  br i1 %.not32, label %L52, label %odessy.chk1, !dbg !39

L49:                                              ; No predecessors!
  store i64 poison, ptr %"new::Tuple", align 8, !dbg !39, !tbaa !42, !alias.scope !44, !noalias !47
...
L52:                                              ; preds = %L31
  ...
  %11 = load i64, ptr %gep, align 8, !dbg !56, !tbaa !57, !alias.scope !60, !noalias !61
  %memoryref_offset8 = shl i64 %9, 3, !dbg !56
  %gep47 = getelementptr i8, ptr %invariant.gep46, i64 %memoryref_offset8, !dbg !56
  %12 = load i64, ptr %gep47, align 8, !dbg !56, !tbaa !57, !alias.scope !60, !noalias !61
  %13 = mul i64 %12, %11, !dbg !54
  %14 = add i64 %13, %value_phi341, !dbg !36
  %15 = add i64 %value_phi240, 1, !dbg !62
  %.not30 = icmp sgt i64 %15, %"n::Int64", !dbg !64
  br i1 %.not30, label %L10.L60_crit_edge, label %L14, !dbg !35

L10.L60_crit_edge:                                ; preds = %L52
  %.lcssa = phi i64 [ %14, %L52 ], !dbg !36
  %16 = add i64 %value_phi143, %3, !dbg !65
  %17 = add i64 %16, -1, !dbg !67
  %.not33 = icmp ult i64 %17, %"c::Array.size.0.copyload", !dbg !73
  br i1 %.not33, label %L77, label %odessy.chk2, !dbg !68

L74:                                              ; No predecessors!
  store i64 poison, ptr %"new::Tuple27", align 8, !dbg !68, !tbaa !42, !alias.scope !44, !noalias !47
  call swiftcc void @j_throw_boundserror_147(ptr nonnull swiftself %pgcstack, ptr nonnull %"c::Array", ptr nonnull readonly captures(none) %"new::Tuple27") #9, !dbg !68
  unreachable, !dbg !68

L77:                                              ; preds = %L10.L60_crit_edge
  %memoryref_offset20 = shl i64 %16, 3, !dbg !75
  %gep49 = getelementptr i8, ptr %invariant.gep48, i64 %memoryref_offset20, !dbg !75
  store i64 %.lcssa, ptr %gep49, align 8, !dbg !75, !tbaa !57, !alias.scope !60, !noalias !61
  %18 = add i64 %value_phi143, 1, !dbg !76
  %.not29 = icmp sgt i64 %18, %"n::Int64", !dbg !78
  br i1 %.not29, label %L6.L84_crit_edge.split, label %L10.preheader, !dbg !34

L6.L84_crit_edge.split:                           ; preds = %L77
  %19 = add i64 %value_phi45, 1, !dbg !79
  %.not = icmp sgt i64 %19, %"n::Int64", !dbg !29
  %indvars.iv.next = add i64 %indvars.iv, %"n::Int64", !dbg !33
  br i1 %.not, label %L86.loopexit, label %L6.preheader, !dbg !33

L86.loopexit:                                     ; preds = %L6.L84_crit_edge.split
  br label %L86, !dbg !81

L86:                                              ; preds = %L86.loopexit, %top
