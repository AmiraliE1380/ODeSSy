...
L37.us1021:                                       ; preds = %L322.loopexit.split.us.us, %L37.us1021.preheader
  ...
  br i1 false, label %odessy.chk3, label %L55.us662.us.preheader
...
L55.us662.us:                                     ; preds = %L85.us.us, %scalar.ph1610
  ...
  br i1 true, label %L85.us.us, label %odessy.chk2, !dbg !80
...
L37:                                              ; preds = %L322.loopexit.split, %L37.preheader1455
  ...
  %.fr578 = freeze i1 %23
  br i1 false, label %odessy.chk1, label %L55.preheader.split
...
L55.preheader.split:                              ; preds = %L37
  ...
  %.fr = freeze i1 %27
  br i1 false, label %odessy.chk8, label %L55.preheader
...
L55:                                              ; preds = %L311.loopexit, %L55.preheader
  ...
  br i1 true, label %L85, label %odessy.chk, !dbg !80
...
L133.preheader.split.split.us:                    ; preds = %L85
  ...
  br i1 true, label %odessy.chk7, label %L220, !dbg !127
...
L163.peel:                                        ; preds = %L133.preheader.split.split.split
  ...
  br i1 false, label %odessy.chk10, label %L223.peel, !dbg !127

L223.peel:                                        ; preds = %L163.peel
  %.not1445 = icmp eq i64 %.size77.sroa.0.0.copyload, 0, !dbg !136
  br i1 false, label %odessy.chk13, label %L285.peel, !dbg !140
...
L133:                                             ; preds = %L285, %scalar.ph
  ...
  br i1 true, label %L163, label %odessy.chk4, !dbg !127
...
L163:                                             ; preds = %L133
  ...
  br i1 true, label %L223, label %odessy.chk9, !dbg !127
...
L223:                                             ; preds = %L163
  ...
  br i1 true, label %L285, label %odessy.chk12, !dbg !140
