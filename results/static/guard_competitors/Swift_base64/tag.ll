; ModuleID = 'logs/swift_triage/base64.ll'
...
193:                                              ; preds = %188
  ...
  br i1 %.not70, label %200, label %296
...
221:                                              ; preds = %292, %212
  %222 = phi i64 [ 0, %212 ], [ %293, %292 ]
  %223 = phi i64 [ 0, %212 ], [ %224, %292 ]
  %224 = add nuw i64 %223, 1
  br i1 %216, label %227, label %225

225:                                              ; preds = %221
  %226 = icmp eq i64 %224, %208
  br i1 %226, label %294, label %292
...
229:                                              ; preds = %294, %210
  %230 = phi i64 [ %295, %294 ], [ 0, %210 ]
  %231 = call ptr @__swift_instantiateConcreteTypeFromMangledNameV2(ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMd", ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMR") #15
  %232 = call noalias ptr @swift_allocObject(ptr %231, i64 64, i64 7) #2
  %233 = getelementptr inbounds nuw i8, ptr %232, i64 16
  store <2 x i64> <i64 1, i64 2>, ptr %233, align 8
  %234 = getelementptr inbounds nuw i8, ptr %232, i64 32
  %235 = getelementptr inbounds nuw i8, ptr %232, i64 56
  store ptr @"$ss6UInt64VN", ptr %235, align 8
  store i64 %230, ptr %234, align 8
  call swiftcc void @"$ss5print_9separator10terminatoryypd_S2StF"(ptr %232, i64 32, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr), i64 10, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr))
  call void @swift_release(ptr %232) #2
  call void @llvm.lifetime.end.p0(ptr %7)
  ret i32 0

236:                                              ; preds = %269, %227
  %237 = phi i64 [ 0, %227 ], [ %286, %269 ]
  %238 = phi i64 [ 0, %227 ], [ %270, %269 ]
  %239 = phi i64 [ 2, %227 ], [ %287, %269 ]
  %.not72 = icmp samesign ult i64 %238, %215
  br i1 %.not72, label %240, label %odessy.chk5, !prof !45

240:                                              ; preds = %236
  %241 = getelementptr inbounds nuw %Ts5UInt8V, ptr %217, i64 %238
  %242 = load i8, ptr %241, align 1
  %243 = add nuw nsw i64 %238, 1
  %.not73 = icmp samesign ult i64 %243, %215
  br i1 %.not73, label %244, label %odessy.chk6, !prof !45

244:                                              ; preds = %240
  %245 = getelementptr inbounds nuw %Ts5UInt8V, ptr %217, i64 %243
  %246 = load i8, ptr %245, align 1
  %247 = getelementptr inbounds nuw %Ts5UInt8V, ptr %217, i64 %239
  %248 = load i8, ptr %247, align 1
  %249 = lshr i8 %242, 2
  %250 = zext nneg i8 %249 to i64
  %.not75 = icmp samesign ugt i64 %228, %250
  br i1 %.not75, label %251, label %odessy.chk7, !prof !45
...
251:                                              ; preds = %244
  ...
  %.not76 = icmp samesign ugt i64 %228, %256
  br i1 %.not76, label %257, label %odessy.chk8, !prof !45

257:                                              ; preds = %251
  %258 = shl i8 %246, 2
  %259 = and i8 %258, 60
  %260 = lshr i8 %248, 6
  %261 = or disjoint i8 %260, %259
  %262 = zext nneg i8 %261 to i64
  %.not77 = icmp samesign ugt i64 %228, %262
  br i1 %.not77, label %263, label %odessy.chk9, !prof !45

263:                                              ; preds = %257
  %264 = and i8 %248, 63
  %265 = zext nneg i8 %264 to i64
  %.not78 = icmp samesign ugt i64 %228, %265
  br i1 %.not78, label %266, label %odessy.chk10, !prof !45

266:                                              ; preds = %263
  %267 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %238, i64 5)
  %268 = extractvalue { i64, i1 } %267, 1
  br i1 %268, label %odessy.chk11, label %269, !prof !44

269:                                              ; preds = %266
  %270 = add nuw nsw i64 %238, 3
  %271 = getelementptr inbounds nuw %Ts5UInt8V, ptr %219, i64 %262
  %272 = load i8, ptr %271, align 1
  %273 = zext i8 %272 to i64
  %274 = add i64 %237, %273
  %275 = getelementptr inbounds nuw %Ts5UInt8V, ptr %219, i64 %250
  %276 = load i8, ptr %275, align 1
  %277 = zext i8 %276 to i64
  %278 = add i64 %274, %277
  %279 = getelementptr inbounds nuw %Ts5UInt8V, ptr %219, i64 %256
  %280 = load i8, ptr %279, align 1
  %281 = zext i8 %280 to i64
  %282 = add i64 %278, %281
  %283 = getelementptr inbounds nuw %Ts5UInt8V, ptr %219, i64 %265
  %284 = load i8, ptr %283, align 1
  %285 = zext i8 %284 to i64
  %286 = add i64 %282, %285
  %287 = extractvalue { i64, i1 } %267, 0
  %288 = icmp slt i64 %287, %215
  br i1 %288, label %236, label %289

289:                                              ; preds = %269
  %290 = add i64 %286, %222
  %291 = icmp eq i64 %224, %208
  br i1 %291, label %294, label %292

292:                                              ; preds = %289, %225
  %293 = phi i64 [ %222, %225 ], [ %290, %289 ]
  %exitcond.not = icmp eq i64 %224, %208
  br i1 %exitcond.not, label %odessy.chk4, label %221, !prof !48

294:                                              ; preds = %289, %225
  %295 = phi i64 [ %222, %225 ], [ %290, %289 ]
  store i64 %295, ptr @"$s6base645finals6UInt64Vvp", align 8
  br label %229

296:                                              ; preds = %193
  %297 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %297, align 8, !invariant.load !41
...
odessy.chk5:                                      ; preds = %236
  call void @odessy.chk(i32 5)
  unreachable

odessy.chk6:                                      ; preds = %240
  call void @odessy.chk(i32 6)
  unreachable

odessy.chk7:                                      ; preds = %244
  call void @odessy.chk(i32 7)
  unreachable

odessy.chk8:                                      ; preds = %251
...
odessy.chk10:                                     ; preds = %263
  call void @odessy.chk(i32 10)
  unreachable

odessy.chk11:                                     ; preds = %266
