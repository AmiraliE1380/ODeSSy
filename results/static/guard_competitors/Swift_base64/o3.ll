...
193:                                              ; preds = %188
  ...
  br i1 %.not70, label %200, label %289
...
212:                                              ; preds = %210
  ...
  br i1 %216, label %.split.us.split, label %.split40.us

.split.us.split:                                  ; preds = %212
  %220 = getelementptr inbounds nuw i8, ptr %218, i64 16
  %221 = load i64, ptr %220, align 8, !range !43
  br label %222

222:                                              ; preds = %279, %.split.us.split
  %223 = phi i64 [ 0, %.split.us.split ], [ %280, %279 ]
  %224 = phi i64 [ 0, %.split.us.split ], [ %225, %279 ]
  %225 = add nuw nsw i64 %224, 1
  br label %228

226:                                              ; preds = %260
  %227 = add nuw nsw i64 %230, 3
  %.not72.us = icmp samesign ult i64 %227, %215
  br i1 %.not72.us, label %228, label %odessy.chk5, !prof !48

228:                                              ; preds = %222, %226
  %229 = phi i64 [ 2, %222 ], [ %277, %226 ]
  %230 = phi i64 [ 0, %222 ], [ %227, %226 ]
  %231 = phi i64 [ 0, %222 ], [ %276, %226 ]
  %232 = getelementptr inbounds nuw i8, ptr %217, i64 %230
  %233 = load i8, ptr %232, align 1
  %234 = add nuw nsw i64 %230, 1
  %.not73.us = icmp samesign ult i64 %234, %215
  br i1 %.not73.us, label %235, label %odessy.chk6, !prof !45

235:                                              ; preds = %228
  %236 = getelementptr inbounds nuw i8, ptr %217, i64 %234
  %237 = load i8, ptr %236, align 1
  %238 = getelementptr inbounds nuw i8, ptr %217, i64 %229
  %239 = load i8, ptr %238, align 1
  %240 = lshr i8 %233, 2
  %241 = zext nneg i8 %240 to i64
  %.not75.us = icmp samesign ugt i64 %221, %241
  br i1 %.not75.us, label %242, label %odessy.chk7, !prof !45
...
242:                                              ; preds = %235
  ...
  %.not76.us = icmp samesign ugt i64 %221, %247
  br i1 %.not76.us, label %248, label %odessy.chk8, !prof !45
...
248:                                              ; preds = %242
  ...
  %.not77.us = icmp samesign ugt i64 %221, %253
  br i1 %.not77.us, label %254, label %odessy.chk9, !prof !45

254:                                              ; preds = %248
  %255 = and i8 %239, 63
  %256 = zext nneg i8 %255 to i64
  %.not78.us = icmp samesign ugt i64 %221, %256
  br i1 %.not78.us, label %257, label %odessy.chk10, !prof !45

257:                                              ; preds = %254
  %258 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %230, i64 5)
  %259 = extractvalue { i64, i1 } %258, 1
  br i1 %259, label %odessy.chk11, label %260, !prof !44

260:                                              ; preds = %257
  %261 = getelementptr inbounds nuw i8, ptr %219, i64 %253
  %262 = load i8, ptr %261, align 1
  %263 = zext i8 %262 to i64
  %264 = add i64 %231, %263
  %265 = getelementptr inbounds nuw i8, ptr %219, i64 %241
  %266 = load i8, ptr %265, align 1
  %267 = zext i8 %266 to i64
  %268 = add i64 %264, %267
  %269 = getelementptr inbounds nuw i8, ptr %219, i64 %247
  %270 = load i8, ptr %269, align 1
  %271 = zext i8 %270 to i64
  %272 = add i64 %268, %271
  %273 = getelementptr inbounds nuw i8, ptr %219, i64 %256
  %274 = load i8, ptr %273, align 1
  %275 = zext i8 %274 to i64
  %276 = add i64 %272, %275
  %277 = extractvalue { i64, i1 } %258, 0
  %278 = icmp slt i64 %277, %215
  br i1 %278, label %226, label %279

279:                                              ; preds = %260
  %280 = add i64 %276, %223
  %281 = icmp eq i64 %225, %208
  br i1 %281, label %.split40.us, label %222

282:                                              ; preds = %.split40.us, %210
  %283 = phi i64 [ %.us-phi, %.split40.us ], [ 0, %210 ]
  %284 = call ptr @__swift_instantiateConcreteTypeFromMangledNameV2(ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMd", ptr nonnull @"$ss23_ContiguousArrayStorageCyypGMR") #15
  %285 = call noalias ptr @swift_allocObject(ptr %284, i64 64, i64 7) #2
  %286 = getelementptr inbounds nuw i8, ptr %285, i64 16
  store <2 x i64> <i64 1, i64 2>, ptr %286, align 8
  %287 = getelementptr inbounds nuw i8, ptr %285, i64 32
  %288 = getelementptr inbounds nuw i8, ptr %285, i64 56
  store ptr @"$ss6UInt64VN", ptr %288, align 8
  store i64 %283, ptr %287, align 8
  call swiftcc void @"$ss5print_9separator10terminatoryypd_S2StF"(ptr %285, i64 32, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr), i64 10, ptr nonnull inttoptr (i64 -2233785415175766016 to ptr))
  call void @swift_release(ptr %285) #2
  call void @llvm.lifetime.end.p0(ptr nonnull %7)
  ret i32 0

.split40.us:                                      ; preds = %279, %212
  %.us-phi = phi i64 [ 0, %212 ], [ %280, %279 ]
  store i64 %.us-phi, ptr @"$s6base645finals6UInt64Vvp", align 8
  br label %282

289:                                              ; preds = %193
  %290 = getelementptr inbounds nuw i8, ptr %.valueWitnesses, i64 8
  %Destroy = load ptr, ptr %290, align 8, !invariant.load !41
