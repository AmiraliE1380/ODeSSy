...
6:                                                ; preds = %2
  %7 = tail call noalias dereferenceable_or_null(248) ptr @malloc(i64 noundef 248) #13
...
65:                                               ; preds = %62, %61, %59
  %66 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #15
  %67 = add i64 %66, 1
...
72:                                               ; preds = %65
  %73 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %68, i64 noundef %67, ptr noundef nonnull @.str.5, ptr noundef nonnull %0) #14
  ...
  %79 = or i32 %78, %50
  %80 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef %79, i32 noundef 438) #14
...
86:                                               ; preds = %84
  %87 = tail call i64 @lseek64(i32 noundef %80, i64 noundef 0, i32 noundef 2) #14
  store i32 31153, ptr %14, align 8, !tbaa !19
  br label %98
...
89:                                               ; preds = %88
  %90 = tail call i64 @lseek64(i32 noundef %80, i64 noundef 0, i32 noundef 1) #14
...
10:                                               ; preds = %7
  %11 = tail call noalias dereferenceable_or_null(248) ptr @malloc(i64 noundef 248) #13
...
64:                                               ; preds = %61, %60, %58
  %65 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %5) #15
  %66 = add i64 %65, 1
...
71:                                               ; preds = %64
  %72 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %67, i64 noundef %66, ptr noundef nonnull @.str.5, ptr noundef nonnull %5) #14
  %73 = and i32 %52, 2048
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %79, label %75

75:                                               ; preds = %71
  %76 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 3) #14
  %77 = or i32 %76, 2048
  %78 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 4, i32 noundef %77) #14
  br label %79
...
82:                                               ; preds = %79
  %83 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 1) #14
  %84 = or i32 %83, 524288
  %85 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 2, i32 noundef %84) #14
  br label %86
...
88:                                               ; preds = %86
  %89 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 2) #14
  store i32 31153, ptr %18, align 8, !tbaa !19
  br label %99

90:                                               ; preds = %86
  %91 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 1) #14
...
10:                                               ; preds = %7, %7
  ...
  %15 = tail call i64 @lseek64(i32 noundef %12, i64 noundef %14, i32 noundef 0) #14
  %16 = icmp eq i64 %15, -1
...
42:                                               ; preds = %37
  ...
  %45 = load i32, ptr %0, align 8, !tbaa !28
  %46 = zext i32 %45 to i64
  %47 = sub nsw i64 %31, %46
  %48 = tail call i64 @lseek64(i32 noundef %44, i64 noundef %47, i32 noundef 1) #14
  %49 = icmp eq i64 %48, -1
...
62:                                               ; preds = %50, %61
  ...
  store i64 %65, ptr %38, align 8, !tbaa !36
  br label %104
...
85:                                               ; preds = %66, %78
  ...
  store i64 %97, ptr %95, align 8, !tbaa !36
  %98 = sub nsw i64 %86, %89
  br label %99

99:                                               ; preds = %81, %85
  %100 = phi i64 [ %97, %85 ], [ %84, %81 ]
  %101 = phi i64 [ %98, %85 ], [ %82, %81 ]
  %102 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store i64 %101, ptr %102, align 8, !tbaa !35
  %103 = add nsw i64 %100, %101
  br label %104

104:                                              ; preds = %68, %75, %70, %42, %11, %8, %5, %3, %99, %62
  %105 = phi i64 [ %103, %99 ], [ -1, %3 ], [ -1, %5 ], [ -1, %8 ], [ -1, %11 ], [ %65, %62 ], [ -1, %42 ], [ -1, %68 ], [ -1, %70 ], [ -1, %75 ]
  ret i64 %105
}
...
24:                                               ; preds = %19
  ...
  %28 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %2) #15
  %29 = add i64 %27, 3
  %30 = add i64 %29, %28
...
34:                                               ; preds = %24
  %35 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %26) #15
  %36 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %2) #15
  %37 = add i64 %35, 3
  %38 = add i64 %37, %36
  %39 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %31, i64 noundef %38, ptr noundef nonnull @.str.3, ptr noundef nonnull %26, ptr noundef nonnull @.str.4, ptr noundef nonnull %2) #14
  br label %40
...
104:                                              ; preds = %3, %5, %8, %11, %42, %62, %68, %70, %75, %99
  %105 = phi i64 [ %103, %99 ], [ -1, %3 ], [ -1, %5 ], [ -1, %8 ], [ -1, %11 ], [ %65, %62 ], [ -1, %42 ], [ -1, %68 ], [ -1, %70 ], [ -1, %75 ]
  ret i64 %105
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local i64 @gztell64(ptr noundef readonly captures(address_is_null) %0) local_unnamed_addr #6 {
  %2 = icmp eq ptr %0, null
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local i64 @gztell(ptr noundef readonly captures(address_is_null) %0) local_unnamed_addr #6 {
  %2 = icmp eq ptr %0, null
  br i1 %2, label %18, label %3
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local i32 @gzeof(ptr noundef readonly captures(address_is_null) %0) local_unnamed_addr #6 {
  %2 = icmp eq ptr %0, null
...
define dso_local void @gzclearerr(ptr noundef captures(address_is_null) %0) local_unnamed_addr #7 {
  %2 = icmp eq ptr %0, null
