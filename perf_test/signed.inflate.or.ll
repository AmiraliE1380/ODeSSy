; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/signed.inflate.ll'
...
50:                                               ; preds = %43
  ...
  tail call void %10(ptr noundef %52, ptr noundef nonnull %41) #11
...
85:                                               ; preds = %52, %42, %31
  ...
  tail call void %37(ptr noundef %86, ptr noundef nonnull %29) #11
...
1021:                                             ; preds = %1020, %968
  ...
  %1022 = call i32 @inflate_table(i32 noundef 0, ptr noundef nonnull %61, i32 noundef 19, ptr noundef nonnull %63, ptr noundef nonnull %66, ptr noundef nonnull %67) #11
...
1311:                                             ; preds = %1294, %1288, %1270, %1252
...
1328:                                             ; preds = %1320
  ...
  %1329 = call i32 @inflate_table(i32 noundef 1, ptr noundef nonnull %61, i32 noundef %1033, ptr noundef nonnull %63, ptr noundef nonnull %66, ptr noundef nonnull %67) #11
...
1332:                                             ; preds = %1328
  ...
  %1338 = call i32 @inflate_table(i32 noundef 2, ptr noundef nonnull %1336, i32 noundef %1337, ptr noundef nonnull %63, ptr noundef nonnull %69, ptr noundef nonnull %67) #11
...
1913:                                             ; preds = %1883, %1877, %1857, %1839
...
2002:                                             ; preds = %1996
  %2003 = call i64 @crc32(i64 noundef %1999, ptr noundef %2001, i32 noundef %1986) #11
  br label %2006

2004:                                             ; preds = %1996
  %2005 = call i64 @adler32(i64 noundef %1999, ptr noundef %2001, i32 noundef %1986) #11
  br label %2006
...
2111:                                             ; preds = %2105, %2023, %1921, %1918, %1913, %1783, %1712, %1509, %1505, %1501, %1366, %1357, %1340, %1331, %1327, %1293, %1150, %1024, %953, %908, %900, %880, %812, %780, %705, %692, %250, %246, %207, %206, %191, %187, %169, %130
...
2225:                                             ; preds = %2224, %2218, %2212, %2206, %2200, %2194, %2188, %2182, %2177, %2172, %2167, %2162, %2157, %2152, %2147, %2142, %2137, %2132, %2127, %2125, %2123, %2121, %2106, %1919, %1765, %1341, %984, %896, %881, %804, %778, %764, %630, %590, %570, %530, %514, %88
...
2250:                                             ; preds = %2244
  ...
  %2257 = call ptr %2251(ptr noundef %2253, i32 noundef %2256, i32 noundef 1) #11, !inline_history !105
...
2312:                                             ; preds = %2309, %2300, %2292, %2273, %2240, %2237, %2235
...
2338:                                             ; preds = %2331
  %2339 = call i64 @crc32(i64 noundef %2334, ptr noundef %2337, i32 noundef %2316) #11
  br label %2342

2340:                                             ; preds = %2331
  %2341 = call i64 @adler32(i64 noundef %2334, ptr noundef %2337, i32 noundef %2316) #11
  br label %2342
...
2378:                                             ; preds = %2377, %2366, %2311, %761, %88, %32, %25, %20, %17, %13, %9, %5, %2
...
197:                                              ; preds = %184, %149, %28, %19, %16, %12, %8, %4, %1
