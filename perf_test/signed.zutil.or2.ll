; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/signed.zutil.or.ll'
...
define dso_local ptr @zError(i32 noundef %0) local_unnamed_addr #0 {
  ...
  %6 = zext i32 %5 to i64
  %7 = getelementptr inbounds nuw [8 x i8], ptr @z_errmsg, i64 %6
  %8 = load ptr, ptr %7, align 8, !tbaa !8
  ret ptr %8
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(inaccessiblemem: readwrite, errnomem: write) uwtable
define dso_local noalias noundef ptr @zcalloc(ptr noundef readnone captures(none) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #1 {
  %4 = mul i32 %2, %1
  %5 = zext i32 %4 to i64
...
define dso_local void @zcfree(ptr noundef readnone captures(none) %0, ptr noundef captures(none) %1) local_unnamed_addr #3 {
