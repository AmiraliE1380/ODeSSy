...
72:                                               ; preds = %65
  %73 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %68, i64 noundef %67, ptr noundef nonnull @.str.5, ptr noundef nonnull %0) #16
  ...
  %79 = or i32 %78, %50
  %80 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef %79, i32 noundef 438) #16
...
86:                                               ; preds = %84
  %87 = tail call i64 @lseek64(i32 noundef %80, i64 noundef 0, i32 noundef 2) #16
  store i32 31153, ptr %14, align 8, !tbaa !19
  br label %98
...
89:                                               ; preds = %88
  %90 = tail call i64 @lseek64(i32 noundef %80, i64 noundef 0, i32 noundef 1) #16
...
105:                                              ; preds = %100, %83, %71, %64, %60, %58, %35, %6, %2
...
71:                                               ; preds = %64
  %72 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %67, i64 noundef %66, ptr noundef nonnull @.str.5, ptr noundef nonnull %5) #16
  %73 = and i32 %52, 2048
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %79, label %75

75:                                               ; preds = %71
  %76 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 3) #16
  %77 = or i32 %76, 2048
  %78 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 4, i32 noundef %77) #16
  br label %79
...
82:                                               ; preds = %79
  %83 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 1) #16
  %84 = or i32 %83, 524288
  %85 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 2, i32 noundef %84) #16
  br label %86
...
88:                                               ; preds = %86
  %89 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 2) #16
  store i32 31153, ptr %18, align 8, !tbaa !19
  br label %99

90:                                               ; preds = %86
  %91 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 1) #16
...
106:                                              ; preds = %101, %70, %63, %59, %57, %38, %10, %7
