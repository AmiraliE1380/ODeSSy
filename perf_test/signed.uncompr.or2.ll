; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/signed.uncompr.or.ll'
...
54:                                               ; preds = %50
  ...
  %57 = add i64 %51, %56
  %58 = load i32, ptr %30, align 8, !tbaa !17
...
72:                                               ; preds = %71, %66, %54, %19, %14, %7, %4
  %73 = phi i32 [ %22, %19 ], [ -2, %4 ], [ -2, %14 ], [ -2, %7 ], [ 0, %54 ], [ %70, %66 ], [ -3, %71 ]
...
15:                                               ; preds = %11
  ...
  %18 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #5
  %19 = icmp eq i32 %18, 0
...
46:                                               ; preds = %42, %38
  ...
  %48 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #5
  %49 = icmp eq i32 %48, 0
...
50:                                               ; preds = %46
  ...
  %53 = add i64 %47, %52
  %54 = load i32, ptr %26, align 8, !tbaa !17
  %55 = zext i32 %54 to i64
  %56 = sub i64 %7, %53
  %57 = add i64 %39, %55
  %58 = sub i64 %6, %57
  %59 = call i32 @inflateEnd(ptr noundef nonnull %5) #5
...
60:                                               ; preds = %50
  ...
  %64 = select i1 %63, i32 -3, i32 %48
  br label %66

65:                                               ; preds = %50
  br label %66

66:                                               ; preds = %65, %60, %50, %15, %11, %4
  %67 = phi i64 [ %6, %4 ], [ %6, %11 ], [ %58, %60 ], [ %58, %50 ], [ %58, %65 ], [ %6, %15 ]
  %68 = phi i64 [ %7, %4 ], [ %7, %11 ], [ %56, %60 ], [ %56, %50 ], [ %56, %65 ], [ %7, %15 ]
  %69 = phi i32 [ -2, %4 ], [ -2, %11 ], [ %64, %60 ], [ 0, %50 ], [ -3, %65 ], [ %18, %15 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #5
  store i64 %68, ptr %3, align 8, !tbaa !8
  store i64 %67, ptr %1, align 8, !tbaa !8
  ret i32 %69
}
...
16:                                               ; preds = %11
  ...
  %19 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #5
  %20 = icmp eq i32 %19, 0
...
47:                                               ; preds = %43, %39
  ...
  %49 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #5
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %28, label %51, !llvm.loop !18

51:                                               ; preds = %47
  %52 = load i32, ptr %17, align 8, !tbaa !15
  %53 = load i32, ptr %27, align 8, !tbaa !17
  %54 = zext i32 %53 to i64
  %55 = load i64, ptr %1, align 8, !tbaa !8
  %56 = add i64 %40, %54
  %57 = sub i64 %55, %56
  store i64 %57, ptr %1, align 8, !tbaa !8
  %58 = call i32 @inflateEnd(ptr noundef nonnull %5) #5
...
59:                                               ; preds = %51
  ...
  %65 = select i1 %64, i32 -3, i32 %49
  br label %67

66:                                               ; preds = %51
  br label %67

67:                                               ; preds = %66, %59, %51, %16, %11, %4
  %68 = phi i32 [ %19, %16 ], [ -3, %66 ], [ -2, %11 ], [ -2, %4 ], [ 0, %51 ], [ %65, %59 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #5
  ret i32 %68
}
...
14:                                               ; preds = %10
  ...
  %17 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #5
  %18 = icmp eq i32 %17, 0
...
45:                                               ; preds = %41, %37
  ...
  %47 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #5
  %48 = icmp eq i32 %47, 0
  br i1 %48, label %26, label %49, !llvm.loop !18

49:                                               ; preds = %45
  %50 = load i32, ptr %15, align 8, !tbaa !15
  %51 = load i32, ptr %25, align 8, !tbaa !17
  %52 = zext i32 %51 to i64
  %53 = add i64 %38, %52
  %54 = sub i64 %6, %53
  %55 = call i32 @inflateEnd(ptr noundef nonnull %5) #5
...
56:                                               ; preds = %49
  ...
  %62 = select i1 %61, i32 -3, i32 %47
  br label %64

63:                                               ; preds = %49
  br label %64

64:                                               ; preds = %63, %56, %49, %14, %10, %4
  %65 = phi i64 [ %6, %4 ], [ %6, %10 ], [ %54, %56 ], [ %54, %49 ], [ %54, %63 ], [ %6, %14 ]
  %66 = phi i32 [ -2, %4 ], [ -2, %10 ], [ %62, %56 ], [ 0, %49 ], [ -3, %63 ], [ %17, %14 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #5
