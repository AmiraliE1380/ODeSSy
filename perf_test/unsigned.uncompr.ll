...
19:                                               ; preds = %14
  ...
  %22 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #7
  %23 = icmp eq i32 %22, 0
...
58:                                               ; preds = %56, %46
  ...
  %60 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #7
  %61 = icmp eq i32 %60, 0
...
68:                                               ; preds = %62
  call void @llvm.ubsantrap(i8 0) #8, !nosanitize !18
  unreachable, !nosanitize !18
...
87:                                               ; preds = %81
  ...
  %89 = call i32 @inflateEnd(ptr noundef nonnull %5) #7
...
15:                                               ; preds = %11
  ...
  %18 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #7
  %19 = icmp eq i32 %18, 0
...
54:                                               ; preds = %52, %42
  ...
  %56 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #7
  %57 = icmp eq i32 %56, 0
...
81:                                               ; preds = %76
  %82 = extractvalue { i64, i1 } %78, 0, !nosanitize !18
  %83 = call i32 @inflateEnd(ptr noundef nonnull %5) #7
...
16:                                               ; preds = %11
  ...
  %19 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #7
  %20 = icmp eq i32 %19, 0
...
55:                                               ; preds = %53, %43
  ...
  %57 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #7
  %58 = icmp eq i32 %57, 0
...
14:                                               ; preds = %10
  ...
  %17 = call i32 @inflateInit_(ptr noundef nonnull %5, ptr noundef nonnull @.str, i32 noundef 112) #7
  %18 = icmp eq i32 %17, 0
...
53:                                               ; preds = %51, %41
  ...
  %55 = call i32 @inflate(ptr noundef nonnull %5, i32 noundef 0) #7
  %56 = icmp eq i32 %55, 0
...
78:                                               ; preds = %74
  ...
  %80 = call i32 @inflateEnd(ptr noundef nonnull %5) #7
