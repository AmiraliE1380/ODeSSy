...
139:                                              ; preds = %122, %118, %114, %110, %106, %102, %98, %94, %90, %86, %82, %78, %73, %68
...
239:                                              ; preds = %232
  ...
  br i1 %245, label %544, label %246

246:                                              ; preds = %239
  %247 = shl nuw nsw i32 %244, 1
  %248 = zext i16 %262 to i32
...
250:                                              ; preds = %246
  ...
  %253 = or i1 %252, %261
  %254 = and i1 %251, %253
  br i1 %254, label %544, label %267

255:                                              ; preds = %145
  %256 = trunc nuw nsw i64 %146 to i32
  %257 = tail call i32 @llvm.umax.i32(i32 %143, i32 %256)
  br label %258

258:                                              ; preds = %255, %150, %126
  %259 = phi i32 [ 1, %126 ], [ %257, %255 ], [ %142, %150 ]
  %260 = phi i32 [ 1, %126 ], [ %142, %255 ], [ %142, %150 ]
  %261 = phi i1 [ false, %126 ], [ true, %255 ], [ true, %150 ]
  %262 = phi i16 [ 0, %126 ], [ %141, %255 ], [ %141, %150 ]
  %263 = phi i32 [ 1, %126 ], [ %256, %255 ], [ %142, %150 ]
  %264 = getelementptr inbounds nuw i8, ptr %7, i64 2
  %265 = load i16, ptr %264, align 2, !tbaa !8
  %266 = icmp ugt i16 %265, 2
  br i1 %266, label %544, label %153
...
267:                                              ; preds = %250
  ...
  store i16 %265, ptr %269, align 4, !tbaa !8
  %270 = add i16 %265, %155
...
351:                                              ; preds = %349
  %352 = icmp ugt i32 %259, 9
  br i1 %352, label %544, label %355

353:                                              ; preds = %349
  %354 = icmp ugt i32 %259, 9
  br i1 %354, label %544, label %355

355:                                              ; preds = %353, %351, %350, %349
  ...
  %362 = shl nuw i32 1, %259
  %363 = add i32 %362, -1
  %364 = trunc i32 %259 to i8
  br label %366
...
366:                                              ; preds = %522, %355
  %367 = phi i64 [ 0, %355 ], [ %433, %522 ]
  %368 = phi i32 [ %263, %355 ], [ %529, %522 ]
  %369 = phi ptr [ %361, %355 ], [ %527, %522 ]
  %370 = phi i32 [ -1, %355 ], [ %526, %522 ]
  %371 = phi i32 [ 0, %355 ], [ %432, %522 ]
  %372 = phi i32 [ %362, %355 ], [ %525, %522 ]
  %373 = phi i32 [ 0, %355 ], [ %524, %522 ]
  %374 = phi i32 [ %259, %355 ], [ %523, %522 ]
  %375 = phi i32 [ %263, %355 ], [ %453, %522 ]
...
442:                                              ; preds = %436
  %443 = icmp eq i32 %375, %260
  br i1 %443, label %531, label %444
...
458:                                              ; preds = %455
  ...
  %460 = select i1 %459, i32 %259, i32 %373
...
473:                                              ; preds = %493, %470
  %474 = phi { i32, i1 } [ %496, %493 ], [ %468, %470 ]
  %475 = phi i32 [ %495, %493 ], [ %471, %470 ]
  %476 = phi i32 [ %494, %493 ], [ %467, %470 ]
  %477 = extractvalue { i32, i1 } %474, 0
  %478 = icmp ult i32 %477, %260
...
479:                                              ; preds = %473
  ...
  %484 = tail call { i32, i1 } @llvm.ssub.with.overflow.i32(i32 %475, i32 %483), !nosanitize !19
  %485 = extractvalue { i32, i1 } %484, 0, !nosanitize !19
  %486 = extractvalue { i32, i1 } %484, 1, !nosanitize !19
  br i1 %486, label %465, label %487, !prof !20, !nosanitize !19
...
489:                                              ; preds = %487
  %490 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %476, i32 1), !nosanitize !19
  %491 = extractvalue { i32, i1 } %490, 1, !nosanitize !19
  br i1 %491, label %492, label %493, !prof !20, !nosanitize !19
...
493:                                              ; preds = %489
  %494 = extractvalue { i32, i1 } %490, 0, !nosanitize !19
  %495 = shl nuw i32 %485, 1
  %496 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %494, i32 %460), !nosanitize !19
  %497 = extractvalue { i32, i1 } %496, 1, !nosanitize !19
  br i1 %497, label %472, label %473, !prof !24, !llvm.loop !25, !nosanitize !19

498:                                              ; preds = %487, %473
  %499 = shl nuw i32 1, %476
  %500 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %372, i32 %499), !nosanitize !19
  %501 = extractvalue { i32, i1 } %500, 0, !nosanitize !19
  %502 = extractvalue { i32, i1 } %500, 1, !nosanitize !19
  br i1 %502, label %503, label %504, !prof !20, !nosanitize !19
...
504:                                              ; preds = %498
  %505 = icmp ugt i32 %501, 852
  %506 = select i1 %360, i1 %505, i1 false
  %507 = icmp ugt i32 %501, 592
  %508 = select i1 %356, i1 %507, i1 false
  %509 = select i1 %506, i1 true, i1 %508
  br i1 %509, label %544, label %510

510:                                              ; preds = %504
  %511 = trunc i32 %476 to i8
  %512 = load ptr, ptr %3, align 8, !tbaa !14
  %513 = zext nneg i32 %456 to i64
  %514 = getelementptr inbounds nuw [4 x i8], ptr %512, i64 %513
  store i8 %511, ptr %514, align 2, !tbaa !26
  %515 = getelementptr inbounds nuw i8, ptr %514, i64 1
  store i8 %364, ptr %515, align 1, !tbaa !28
  ...
  store i16 %520, ptr %521, align 2, !tbaa !29
  br label %522

522:                                              ; preds = %510, %455, %452
  %523 = phi i32 [ %476, %510 ], [ %374, %455 ], [ %374, %452 ]
  %524 = phi i32 [ %460, %510 ], [ %373, %455 ], [ %373, %452 ]
  %525 = phi i32 [ %501, %510 ], [ %372, %455 ], [ %372, %452 ]
  %526 = phi i32 [ %456, %510 ], [ %370, %455 ], [ %370, %452 ]
  %527 = phi ptr [ %462, %510 ], [ %369, %455 ], [ %369, %452 ]
  %528 = tail call { i32, i1 } @llvm.usub.with.overflow.i32(i32 %453, i32 %524), !nosanitize !19
  %529 = extractvalue { i32, i1 } %528, 0, !nosanitize !19
  %530 = extractvalue { i32, i1 } %528, 1, !nosanitize !19
  br i1 %530, label %365, label %366, !prof !24, !nosanitize !19

531:                                              ; preds = %442
  %532 = icmp eq i32 %432, 0
  br i1 %532, label %538, label %533

533:                                              ; preds = %531
  %534 = zext i32 %432 to i64
  %535 = getelementptr inbounds nuw [4 x i8], ptr %369, i64 %534
  store i8 64, ptr %535, align 2, !tbaa !16
  %536 = getelementptr inbounds nuw i8, ptr %535, i64 1
  store i8 %376, ptr %536, align 1, !tbaa !16
  %537 = getelementptr inbounds nuw i8, ptr %535, i64 2
  store i16 0, ptr %537, align 2, !tbaa !8
  br label %538

538:                                              ; preds = %533, %531
  %539 = load ptr, ptr %3, align 8, !tbaa !14
  %540 = zext i32 %372 to i64
  %541 = getelementptr inbounds nuw [4 x i8], ptr %539, i64 %540
  store ptr %541, ptr %3, align 8, !tbaa !14
  br label %542

542:                                              ; preds = %538, %130
  %543 = phi i32 [ %259, %538 ], [ 1, %130 ]
  store i32 %543, ptr %4, align 4, !tbaa !4
  br label %544

544:                                              ; preds = %542, %504, %353, %351, %258, %250, %246, %239, %232, %225, %218, %211, %204, %197, %190, %183, %176, %169, %162, %153
  %545 = phi i32 [ -1, %153 ], [ 1, %351 ], [ -1, %258 ], [ -1, %250 ], [ 0, %542 ], [ 1, %353 ], [ -1, %246 ], [ -1, %239 ], [ -1, %232 ], [ -1, %225 ], [ -1, %218 ], [ -1, %211 ], [ -1, %204 ], [ -1, %197 ], [ -1, %190 ], [ -1, %183 ], [ -1, %176 ], [ -1, %169 ], [ -1, %162 ], [ 1, %504 ]
