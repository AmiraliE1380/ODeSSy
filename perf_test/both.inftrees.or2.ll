; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/both.inftrees.or.ll'
...
50:                                               ; preds = %50, %47
  ...
  br i1 %61, label %.loopexit38, label %50, !llvm.loop !12

.loopexit38:                                      ; preds = %50, %45
...
117:                                              ; preds = %113
  ...
  br i1 %120, label %121, label %.loopexit37
...
130:                                              ; preds = %113, %109, %105, %101, %97, %93, %89, %85, %81, %77, %73, %68, %66, %.loopexit38
  %131 = phi i32 [ %69, %113 ], [ %69, %109 ], [ %69, %105 ], [ %69, %101 ], [ %69, %97 ], [ %69, %93 ], [ %69, %89 ], [ %69, %85 ], [ %69, %81 ], [ %69, %77 ], [ %69, %73 ], [ %69, %68 ], [ %64, %66 ], [ %64, %.loopexit38 ]
  %132 = phi i16 [ 0, %113 ], [ 0, %109 ], [ 0, %105 ], [ 0, %101 ], [ 0, %97 ], [ 0, %93 ], [ 0, %89 ], [ 0, %85 ], [ 0, %81 ], [ 0, %77 ], [ 0, %73 ], [ 0, %68 ], [ 0, %66 ], [ %63, %.loopexit38 ]
  %133 = phi i32 [ 2, %113 ], [ 3, %109 ], [ 4, %105 ], [ 5, %101 ], [ 6, %97 ], [ 7, %93 ], [ 8, %89 ], [ 9, %85 ], [ 10, %81 ], [ 11, %77 ], [ 12, %73 ], [ 13, %68 ], [ 14, %66 ], [ 15, %.loopexit38 ]
...
153:                                              ; preds = %144
  ...
  br i1 %159, label %.loopexit36, label %160
...
160:                                              ; preds = %153
  ...
  br i1 %166, label %.loopexit36, label %167
...
167:                                              ; preds = %160
  ...
  br i1 %173, label %.loopexit36, label %174
...
181:                                              ; preds = %174
  ...
  br i1 %187, label %.loopexit36, label %188
...
188:                                              ; preds = %181
  ...
  br i1 %194, label %.loopexit36, label %195
...
195:                                              ; preds = %188
  ...
  br i1 %201, label %.loopexit36, label %202
...
202:                                              ; preds = %195
  ...
  br i1 %208, label %.loopexit36, label %209
...
209:                                              ; preds = %202
  ...
  br i1 %215, label %.loopexit36, label %216
...
216:                                              ; preds = %209
  ...
  br i1 %222, label %.loopexit36, label %223
...
223:                                              ; preds = %216
  ...
  br i1 %229, label %.loopexit36, label %230
...
230:                                              ; preds = %223
  ...
  br i1 %236, label %.loopexit36, label %237

237:                                              ; preds = %230
  %238 = shl nuw nsw i32 %235, 1
  %239 = zext i16 %252 to i32
  %240 = icmp samesign ult i32 %238, %239
  br i1 %240, label %.loopexit36, label %241
...
241:                                              ; preds = %237
  ...
  %244 = or i1 %243, %251
  %245 = and i1 %244, %242
  br i1 %245, label %.loopexit36, label %257

246:                                              ; preds = %136
  %247 = trunc nuw nsw i64 %137 to i32
  %248 = tail call i32 @llvm.umax.i32(i32 %134, i32 %247)
  br label %.loopexit37

.loopexit37:                                      ; preds = %141, %246, %117
  %249 = phi i32 [ 1, %117 ], [ %248, %246 ], [ %133, %141 ]
  %250 = phi i32 [ 1, %117 ], [ %133, %246 ], [ %133, %141 ]
  %251 = phi i1 [ false, %117 ], [ true, %246 ], [ true, %141 ]
  %252 = phi i16 [ 0, %117 ], [ %132, %246 ], [ %132, %141 ]
  %253 = phi i32 [ 1, %117 ], [ %247, %246 ], [ %133, %141 ]
  %254 = getelementptr inbounds nuw i8, ptr %7, i64 2
  %255 = load i16, ptr %254, align 2, !tbaa !8
  %256 = icmp ugt i16 %255, 2
  br i1 %256, label %.loopexit36, label %144
...
257:                                              ; preds = %241
  ...
  store i16 %255, ptr %259, align 4, !tbaa !8
  %260 = add i16 %146, %255
...
338:                                              ; preds = %336
  %339 = icmp ugt i32 %249, 9
  br i1 %339, label %.loopexit36, label %342

340:                                              ; preds = %336
  %341 = icmp ugt i32 %249, 9
  br i1 %341, label %.loopexit36, label %342
...
342:                                              ; preds = %340, %338, %337, %336
  ...
  %349 = shl nuw i32 1, %249
  %350 = add i32 %349, -1
  %351 = trunc i32 %249 to i8
  br label %353
...
353:                                              ; preds = %507, %342
  %354 = phi i64 [ 0, %342 ], [ %420, %507 ]
  %355 = phi i32 [ %253, %342 ], [ %514, %507 ]
  %356 = phi ptr [ %348, %342 ], [ %512, %507 ]
  %357 = phi i32 [ -1, %342 ], [ %511, %507 ]
  %358 = phi i32 [ 0, %342 ], [ %419, %507 ]
  %359 = phi i32 [ %349, %342 ], [ %510, %507 ]
  %360 = phi i32 [ 0, %342 ], [ %509, %507 ]
  %361 = phi i32 [ %249, %342 ], [ %508, %507 ]
  %362 = phi i32 [ %253, %342 ], [ %440, %507 ]
...
429:                                              ; preds = %423
  %430 = icmp eq i32 %362, %250
  br i1 %430, label %516, label %431
...
445:                                              ; preds = %442
  ...
  %447 = select i1 %446, i32 %249, i32 %360
  ...
  br i1 %451, label %.loopexit, label %452, !prof !20, !nosanitize !19

.loopexit:                                        ; preds = %445, %464
  tail call void @llvm.ubsantrap(i8 21) #8, !nosanitize !19
  unreachable, !nosanitize !19

452:                                              ; preds = %445
  %453 = extractvalue { i32, i1 } %450, 0, !nosanitize !19
  %454 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %453, i32 %447), !nosanitize !19
  %455 = extractvalue { i32, i1 } %454, 1, !nosanitize !19
  br i1 %455, label %.loopexit33, label %456, !prof !23, !nosanitize !19

456:                                              ; preds = %452
  %457 = shl nuw i32 1, %453
  br label %458

.loopexit33:                                      ; preds = %452, %478
  tail call void @llvm.ubsantrap(i8 0) #8, !nosanitize !19
  unreachable, !nosanitize !19

458:                                              ; preds = %478, %456
  %459 = phi { i32, i1 } [ %481, %478 ], [ %454, %456 ]
  %460 = phi i32 [ %480, %478 ], [ %457, %456 ]
  %461 = phi i32 [ %479, %478 ], [ %453, %456 ]
  %462 = extractvalue { i32, i1 } %459, 0
  %463 = icmp ult i32 %462, %250
  br i1 %463, label %464, label %483

464:                                              ; preds = %458
  %465 = zext nneg i32 %462 to i64
  %466 = getelementptr inbounds nuw [2 x i8], ptr %7, i64 %465
  %467 = load i16, ptr %466, align 2, !tbaa !8
  %468 = zext i16 %467 to i32
  %469 = tail call { i32, i1 } @llvm.ssub.with.overflow.i32(i32 %460, i32 %468), !nosanitize !19
  %470 = extractvalue { i32, i1 } %469, 0, !nosanitize !19
  %471 = extractvalue { i32, i1 } %469, 1, !nosanitize !19
  br i1 %471, label %.loopexit, label %472, !prof !20, !nosanitize !19
...
474:                                              ; preds = %472
  %475 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %461, i32 1), !nosanitize !19
  %476 = extractvalue { i32, i1 } %475, 1, !nosanitize !19
  br i1 %476, label %477, label %478, !prof !20, !nosanitize !19
...
478:                                              ; preds = %474
  %479 = extractvalue { i32, i1 } %475, 0, !nosanitize !19
  %480 = shl nuw i32 %470, 1
  %481 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %479, i32 %447), !nosanitize !19
  %482 = extractvalue { i32, i1 } %481, 1, !nosanitize !19
  br i1 %482, label %.loopexit33, label %458, !prof !24, !llvm.loop !25, !nosanitize !19

483:                                              ; preds = %472, %458
  %484 = shl nuw i32 1, %461
  %485 = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %359, i32 %484), !nosanitize !19
  %486 = extractvalue { i32, i1 } %485, 0, !nosanitize !19
  %487 = extractvalue { i32, i1 } %485, 1, !nosanitize !19
  br i1 %487, label %488, label %489, !prof !20, !nosanitize !19
...
489:                                              ; preds = %483
  %490 = icmp ugt i32 %486, 852
  %491 = select i1 %347, i1 %490, i1 false
  %492 = icmp ugt i32 %486, 592
  %493 = select i1 %343, i1 %492, i1 false
  %494 = select i1 %491, i1 true, i1 %493
  br i1 %494, label %.loopexit36, label %495

495:                                              ; preds = %489
  %496 = trunc i32 %461 to i8
  %497 = load ptr, ptr %3, align 8, !tbaa !14
  %498 = zext nneg i32 %443 to i64
  %499 = getelementptr inbounds nuw [4 x i8], ptr %497, i64 %498
  store i8 %496, ptr %499, align 2, !tbaa !26
  %500 = getelementptr inbounds nuw i8, ptr %499, i64 1
  store i8 %351, ptr %500, align 1, !tbaa !28
  %501 = ptrtoint ptr %449 to i64
  ...
  store i16 %505, ptr %506, align 2, !tbaa !29
  br label %507

507:                                              ; preds = %495, %442, %439
  %508 = phi i32 [ %461, %495 ], [ %361, %442 ], [ %361, %439 ]
  %509 = phi i32 [ %447, %495 ], [ %360, %442 ], [ %360, %439 ]
  %510 = phi i32 [ %486, %495 ], [ %359, %442 ], [ %359, %439 ]
  %511 = phi i32 [ %443, %495 ], [ %357, %442 ], [ %357, %439 ]
  %512 = phi ptr [ %449, %495 ], [ %356, %442 ], [ %356, %439 ]
  %513 = tail call { i32, i1 } @llvm.usub.with.overflow.i32(i32 %440, i32 %509), !nosanitize !19
  %514 = extractvalue { i32, i1 } %513, 0, !nosanitize !19
  %515 = extractvalue { i32, i1 } %513, 1, !nosanitize !19
  br i1 %515, label %352, label %353, !prof !24, !nosanitize !19

516:                                              ; preds = %429
  %517 = icmp eq i32 %419, 0
  br i1 %517, label %523, label %518

518:                                              ; preds = %516
  %519 = zext i32 %419 to i64
  %520 = getelementptr inbounds nuw [4 x i8], ptr %356, i64 %519
  store i8 64, ptr %520, align 2, !tbaa !16
  %521 = getelementptr inbounds nuw i8, ptr %520, i64 1
  store i8 %363, ptr %521, align 1, !tbaa !16
  %522 = getelementptr inbounds nuw i8, ptr %520, i64 2
  store i16 0, ptr %522, align 2, !tbaa !8
  br label %523

523:                                              ; preds = %518, %516
  %524 = load ptr, ptr %3, align 8, !tbaa !14
  %525 = zext i32 %359 to i64
  %526 = getelementptr inbounds nuw [4 x i8], ptr %524, i64 %525
  store ptr %526, ptr %3, align 8, !tbaa !14
  br label %527

527:                                              ; preds = %523, %121
  %528 = phi i32 [ %249, %523 ], [ 1, %121 ]
  store i32 %528, ptr %4, align 4, !tbaa !4
  br label %.loopexit36

.loopexit36:                                      ; preds = %489, %527, %340, %338, %.loopexit37, %241, %237, %230, %223, %216, %209, %202, %195, %188, %181, %174, %167, %160, %153, %144
  %529 = phi i32 [ -1, %144 ], [ 1, %338 ], [ -1, %.loopexit37 ], [ -1, %241 ], [ 0, %527 ], [ 1, %340 ], [ -1, %237 ], [ -1, %230 ], [ -1, %223 ], [ -1, %216 ], [ -1, %209 ], [ -1, %202 ], [ -1, %195 ], [ -1, %188 ], [ -1, %181 ], [ -1, %174 ], [ -1, %167 ], [ -1, %160 ], [ -1, %153 ], [ 1, %489 ]
