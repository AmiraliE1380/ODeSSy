...
76:                                               ; preds = %71
  %77 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %72, i64 noundef %68, ptr noundef nonnull @.str.5, ptr noundef nonnull %0) #17
  ...
  %83 = or i32 %82, %50
  %84 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef %83, i32 noundef 438) #17
...
90:                                               ; preds = %88
  %91 = tail call i64 @lseek64(i32 noundef %84, i64 noundef 0, i32 noundef 2) #17
  store i32 31153, ptr %14, align 8, !tbaa !19
  br label %102
...
93:                                               ; preds = %92
  %94 = tail call i64 @lseek64(i32 noundef %84, i64 noundef 0, i32 noundef 1) #17
...
109:                                              ; preds = %2, %6, %35, %58, %60, %64, %75, %87, %104
...
75:                                               ; preds = %70
  %76 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %71, i64 noundef %67, ptr noundef nonnull @.str.5, ptr noundef nonnull %5) #17
  %77 = and i32 %52, 2048
  %78 = icmp eq i32 %77, 0
  br i1 %78, label %83, label %79

79:                                               ; preds = %75
  %80 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 3) #17
  %81 = or i32 %80, 2048
  %82 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 4, i32 noundef %81) #17
  br label %83
...
86:                                               ; preds = %83
  %87 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 1) #17
  %88 = or i32 %87, 524288
  %89 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 2, i32 noundef %88) #17
  br label %90
...
92:                                               ; preds = %90
  %93 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 2) #17
  store i32 31153, ptr %18, align 8, !tbaa !19
  br label %103

94:                                               ; preds = %90
  %95 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 1) #17
...
110:                                              ; preds = %7, %10, %38, %57, %59, %63, %74, %105
...
20:                                               ; preds = %51, %15
  tail call void @llvm.ubsantrap(i8 21) #20, !nosanitize !26
  unreachable, !nosanitize !26
...
32:                                               ; preds = %124, %112, %85, %74, %43, %28
  tail call void @llvm.ubsantrap(i8 0) #20, !nosanitize !26
  unreachable, !nosanitize !26
...
132:                                              ; preds = %83, %93, %91, %56, %11, %8, %5, %3, %130, %79
...
42:                                               ; preds = %37
  %43 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %26) #18
  %44 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %2) #18
...
53:                                               ; preds = %48
  ...
  %55 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %39, i64 noundef %54, ptr noundef nonnull @.str.3, ptr noundef nonnull %26, ptr noundef nonnull @.str.4, ptr noundef nonnull %2) #17
  br label %56
...
132:                                              ; preds = %3, %5, %8, %11, %56, %79, %83, %91, %93, %130
  %133 = phi i64 [ %131, %130 ], [ -1, %3 ], [ -1, %5 ], [ -1, %8 ], [ -1, %11 ], [ %80, %79 ], [ -1, %56 ], [ -1, %83 ], [ -1, %91 ], [ -1, %93 ]
  ret i64 %133
}
