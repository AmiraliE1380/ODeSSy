...
1001:                                             ; preds = %995, %981
  ...
  %1006 = lshr i32 %1002, 3
  %1007 = zext nneg i32 %1006 to i64
  %1008 = sub nsw i64 0, %1007
  %1009 = getelementptr inbounds i8, ptr %1005, i64 %1008
  %1010 = and i32 %1002, -8
  %1011 = tail call { i32, i1 } @llvm.usub.with.overflow.i32(i32 %1002, i32 %1010), !nosanitize !16
  store ptr %1009, ptr %0, align 8, !tbaa !14
  store ptr %1004, ptr %15, align 8, !tbaa !18
  %1012 = icmp ult ptr %1009, %14
  br i1 %1012, label %1014, label %1020

1013:                                             ; preds = %1037, %1020
  tail call void @llvm.ubsantrap(i8 21) #3, !nosanitize !16
  unreachable, !nosanitize !16

1014:                                             ; preds = %1001
  %1015 = ptrtoint ptr %14 to i64
  %1016 = ptrtoint ptr %1009 to i64
  %1017 = sub i64 %1015, %1016
  %1018 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %1017, i64 5), !nosanitize !16
  %1019 = extractvalue { i64, i1 } %1018, 1, !nosanitize !16
  br i1 %1019, label %439, label %1026, !prof !17, !nosanitize !16

1020:                                             ; preds = %1001
  %1021 = ptrtoint ptr %1009 to i64
  %1022 = ptrtoint ptr %14 to i64
  %1023 = sub i64 %1021, %1022
  %1024 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 5, i64 %1023), !nosanitize !16
  %1025 = extractvalue { i64, i1 } %1024, 1, !nosanitize !16
  br i1 %1025, label %1013, label %1026, !prof !17, !nosanitize !16

1026:                                             ; preds = %1020, %1014
  %1027 = phi { i64, i1 } [ %1018, %1014 ], [ %1024, %1020 ]
  %1028 = extractvalue { i64, i1 } %1027, 0
  %1029 = trunc i64 %1028 to i32
  store i32 %1029, ptr %6, align 8, !tbaa !15
  %1030 = icmp ult ptr %1004, %34
  br i1 %1030, label %1031, label %1037

1031:                                             ; preds = %1026
  %1032 = ptrtoint ptr %34 to i64
  %1033 = ptrtoint ptr %1004 to i64
  %1034 = sub i64 %1032, %1033
  %1035 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %1034, i64 257), !nosanitize !16
  %1036 = extractvalue { i64, i1 } %1035, 1, !nosanitize !16
  br i1 %1036, label %439, label %1043, !prof !17, !nosanitize !16

1037:                                             ; preds = %1026
  %1038 = ptrtoint ptr %1004 to i64
  %1039 = ptrtoint ptr %34 to i64
  %1040 = sub i64 %1038, %1039
  %1041 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 257, i64 %1040), !nosanitize !16
  %1042 = extractvalue { i64, i1 } %1041, 1, !nosanitize !16
  br i1 %1042, label %1013, label %1043, !prof !17, !nosanitize !16

1043:                                             ; preds = %1037, %1031
  %1044 = phi { i64, i1 } [ %1035, %1031 ], [ %1041, %1037 ]
  %1045 = extractvalue { i64, i1 } %1044, 0
  %1046 = extractvalue { i32, i1 } %1011, 0, !nosanitize !16
  %1047 = shl nsw i32 -1, %1046
  %1048 = xor i32 %1047, -1
  %1049 = zext nneg i32 %1048 to i64
  %1050 = and i64 %1003, %1049
  %1051 = trunc i64 %1045 to i32
  store i32 %1051, ptr %18, align 8, !tbaa !19
  store i64 %1050, ptr %44, align 8, !tbaa !27
  store i32 %1046, ptr %46, align 8, !tbaa !28
  ret void
}
