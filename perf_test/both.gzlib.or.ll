; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/both.gzlib.ll'
...
65:                                               ; preds = %62, %61, %59
  %66 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #17
...
70:                                               ; preds = %65
  tail call void @llvm.ubsantrap(i8 0) #18, !nosanitize !26
...
76:                                               ; preds = %71
  %77 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %72, i64 noundef %68, ptr noundef nonnull @.str.5, ptr noundef nonnull %0) #16
  ...
  %83 = or i32 %82, %50
  %84 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef %83, i32 noundef 438) #16
...
90:                                               ; preds = %88
  %91 = tail call i64 @lseek64(i32 noundef %84, i64 noundef 0, i32 noundef 2) #16
  store i32 31153, ptr %14, align 8, !tbaa !19
  br label %102
...
93:                                               ; preds = %92
  %94 = tail call i64 @lseek64(i32 noundef %84, i64 noundef 0, i32 noundef 1) #16
...
64:                                               ; preds = %61, %60, %58
  %65 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %5) #17
...
75:                                               ; preds = %70
  %76 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %71, i64 noundef %67, ptr noundef nonnull @.str.5, ptr noundef nonnull %5) #16
  %77 = and i32 %52, 2048
  %78 = icmp eq i32 %77, 0
  br i1 %78, label %83, label %79

79:                                               ; preds = %75
  %80 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 3) #16
  %81 = or i32 %80, 2048
  %82 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 4, i32 noundef %81) #16
  br label %83
...
86:                                               ; preds = %83
  %87 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 1) #16
  %88 = or i32 %87, 524288
  %89 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 2, i32 noundef %88) #16
  br label %90
...
92:                                               ; preds = %90
  %93 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 2) #16
  store i32 31153, ptr %18, align 8, !tbaa !19
  br label %103

94:                                               ; preds = %90
  %95 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 1) #16
...
15:                                               ; preds = %13
  ...
  %18 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %1, i64 %17), !nosanitize !26
  %19 = extractvalue { i64, i1 } %18, 1, !nosanitize !26
  br i1 %19, label %20, label %35, !prof !27, !nosanitize !26

20:                                               ; preds = %51, %15
  tail call void @llvm.ubsantrap(i8 21) #19, !nosanitize !26
  unreachable, !nosanitize !26
...
28:                                               ; preds = %25, %21
  ...
  %30 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %1, i64 %29), !nosanitize !26
  %31 = extractvalue { i64, i1 } %30, 1, !nosanitize !26
  br i1 %31, label %32, label %33, !prof !27, !nosanitize !26

32:                                               ; preds = %124, %112, %85, %74, %43, %28
  tail call void @llvm.ubsantrap(i8 0) #19, !nosanitize !26
  unreachable, !nosanitize !26
...
43:                                               ; preds = %39
  ...
  %46 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %45, i64 %37), !nosanitize !26
  %47 = extractvalue { i64, i1 } %46, 1, !nosanitize !26
  br i1 %47, label %32, label %48, !prof !27, !nosanitize !26

48:                                               ; preds = %43
  %49 = extractvalue { i64, i1 } %46, 0, !nosanitize !26
...
51:                                               ; preds = %48
  ...
  %54 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %37, i64 %53), !nosanitize !26
  %55 = extractvalue { i64, i1 } %54, 1, !nosanitize !26
  br i1 %55, label %20, label %56, !prof !27, !nosanitize !26

56:                                               ; preds = %51
  %57 = extractvalue { i64, i1 } %54, 0, !nosanitize !26
...
74:                                               ; preds = %73, %62
  ...
  %76 = load i64, ptr %44, align 8, !tbaa !38
  %77 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %76, i64 %37), !nosanitize !26
  %78 = extractvalue { i64, i1 } %77, 1, !nosanitize !26
  br i1 %78, label %32, label %79, !prof !27, !nosanitize !26

79:                                               ; preds = %74
  %80 = extractvalue { i64, i1 } %77, 0, !nosanitize !26
  store i64 %80, ptr %44, align 8, !tbaa !38
  br label %132
...
85:                                               ; preds = %81
  ...
  %88 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %37, i64 %87), !nosanitize !26
  %89 = extractvalue { i64, i1 } %88, 0, !nosanitize !26
  %90 = extractvalue { i64, i1 } %88, 1, !nosanitize !26
  br i1 %90, label %32, label %91, !prof !27, !nosanitize !26
...
103:                                              ; preds = %96, %81
  ...
  %105 = load i32, ptr %0, align 8, !tbaa !30
  %106 = zext i32 %105 to i64
  %107 = tail call i64 @llvm.umin.i64(i64 %104, i64 %106)
  %108 = trunc nuw i64 %107 to i32
  %109 = tail call { i32, i1 } @llvm.usub.with.overflow.i32(i32 %105, i32 %108), !nosanitize !26
  %110 = extractvalue { i32, i1 } %109, 1, !nosanitize !26
  br i1 %110, label %111, label %112, !prof !27, !nosanitize !26

111:                                              ; preds = %103
  tail call void @llvm.ubsantrap(i8 21) #18, !nosanitize !26
  unreachable, !nosanitize !26

112:                                              ; preds = %103
  %113 = extractvalue { i32, i1 } %109, 0, !nosanitize !26
  store i32 %113, ptr %0, align 8, !tbaa !30
  ...
  %119 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %118, i64 %107), !nosanitize !26
  %120 = extractvalue { i64, i1 } %119, 1, !nosanitize !26
  br i1 %120, label %32, label %121, !prof !27, !nosanitize !26

121:                                              ; preds = %112
  %122 = extractvalue { i64, i1 } %119, 0, !nosanitize !26
  store i64 %122, ptr %117, align 8, !tbaa !38
  %123 = sub nsw i64 %104, %107
  br label %124

124:                                              ; preds = %121, %99
  %125 = phi i64 [ %122, %121 ], [ %102, %99 ]
  %126 = phi i64 [ %123, %121 ], [ %100, %99 ]
  %127 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store i64 %126, ptr %127, align 8, !tbaa !37
  %128 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %125, i64 %126), !nosanitize !26
  %129 = extractvalue { i64, i1 } %128, 1, !nosanitize !26
  br i1 %129, label %32, label %130, !prof !27, !nosanitize !26

130:                                              ; preds = %124
  %131 = extractvalue { i64, i1 } %128, 0, !nosanitize !26
  br label %132

132:                                              ; preds = %130, %93, %91, %83, %79, %56, %11, %8, %5, %3
  %133 = phi i64 [ %131, %130 ], [ -1, %3 ], [ -1, %5 ], [ -1, %8 ], [ -1, %11 ], [ %80, %79 ], [ -1, %56 ], [ -1, %83 ], [ -1, %91 ], [ -1, %93 ]
  ret i64 %133
}
...
42:                                               ; preds = %37
  %43 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %26) #17
  %44 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %2) #17
...
53:                                               ; preds = %48
  ...
  %55 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %39, i64 noundef %54, ptr noundef nonnull @.str.3, ptr noundef nonnull %26, ptr noundef nonnull @.str.4, ptr noundef nonnull %2) #16
  br label %56
...
15:                                               ; preds = %12, %6
  ...
  %17 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %8, i64 %16), !nosanitize !26
  %18 = extractvalue { i64, i1 } %17, 1, !nosanitize !26
  br i1 %18, label %19, label %20, !prof !27, !nosanitize !26
...
20:                                               ; preds = %15
  %21 = extractvalue { i64, i1 } %17, 0, !nosanitize !26
  br label %22
...
14:                                               ; preds = %11
  ...
  %18 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %9, i64 %17), !nosanitize !26
  %19 = extractvalue { i64, i1 } %18, 1, !nosanitize !26
  br i1 %19, label %20, label %21, !prof !27, !nosanitize !26
...
21:                                               ; preds = %14
  %22 = extractvalue { i64, i1 } %18, 0, !nosanitize !26
  br label %23
