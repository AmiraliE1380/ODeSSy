; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/both.gzlib.or.ll'
...
75:                                               ; preds = %70
  %76 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %71, i64 noundef %67, ptr noundef nonnull @.str.5, ptr noundef nonnull %0) #16
  ...
  %82 = or i32 %81, %49
  %83 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef %82, i32 noundef 438) #16
...
89:                                               ; preds = %87
  %90 = tail call i64 @lseek64(i32 noundef %83, i64 noundef 0, i32 noundef 2) #16
  store i32 31153, ptr %14, align 8, !tbaa !19
  br label %101
...
92:                                               ; preds = %91
  %93 = tail call i64 @lseek64(i32 noundef %83, i64 noundef 0, i32 noundef 1) #16
...
74:                                               ; preds = %69
  %75 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %70, i64 noundef %66, ptr noundef nonnull @.str.5, ptr noundef nonnull %5) #16
  %76 = and i32 %51, 2048
  %77 = icmp eq i32 %76, 0
  br i1 %77, label %82, label %78

78:                                               ; preds = %74
  %79 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 3) #16
  %80 = or i32 %79, 2048
  %81 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 4, i32 noundef %80) #16
  br label %82
...
85:                                               ; preds = %82
  %86 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 1) #16
  %87 = or i32 %86, 524288
  %88 = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %0, i32 noundef 2, i32 noundef %87) #16
  br label %89
...
91:                                               ; preds = %89
  %92 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 2) #16
  store i32 31153, ptr %18, align 8, !tbaa !19
  br label %102

93:                                               ; preds = %89
  %94 = tail call i64 @lseek64(i32 noundef %0, i64 noundef 0, i32 noundef 1) #16
