; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/signed.inffast.ll'
...
715:                                              ; preds = %709, %593, %587, %498, %381, %373, %257
...
861:                                              ; preds = %806, %802, %800, %777, %773, %768, %126
...
881:                                              ; preds = %875, %861
  ...
  %890 = icmp ult ptr %889, %10
  br i1 %890, label %891, label %898

891:                                              ; preds = %881
  %892 = ptrtoint ptr %10 to i64
  %893 = ptrtoint ptr %889 to i64
  %894 = sub i64 %892, %893
  %895 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %894, i64 5), !nosanitize !64
  %896 = extractvalue { i64, i1 } %895, 1, !nosanitize !64
  br i1 %896, label %897, label %905, !prof !65, !nosanitize !64
...
898:                                              ; preds = %881
  %899 = ptrtoint ptr %889 to i64
  %900 = ptrtoint ptr %10 to i64
  %901 = sub i64 %899, %900
  %902 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 5, i64 %901), !nosanitize !64
  %903 = extractvalue { i64, i1 } %902, 1, !nosanitize !64
  br i1 %903, label %904, label %905, !prof !65, !nosanitize !64
...
905:                                              ; preds = %898, %891
  %906 = phi { i64, i1 } [ %895, %891 ], [ %902, %898 ]
  %907 = extractvalue { i64, i1 } %906, 0
  %908 = trunc i64 %907 to i32
  store i32 %908, ptr %6, align 8, !tbaa !15
  %909 = icmp ult ptr %884, %23
  br i1 %909, label %910, label %916

910:                                              ; preds = %905
  %911 = ptrtoint ptr %23 to i64
  %912 = ptrtoint ptr %884 to i64
  %913 = sub i64 %911, %912
  %914 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %913, i64 257), !nosanitize !64
  %915 = extractvalue { i64, i1 } %914, 1, !nosanitize !64
  br i1 %915, label %897, label %922, !prof !65, !nosanitize !64

916:                                              ; preds = %905
  %917 = ptrtoint ptr %884 to i64
  %918 = ptrtoint ptr %23 to i64
  %919 = sub i64 %917, %918
  %920 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 257, i64 %919), !nosanitize !64
  %921 = extractvalue { i64, i1 } %920, 1, !nosanitize !64
  br i1 %921, label %904, label %922, !prof !65, !nosanitize !64

922:                                              ; preds = %916, %910
  %923 = phi { i64, i1 } [ %914, %910 ], [ %920, %916 ]
  %924 = extractvalue { i64, i1 } %923, 0
  %925 = and i32 %882, 7
  %926 = shl nsw i32 -1, %925
  %927 = xor i32 %926, -1
  %928 = zext nneg i32 %927 to i64
  %929 = and i64 %883, %928
  %930 = trunc i64 %924 to i32
  store i32 %930, ptr %15, align 8, !tbaa !17
  store i64 %929, ptr %33, align 8, !tbaa !25
  store i32 %925, ptr %35, align 8, !tbaa !26
  ret void
}
