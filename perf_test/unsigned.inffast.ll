...
1007:                                             ; preds = %987, %1001
  ...
  %1012 = and i32 %1008, -8
  %1013 = tail call { i32, i1 } @llvm.usub.with.overflow.i32(i32 %1008, i32 %1012), !nosanitize !16
  %1014 = extractvalue { i32, i1 } %1013, 1, !nosanitize !16
  br i1 %1014, label %1015, label %1016, !prof !17, !nosanitize !16
...
1016:                                             ; preds = %1007
  %1017 = lshr i32 %1008, 3
  %1018 = zext nneg i32 %1017 to i64
  %1019 = sub nsw i64 0, %1018
  %1020 = getelementptr inbounds i8, ptr %1011, i64 %1019
  store ptr %1020, ptr %0, align 8, !tbaa !14
  store ptr %1010, ptr %15, align 8, !tbaa !18
  %1021 = ptrtoint ptr %14 to i64
  %1022 = ptrtoint ptr %1020 to i64
  %1023 = sub i64 %1021, %1022
  %1024 = trunc i64 %1023 to i32
  %1025 = add i32 %1024, 5
  store i32 %1025, ptr %6, align 8, !tbaa !15
  %1026 = ptrtoint ptr %34 to i64
  %1027 = ptrtoint ptr %1010 to i64
  %1028 = sub i64 %1026, %1027
  %1029 = extractvalue { i32, i1 } %1013, 0, !nosanitize !16
  %1030 = shl nsw i32 -1, %1029
  %1031 = xor i32 %1030, -1
  %1032 = zext nneg i32 %1031 to i64
  %1033 = and i64 %1009, %1032
  %1034 = trunc i64 %1028 to i32
  %1035 = add i32 %1034, 257
  store i32 %1035, ptr %18, align 8, !tbaa !19
  store i64 %1033, ptr %44, align 8, !tbaa !27
  store i32 %1029, ptr %46, align 8, !tbaa !28
  ret void
}
