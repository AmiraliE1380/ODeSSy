; ModuleID = '/home/amiralie1380/michigan/pl/smt-compiler-oracle/perf_test/unsigned.compress.or.ll'
...
42:                                               ; preds = %38, %34
  ...
  %46 = call i32 @deflate(ptr noundef nonnull %6, i32 noundef %45) #7
  %47 = icmp eq i32 %46, 0
...
48:                                               ; preds = %42
  ...
  %52 = sub i64 %50, %51
  %53 = call i32 @deflateEnd(ptr noundef nonnull %6) #7
  %54 = icmp eq i32 %46, 1
...
41:                                               ; preds = %37, %33
  ...
  %45 = call i32 @deflate(ptr noundef nonnull %5, i32 noundef %44) #7
  %46 = icmp eq i32 %45, 0
...
47:                                               ; preds = %41
  ...
  %51 = sub i64 %49, %50
  %52 = call i32 @deflateEnd(ptr noundef nonnull %5) #7
  %53 = icmp eq i32 %45, 1
...
define dso_local range(i64 13, 0) i64 @compressBound_z(i64 noundef %0) local_unnamed_addr #4 {
  %2 = lshr i64 %0, 12
  %3 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %0, i64 %2), !nosanitize !20
  %4 = extractvalue { i64, i1 } %3, 1, !nosanitize !20
  br i1 %4, label %5, label %6, !prof !21, !nosanitize !20
...
6:                                                ; preds = %1
  %7 = extractvalue { i64, i1 } %3, 0, !nosanitize !20
  %8 = lshr i64 %0, 14
  %9 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %7, i64 %8), !nosanitize !20
  %10 = extractvalue { i64, i1 } %9, 1, !nosanitize !20
  br i1 %10, label %11, label %12, !prof !21, !nosanitize !20
...
12:                                               ; preds = %6
  %13 = extractvalue { i64, i1 } %9, 0, !nosanitize !20
  %14 = lshr i64 %0, 25
  %15 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %13, i64 %14), !nosanitize !20
  %16 = extractvalue { i64, i1 } %15, 1, !nosanitize !20
  br i1 %16, label %17, label %18, !prof !21, !nosanitize !20
...
18:                                               ; preds = %12
  %19 = extractvalue { i64, i1 } %15, 0, !nosanitize !20
  %20 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %19, i64 13), !nosanitize !20
  %21 = extractvalue { i64, i1 } %20, 1, !nosanitize !20
  br i1 %21, label %22, label %23, !prof !21, !nosanitize !20
...
23:                                               ; preds = %18
  %24 = extractvalue { i64, i1 } %20, 0, !nosanitize !20
...
; Function Attrs: nounwind memory(inaccessiblemem: write) uwtable
define dso_local range(i64 13, 0) i64 @compressBound(i64 noundef %0) local_unnamed_addr #4 {
  %2 = lshr i64 %0, 12
  %3 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %0, i64 %2), !nosanitize !20
  %4 = extractvalue { i64, i1 } %3, 1, !nosanitize !20
  br i1 %4, label %5, label %6, !prof !21, !nosanitize !20
...
attributes #4 = { nounwind memory(inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
