; ModuleID = '/home/amiralie1380/michigan/pl/zlib/compress.c'
...
17:                                               ; preds = %12
  ...
  %19 = call i32 @deflateInit_(ptr noundef nonnull %6, i32 noundef %4, ptr noundef nonnull @.str, i32 noundef 112) #8
  %20 = icmp eq i32 %19, 0
...
37:                                               ; preds = %32
  call void @llvm.ubsantrap(i8 21) #9, !nosanitize !18
...
52:                                               ; preds = %50, %40
  ...
  %56 = call i32 @deflate(ptr noundef nonnull %6, i32 noundef %55) #8
  %57 = icmp eq i32 %56, 0
...
58:                                               ; preds = %52
  ...
  %63 = call i32 @deflateEnd(ptr noundef nonnull %6) #8
  %64 = icmp eq i32 %56, 1
...
15:                                               ; preds = %11
  ...
  %17 = call i32 @deflateInit_(ptr noundef nonnull %6, i32 noundef %4, ptr noundef nonnull @.str, i32 noundef 112) #8
  %18 = icmp eq i32 %17, 0
...
50:                                               ; preds = %48, %38
  ...
  %54 = call i32 @deflate(ptr noundef nonnull %6, i32 noundef %53) #8
  %55 = icmp eq i32 %54, 0
...
56:                                               ; preds = %50
  ...
  %60 = sub i64 %58, %59
  %61 = call i32 @deflateEnd(ptr noundef nonnull %6) #8
  %62 = icmp eq i32 %54, 1
...
16:                                               ; preds = %11
  ...
  %18 = call i32 @deflateInit_(ptr noundef nonnull %5, i32 noundef -1, ptr noundef nonnull @.str, i32 noundef 112) #8
  %19 = icmp eq i32 %18, 0
...
51:                                               ; preds = %49, %39
  ...
  %55 = call i32 @deflate(ptr noundef nonnull %5, i32 noundef %54) #8
  %56 = icmp eq i32 %55, 0
...
57:                                               ; preds = %51
  ...
  %62 = call i32 @deflateEnd(ptr noundef nonnull %5) #8
  %63 = icmp eq i32 %55, 1
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @deflateInit_(ptr noundef nonnull %5, i32 noundef -1, ptr noundef nonnull @.str, i32 noundef 112) #8
  %17 = icmp eq i32 %16, 0
...
49:                                               ; preds = %47, %37
  ...
  %53 = call i32 @deflate(ptr noundef nonnull %5, i32 noundef %52) #8
  %54 = icmp eq i32 %53, 0
...
55:                                               ; preds = %49
  ...
  %59 = sub i64 %57, %58
  %60 = call i32 @deflateEnd(ptr noundef nonnull %5) #8
  %61 = icmp eq i32 %53, 1
...
5:                                                ; preds = %1
  tail call void @llvm.ubsantrap(i8 0) #9, !nosanitize !18
  unreachable, !nosanitize !18
