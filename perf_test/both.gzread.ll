...
64:                                               ; preds = %56
  tail call void @llvm.ubsantrap(i8 0) #16, !nosanitize !20
  unreachable, !nosanitize !20
...
95:                                               ; preds = %83
  ...
  %97 = tail call i32 @inflateInit2_(ptr noundef nonnull %36, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %98 = icmp eq i32 %97, 0
...
108:                                              ; preds = %105, %102
  %109 = tail call i32 @inflateReset(ptr noundef nonnull %36) #14
...
233:                                              ; preds = %227
  ...
  %238 = tail call ptr @__errno_location() #18
...
244:                                              ; preds = %239
  ...
  %251 = tail call i64 @read(i32 noundef %247, ptr noundef %249, i64 noundef %250) #14
...
271:                                              ; preds = %263, %268
  ...
  %273 = tail call ptr @strerror(i32 noundef %272) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %273) #14
  br label %1119

274:                                              ; preds = %258, %270, %266
...
309:                                              ; preds = %305
  %310 = tail call i32 @inflateReset(ptr noundef nonnull %36) #14
  store i32 2, ptr %31, align 8, !tbaa !26
...
328:                                              ; preds = %323
  ...
  %335 = tail call i64 @read(i32 noundef %331, ptr noundef %333, i64 noundef %334) #14
...
357:                                              ; preds = %348, %354
  ...
  %359 = tail call ptr @strerror(i32 noundef %358) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %359) #14
  br label %1119

360:                                              ; preds = %343, %356, %351
...
384:                                              ; preds = %379
  ...
  %391 = tail call i64 @read(i32 noundef %387, ptr noundef %389, i64 noundef %390) #14
...
411:                                              ; preds = %403, %408
  ...
  %413 = tail call ptr @strerror(i32 noundef %412) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %413) #14
  %414 = load i32, ptr %10, align 8, !tbaa !16
  br label %449

415:                                              ; preds = %398, %410, %406
...
429:                                              ; preds = %421, %366
  %430 = tail call i32 @inflate(ptr noundef nonnull %36, i32 noundef 0) #14
...
441:                                              ; preds = %437
  ...
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %444) #14
  br label %449
...
449:                                              ; preds = %445, %370, %441, %440, %436, %435, %428, %425, %411
...
541:                                              ; preds = %538
  ...
  %544 = tail call noalias ptr @malloc(i64 noundef %543) #17
  store ptr %544, ptr %489, align 8, !tbaa !29
  %545 = load i32, ptr %496, align 4, !tbaa !28
  %546 = shl i32 %545, 1
  %547 = zext i32 %546 to i64
  %548 = tail call noalias ptr @malloc(i64 noundef %547) #17
...
552:                                              ; preds = %541
  tail call void @free(ptr noundef %548) #14
  tail call void @free(ptr noundef %544) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -4, ptr noundef nonnull @.str.5) #14
  br label %934
...
553:                                              ; preds = %541
  ...
  %555 = tail call i32 @inflateInit2_(ptr noundef nonnull %488, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %556 = icmp eq i32 %555, 0
  br i1 %556, label %560, label %557

557:                                              ; preds = %553
  %558 = load ptr, ptr %495, align 8, !tbaa !30
  tail call void @free(ptr noundef %558) #14
...
566:                                              ; preds = %563, %560
  %567 = tail call i32 @inflateReset(ptr noundef nonnull %488) #14
...
702:                                              ; preds = %697
  ...
  %709 = tail call i64 @read(i32 noundef %705, ptr noundef %707, i64 noundef %708) #14
...
729:                                              ; preds = %721, %726
  ...
  %731 = tail call ptr @strerror(i32 noundef %730) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %731) #14
  br label %934

732:                                              ; preds = %716, %728, %724
...
767:                                              ; preds = %763
  %768 = tail call i32 @inflateReset(ptr noundef nonnull %488) #14
  store i32 2, ptr %484, align 8, !tbaa !26
...
776:                                              ; preds = %536
  ...
  %779 = shl i32 %778, 1
  store i32 0, ptr %490, align 4, !tbaa !17
  %780 = tail call ptr @__errno_location() #18
...
786:                                              ; preds = %781
  ...
  %793 = tail call i64 @read(i32 noundef %789, ptr noundef %791, i64 noundef %792) #14
...
815:                                              ; preds = %812, %806
  ...
  %817 = tail call ptr @strerror(i32 noundef %816) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %817) #14
  br label %934

818:                                              ; preds = %801, %814, %809
...
842:                                              ; preds = %837
  ...
  %849 = tail call i64 @read(i32 noundef %845, ptr noundef %847, i64 noundef %848) #14
...
869:                                              ; preds = %861, %866
  ...
  %871 = tail call ptr @strerror(i32 noundef %870) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %871) #14
  %872 = load i32, ptr %10, align 8, !tbaa !16
  br label %907

873:                                              ; preds = %856, %868, %864
...
887:                                              ; preds = %879, %824
  %888 = tail call i32 @inflate(ptr noundef nonnull %488, i32 noundef 0) #14
...
899:                                              ; preds = %895
  ...
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %902) #14
  br label %907
...
907:                                              ; preds = %903, %828, %899, %898, %894, %893, %886, %883, %869
...
934:                                              ; preds = %913, %571, %920, %815, %729, %557, %552
...
940:                                              ; preds = %938
  store i32 0, ptr %490, align 4, !tbaa !17
  %941 = tail call ptr @__errno_location() #18
...
947:                                              ; preds = %942
  ...
  %954 = tail call i64 @read(i32 noundef %950, ptr noundef %952, i64 noundef %953) #14
...
973:                                              ; preds = %971, %966
  ...
  %975 = tail call ptr @strerror(i32 noundef %974) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %975) #14
  br label %1082
...
987:                                              ; preds = %984
  ...
  store i32 0, ptr %490, align 4, !tbaa !17
  %990 = tail call ptr @__errno_location() #18
...
996:                                              ; preds = %991
  ...
  %1003 = tail call i64 @read(i32 noundef %999, ptr noundef %1001, i64 noundef %1002) #14
...
1023:                                             ; preds = %1015, %1020
  %1024 = phi i32 [ %1021, %1020 ], [ %1016, %1015 ]
  %1025 = tail call ptr @strerror(i32 noundef %1024) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %1025) #14
  %1026 = load i32, ptr %10, align 8, !tbaa !16
  br label %1061

1027:                                             ; preds = %1010, %1022, %1018
...
1041:                                             ; preds = %1033, %978
  %1042 = tail call i32 @inflate(ptr noundef nonnull %488, i32 noundef 0) #14
...
1053:                                             ; preds = %1049
  ...
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %1056) #14
  br label %1061
...
1061:                                             ; preds = %1057, %982, %1053, %1052, %1048, %1047, %1040, %1037, %1023
...
1101:                                             ; preds = %929, %923, %773, %1099, %934, %818
...
1127:                                             ; preds = %1123
  %1128 = tail call ptr @__errno_location() #18
  %1129 = load i32, ptr %1128, align 4, !tbaa !4
  %1130 = tail call ptr @strerror(i32 noundef %1129) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %1130) #14
  br label %1131

1131:                                             ; preds = %1115, %1123, %1121, %12, %5, %3, %1127, %18
...
103:                                              ; preds = %91
  ...
  %105 = tail call i32 @inflateInit2_(ptr noundef nonnull %44, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
...
116:                                              ; preds = %113, %110
  %117 = tail call i32 @inflateReset(ptr noundef nonnull %44) #14
...
252:                                              ; preds = %247
  ...
  %259 = tail call i64 @read(i32 noundef %255, ptr noundef %257, i64 noundef %258) #14
...
279:                                              ; preds = %271, %276
  ...
  %281 = tail call ptr @strerror(i32 noundef %280) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %281) #14
  br label %1123

282:                                              ; preds = %266, %278, %274
...
317:                                              ; preds = %313
  %318 = tail call i32 @inflateReset(ptr noundef nonnull %44) #14
  store i32 2, ptr %39, align 8, !tbaa !26
...
336:                                              ; preds = %331
  ...
  %343 = tail call i64 @read(i32 noundef %339, ptr noundef %341, i64 noundef %342) #14
...
365:                                              ; preds = %356, %362
  ...
  %367 = tail call ptr @strerror(i32 noundef %366) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %367) #14
  br label %1123

368:                                              ; preds = %351, %364, %359
...
392:                                              ; preds = %387
  ...
  %399 = tail call i64 @read(i32 noundef %395, ptr noundef %397, i64 noundef %398) #14
...
419:                                              ; preds = %411, %416
  ...
  %421 = tail call ptr @strerror(i32 noundef %420) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %421) #14
  %422 = load i32, ptr %11, align 8, !tbaa !16
  br label %457

423:                                              ; preds = %406, %418, %414
...
437:                                              ; preds = %429, %374
  %438 = tail call i32 @inflate(ptr noundef nonnull %44, i32 noundef 0) #14
...
449:                                              ; preds = %445
  ...
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -3, ptr noundef nonnull %452) #14
  br label %457
...
457:                                              ; preds = %453, %378, %449, %448, %444, %443, %436, %433, %419
...
549:                                              ; preds = %546
  ...
  %552 = tail call noalias ptr @malloc(i64 noundef %551) #17
...
560:                                              ; preds = %549
  tail call void @free(ptr noundef %556) #14
...
561:                                              ; preds = %549
  ...
  %563 = tail call i32 @inflateInit2_(ptr noundef nonnull %496, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %564 = icmp eq i32 %563, 0
  br i1 %564, label %568, label %565

565:                                              ; preds = %561
  %566 = load ptr, ptr %503, align 8, !tbaa !30
  tail call void @free(ptr noundef %566) #14
  %567 = load ptr, ptr %497, align 8, !tbaa !29
  tail call void @free(ptr noundef %567) #14
...
574:                                              ; preds = %571, %568
  %575 = tail call i32 @inflateReset(ptr noundef nonnull %496) #14
...
699:                                              ; preds = %693
  ...
  %704 = tail call ptr @__errno_location() #18
...
710:                                              ; preds = %705
  ...
  %717 = tail call i64 @read(i32 noundef %713, ptr noundef %715, i64 noundef %716) #14
...
737:                                              ; preds = %729, %734
  ...
  %739 = tail call ptr @strerror(i32 noundef %738) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %739) #14
  br label %942

740:                                              ; preds = %724, %736, %732
...
775:                                              ; preds = %771
  %776 = tail call i32 @inflateReset(ptr noundef nonnull %496) #14
  store i32 2, ptr %492, align 8, !tbaa !26
...
794:                                              ; preds = %789
  ...
  %801 = tail call i64 @read(i32 noundef %797, ptr noundef %799, i64 noundef %800) #14
...
823:                                              ; preds = %820, %814
  ...
  %825 = tail call ptr @strerror(i32 noundef %824) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %825) #14
  br label %942

826:                                              ; preds = %809, %822, %817
...
841:                                              ; preds = %838
  ...
  store i32 0, ptr %498, align 4, !tbaa !17
  %844 = tail call ptr @__errno_location() #18
...
850:                                              ; preds = %845
  ...
  %857 = tail call i64 @read(i32 noundef %853, ptr noundef %855, i64 noundef %856) #14
...
877:                                              ; preds = %869, %874
  ...
  %879 = tail call ptr @strerror(i32 noundef %878) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %879) #14
  %880 = load i32, ptr %11, align 8, !tbaa !16
  br label %915

881:                                              ; preds = %864, %876, %872
...
895:                                              ; preds = %887, %832
  %896 = tail call i32 @inflate(ptr noundef nonnull %496, i32 noundef 0) #14
...
907:                                              ; preds = %903
  ...
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -3, ptr noundef nonnull %910) #14
  br label %915
...
915:                                              ; preds = %911, %836, %907, %906, %902, %901, %894, %891, %877
...
942:                                              ; preds = %921, %579, %928, %823, %737, %565, %560
...
948:                                              ; preds = %946
  store i32 0, ptr %498, align 4, !tbaa !17
  %949 = tail call ptr @__errno_location() #18
...
955:                                              ; preds = %950
  ...
  %962 = tail call i64 @read(i32 noundef %958, ptr noundef %960, i64 noundef %961) #14
...
981:                                              ; preds = %979, %974
  ...
  %983 = tail call ptr @strerror(i32 noundef %982) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %983) #14
  br label %1090
...
995:                                              ; preds = %992
  ...
  store i32 0, ptr %498, align 4, !tbaa !17
  %998 = tail call ptr @__errno_location() #18
...
1004:                                             ; preds = %999
  ...
  %1011 = tail call i64 @read(i32 noundef %1007, ptr noundef %1009, i64 noundef %1010) #14
...
1031:                                             ; preds = %1023, %1028
  %1032 = phi i32 [ %1029, %1028 ], [ %1024, %1023 ]
  %1033 = tail call ptr @strerror(i32 noundef %1032) #14
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -1, ptr noundef %1033) #14
  %1034 = load i32, ptr %11, align 8, !tbaa !16
  br label %1069

1035:                                             ; preds = %1018, %1030, %1026
...
1049:                                             ; preds = %1041, %986
  %1050 = tail call i32 @inflate(ptr noundef nonnull %496, i32 noundef 0) #14
...
1061:                                             ; preds = %1057
  ...
  tail call void @gz_error(ptr noundef nonnull %3, i32 noundef -3, ptr noundef nonnull %1064) #14
  br label %1069
...
1069:                                             ; preds = %1065, %990, %1061, %1060, %1056, %1055, %1048, %1045, %1031
...
1109:                                             ; preds = %937, %931, %781, %1107, %942, %826
...
93:                                               ; preds = %90
  ...
  %96 = tail call noalias ptr @malloc(i64 noundef %95) #17
...
105:                                              ; preds = %93
  ...
  %107 = tail call i32 @inflateInit2_(ptr noundef nonnull %46, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
...
118:                                              ; preds = %115, %112
  %119 = tail call i32 @inflateReset(ptr noundef nonnull %46) #14
...
243:                                              ; preds = %237
  ...
  %248 = tail call ptr @__errno_location() #18
...
254:                                              ; preds = %249
  ...
  %261 = tail call i64 @read(i32 noundef %257, ptr noundef %259, i64 noundef %260) #14
...
281:                                              ; preds = %273, %278
  ...
  %283 = tail call ptr @strerror(i32 noundef %282) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %283) #14
  br label %1130

284:                                              ; preds = %268, %280, %276
...
319:                                              ; preds = %315
  %320 = tail call i32 @inflateReset(ptr noundef nonnull %46) #14
  store i32 2, ptr %41, align 8, !tbaa !26
...
338:                                              ; preds = %333
  ...
  %345 = tail call i64 @read(i32 noundef %341, ptr noundef %343, i64 noundef %344) #14
...
367:                                              ; preds = %358, %364
  ...
  %369 = tail call ptr @strerror(i32 noundef %368) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %369) #14
  br label %1130

370:                                              ; preds = %353, %366, %361
...
394:                                              ; preds = %389
  ...
  %401 = tail call i64 @read(i32 noundef %397, ptr noundef %399, i64 noundef %400) #14
...
421:                                              ; preds = %413, %418
  ...
  %423 = tail call ptr @strerror(i32 noundef %422) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %423) #14
  %424 = load i32, ptr %9, align 8, !tbaa !16
  br label %459

425:                                              ; preds = %408, %420, %416
...
439:                                              ; preds = %431, %376
  %440 = tail call i32 @inflate(ptr noundef nonnull %46, i32 noundef 0) #14
...
451:                                              ; preds = %447
  ...
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %454) #14
  br label %459
...
459:                                              ; preds = %455, %380, %451, %450, %446, %445, %438, %435, %421
...
551:                                              ; preds = %548
  ...
  %554 = call noalias ptr @malloc(i64 noundef %553) #17
  store ptr %554, ptr %499, align 8, !tbaa !29
  %555 = load i32, ptr %506, align 4, !tbaa !28
  %556 = shl i32 %555, 1
  %557 = zext i32 %556 to i64
  %558 = call noalias ptr @malloc(i64 noundef %557) #17
...
563:                                              ; preds = %551
  ...
  %565 = call i32 @inflateInit2_(ptr noundef nonnull %498, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %566 = icmp eq i32 %565, 0
  br i1 %566, label %570, label %567

567:                                              ; preds = %563
  %568 = load ptr, ptr %505, align 8, !tbaa !30
  call void @free(ptr noundef %568) #14
...
576:                                              ; preds = %573, %570
  %577 = call i32 @inflateReset(ptr noundef nonnull %498) #14
...
701:                                              ; preds = %695
  ...
  %706 = tail call ptr @__errno_location() #18
...
712:                                              ; preds = %707
  ...
  %719 = call i64 @read(i32 noundef %715, ptr noundef %717, i64 noundef %718) #14
...
739:                                              ; preds = %731, %736
  ...
  %741 = call ptr @strerror(i32 noundef %740) #14
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %741) #14
  br label %944

742:                                              ; preds = %726, %738, %734
...
777:                                              ; preds = %773
  %778 = call i32 @inflateReset(ptr noundef nonnull %498) #14
  store i32 2, ptr %494, align 8, !tbaa !26
...
786:                                              ; preds = %546
  ...
  %789 = shl i32 %788, 1
  store i32 0, ptr %500, align 4, !tbaa !17
  %790 = tail call ptr @__errno_location() #18
...
796:                                              ; preds = %791
  ...
  %803 = call i64 @read(i32 noundef %799, ptr noundef %801, i64 noundef %802) #14
...
825:                                              ; preds = %822, %816
  ...
  %827 = call ptr @strerror(i32 noundef %826) #14
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %827) #14
  br label %944

828:                                              ; preds = %811, %824, %819
...
843:                                              ; preds = %840
  ...
  store i32 0, ptr %500, align 4, !tbaa !17
  %846 = tail call ptr @__errno_location() #18
...
852:                                              ; preds = %847
  ...
  %859 = call i64 @read(i32 noundef %855, ptr noundef %857, i64 noundef %858) #14
...
879:                                              ; preds = %871, %876
  ...
  %881 = call ptr @strerror(i32 noundef %880) #14
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %881) #14
  %882 = load i32, ptr %9, align 8, !tbaa !16
  br label %917

883:                                              ; preds = %866, %878, %874
...
897:                                              ; preds = %889, %834
  %898 = call i32 @inflate(ptr noundef nonnull %498, i32 noundef 0) #14
...
909:                                              ; preds = %905
  ...
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %912) #14
  br label %917
...
917:                                              ; preds = %913, %838, %909, %908, %904, %903, %896, %893, %879
...
944:                                              ; preds = %923, %581, %930, %825, %739, %567, %562
...
950:                                              ; preds = %948
  store i32 0, ptr %500, align 4, !tbaa !17
  %951 = tail call ptr @__errno_location() #18
...
957:                                              ; preds = %952
  ...
  %964 = call i64 @read(i32 noundef %960, ptr noundef %962, i64 noundef %963) #14
...
983:                                              ; preds = %981, %976
  ...
  %985 = call ptr @strerror(i32 noundef %984) #14
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %985) #14
  br label %1092
...
997:                                              ; preds = %994
  ...
  store i32 0, ptr %500, align 4, !tbaa !17
  %1000 = tail call ptr @__errno_location() #18
...
1006:                                             ; preds = %1001
  ...
  %1013 = call i64 @read(i32 noundef %1009, ptr noundef %1011, i64 noundef %1012) #14
...
1033:                                             ; preds = %1025, %1030
  ...
  %1035 = call ptr @strerror(i32 noundef %1034) #14
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %1035) #14
  %1036 = load i32, ptr %9, align 8, !tbaa !16
  br label %1071

1037:                                             ; preds = %1020, %1032, %1028
...
1051:                                             ; preds = %1043, %988
  %1052 = call i32 @inflate(ptr noundef nonnull %498, i32 noundef 0) #14
...
1063:                                             ; preds = %1059
  ...
  call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %1066) #14
  br label %1071
...
1071:                                             ; preds = %1067, %992, %1063, %1062, %1058, %1057, %1050, %1047, %1033
...
1112:                                             ; preds = %939, %933, %783, %828, %944, %1109
...
1130:                                             ; preds = %465, %123, %281, %367, %472, %109, %104, %1124
  br label %1131

1131:                                             ; preds = %1130, %1124, %11, %4, %1, %25
...
1112:                                             ; preds = %939, %933, %783, %1109, %944, %828
  %1113 = phi i32 [ %1094, %1109 ], [ %947, %944 ], [ 0, %828 ], [ 0, %783 ], [ 0, %933 ], [ 0, %939 ]
  %1114 = phi i64 [ %1102, %1109 ], [ %512, %944 ], [ %512, %828 ], [ %512, %783 ], [ %512, %933 ], [ %512, %939 ]
  %1115 = phi i64 [ %1096, %1109 ], [ %511, %944 ], [ %511, %828 ], [ %511, %783 ], [ %511, %933 ], [ %511, %939 ]
  %1116 = phi ptr [ %1100, %1109 ], [ %510, %944 ], [ %510, %828 ], [ %510, %783 ], [ %510, %933 ], [ %510, %939 ]
...
1130:                                             ; preds = %465, %123, %1124, %472, %367, %281, %109, %104
  br label %1131

1131:                                             ; preds = %1, %4, %11, %25, %1124, %1130
  %1132 = phi i32 [ -1, %4 ], [ -1, %1 ], [ %31, %25 ], [ -1, %11 ], [ -1, %1130 ], [ %1129, %1124 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #14
  ret i32 %1132
}
...
183:                                              ; preds = %176
  ...
  %189 = tail call ptr @__errno_location() #18
...
337:                                              ; preds = %334
  ...
  %340 = tail call noalias ptr @malloc(i64 noundef %339) #17
  store ptr %340, ptr %291, align 8, !tbaa !29
  %341 = load i32, ptr %296, align 4, !tbaa !28
  %342 = shl i32 %341, 1
  %343 = zext i32 %342 to i64
  %344 = tail call noalias ptr @malloc(i64 noundef %343) #17
...
348:                                              ; preds = %337
  tail call void @free(ptr noundef %344) #14
  tail call void @free(ptr noundef %340) #14
  tail call void @gz_error(ptr noundef nonnull %1, i32 noundef -4, ptr noundef nonnull @.str.5) #14
  br label %808
...
349:                                              ; preds = %337
  ...
  %351 = tail call i32 @inflateInit2_(ptr noundef nonnull %290, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %352 = icmp eq i32 %351, 0
  br i1 %352, label %356, label %353

353:                                              ; preds = %349
  %354 = load ptr, ptr %288, align 8, !tbaa !30
  tail call void @free(ptr noundef %354) #14
...
362:                                              ; preds = %359, %356
  %363 = tail call i32 @inflateReset(ptr noundef nonnull %290) #14
  store i32 2, ptr %9, align 8, !tbaa !26
...
487:                                              ; preds = %481
  ...
  %492 = tail call ptr @__errno_location() #18
...
498:                                              ; preds = %493
  ...
  %505 = tail call i64 @read(i32 noundef %501, ptr noundef %503, i64 noundef %504) #14
...
525:                                              ; preds = %517, %522
  ...
  %527 = tail call ptr @strerror(i32 noundef %526) #14
  tail call void @gz_error(ptr noundef nonnull %1, i32 noundef -1, ptr noundef %527) #14
  br label %808

528:                                              ; preds = %512, %524, %520
...
563:                                              ; preds = %559
  %564 = tail call i32 @inflateReset(ptr noundef nonnull %290) #14
  store i32 2, ptr %9, align 8, !tbaa !26
...
572:                                              ; preds = %332
  ...
  %575 = shl i32 %574, 1
  store i32 0, ptr %292, align 4, !tbaa !17
  %576 = tail call ptr @__errno_location() #18
...
582:                                              ; preds = %577
  ...
  %589 = tail call i64 @read(i32 noundef %585, ptr noundef %587, i64 noundef %588) #14
...
611:                                              ; preds = %602, %608
  ...
  %613 = tail call ptr @strerror(i32 noundef %612) #14
  tail call void @gz_error(ptr noundef nonnull %1, i32 noundef -1, ptr noundef %613) #14
  br label %808

614:                                              ; preds = %597, %610, %605
...
629:                                              ; preds = %626
  ...
  store i32 0, ptr %292, align 4, !tbaa !17
  %632 = tail call ptr @__errno_location() #18
...
638:                                              ; preds = %633
  ...
  %645 = tail call i64 @read(i32 noundef %641, ptr noundef %643, i64 noundef %644) #14
...
665:                                              ; preds = %657, %662
  ...
  %667 = tail call ptr @strerror(i32 noundef %666) #14
  tail call void @gz_error(ptr noundef nonnull %1, i32 noundef -1, ptr noundef %667) #14
  %668 = load i32, ptr %271, align 8, !tbaa !16
  br label %703

669:                                              ; preds = %652, %664, %660
...
683:                                              ; preds = %675, %620
  %684 = tail call i32 @inflate(ptr noundef nonnull %290, i32 noundef 0) #14
...
695:                                              ; preds = %691
  ...
  tail call void @gz_error(ptr noundef nonnull %1, i32 noundef -3, ptr noundef nonnull %698) #14
  br label %703
...
703:                                              ; preds = %699, %624, %695, %694, %690, %689, %682, %679, %665
...
756:                                              ; preds = %797, %741
  tail call void @llvm.ubsantrap(i8 21) #16, !nosanitize !20
  unreachable, !nosanitize !20
...
808:                                              ; preds = %367, %709, %348, %525, %611, %716, %353, %736, %734, %273, %4, %2, %805, %765, %757
...
93:                                               ; preds = %81
  ...
  %95 = tail call i32 @inflateInit2_(ptr noundef nonnull %34, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %96 = icmp eq i32 %95, 0
...
106:                                              ; preds = %103, %100
  %107 = tail call i32 @inflateReset(ptr noundef nonnull %34) #14
...
242:                                              ; preds = %237
  ...
  %249 = tail call i64 @read(i32 noundef %245, ptr noundef %247, i64 noundef %248) #14
...
269:                                              ; preds = %261, %266
  ...
  %271 = tail call ptr @strerror(i32 noundef %270) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %271) #14
  br label %954

272:                                              ; preds = %256, %268, %264
...
307:                                              ; preds = %303
  %308 = tail call i32 @inflateReset(ptr noundef nonnull %34) #14
  store i32 2, ptr %29, align 8, !tbaa !26
...
326:                                              ; preds = %321
  ...
  %333 = tail call i64 @read(i32 noundef %329, ptr noundef %331, i64 noundef %332) #14
...
373:                                              ; preds = %370
  ...
  store i32 0, ptr %36, align 4, !tbaa !17
  %376 = tail call ptr @__errno_location() #18
...
382:                                              ; preds = %377
  ...
  %389 = tail call i64 @read(i32 noundef %385, ptr noundef %387, i64 noundef %388) #14
...
409:                                              ; preds = %401, %406
  ...
  %411 = tail call ptr @strerror(i32 noundef %410) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %411) #14
  %412 = load i32, ptr %14, align 8, !tbaa !16
  br label %447

413:                                              ; preds = %396, %408, %404
...
427:                                              ; preds = %419, %364
  %428 = tail call i32 @inflate(ptr noundef nonnull %34, i32 noundef 0) #14
...
439:                                              ; preds = %435
  ...
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %442) #14
  br label %447
...
447:                                              ; preds = %443, %368, %439, %438, %434, %433, %426, %423, %409
...
511:                                              ; preds = %508
  ...
  %514 = tail call noalias ptr @malloc(i64 noundef %513) #17
  store ptr %514, ptr %490, align 8, !tbaa !29
  %515 = load i32, ptr %496, align 4, !tbaa !28
  %516 = shl i32 %515, 1
  %517 = zext i32 %516 to i64
  %518 = tail call noalias ptr @malloc(i64 noundef %517) #17
...
523:                                              ; preds = %511
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %497, i8 0, i64 24, i1 false)
  %525 = tail call i32 @inflateInit2_(ptr noundef nonnull %487, i32 noundef 31, ptr noundef nonnull @.str.7, i32 noundef 112) #14
  %526 = icmp eq i32 %525, 0
  br i1 %526, label %530, label %527

527:                                              ; preds = %523
  %528 = load ptr, ptr %485, align 8, !tbaa !30
  tail call void @free(ptr noundef %528) #14
  %529 = load ptr, ptr %490, align 8, !tbaa !29
  tail call void @free(ptr noundef %529) #14
...
536:                                              ; preds = %533, %530
  %537 = tail call i32 @inflateReset(ptr noundef nonnull %487) #14
...
661:                                              ; preds = %655
  ...
  %666 = tail call ptr @__errno_location() #18
...
672:                                              ; preds = %667
  ...
  %679 = tail call i64 @read(i32 noundef %675, ptr noundef %677, i64 noundef %678) #14
...
699:                                              ; preds = %691, %696
  ...
  %701 = tail call ptr @strerror(i32 noundef %700) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %701) #14
  br label %950

702:                                              ; preds = %686, %698, %694
...
737:                                              ; preds = %733
  %738 = tail call i32 @inflateReset(ptr noundef nonnull %487) #14
  store i32 2, ptr %482, align 8, !tbaa !26
...
746:                                              ; preds = %506
  ...
  %749 = shl i32 %748, 1
  store i32 0, ptr %491, align 4, !tbaa !17
  %750 = tail call ptr @__errno_location() #18
...
756:                                              ; preds = %751
  ...
  %763 = tail call i64 @read(i32 noundef %759, ptr noundef %761, i64 noundef %762) #14
...
785:                                              ; preds = %776, %782
  ...
  %787 = tail call ptr @strerror(i32 noundef %786) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %787) #14
  br label %950

788:                                              ; preds = %771, %784, %779
...
803:                                              ; preds = %800
  ...
  store i32 0, ptr %491, align 4, !tbaa !17
  %806 = tail call ptr @__errno_location() #18
...
812:                                              ; preds = %807
  ...
  %819 = tail call i64 @read(i32 noundef %815, ptr noundef %817, i64 noundef %818) #14
...
839:                                              ; preds = %831, %836
  ...
  %841 = tail call ptr @strerror(i32 noundef %840) #14
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -1, ptr noundef %841) #14
  %842 = load i32, ptr %14, align 8, !tbaa !16
  br label %877

843:                                              ; preds = %826, %838, %834
...
857:                                              ; preds = %849, %794
  %858 = tail call i32 @inflate(ptr noundef nonnull %487, i32 noundef 0) #14
...
869:                                              ; preds = %865
  ...
  tail call void @gz_error(ptr noundef nonnull %0, i32 noundef -3, ptr noundef nonnull %872) #14
  br label %877
...
877:                                              ; preds = %873, %798, %869, %868, %864, %863, %856, %853, %839
...
908:                                              ; preds = %501, %903
  ...
  %913 = tail call ptr @memchr(ptr noundef %911, i32 noundef 10, i64 noundef %912) #19
...
950:                                              ; preds = %945, %883, %541, %527, %522, %699, %785, %890, %906
...
954:                                              ; preds = %111, %453, %478, %92, %269, %355, %460, %97, %950, %16, %9, %3, %953
...
182:                                              ; preds = %175
  ...
  %188 = tail call ptr @__errno_location() #18
