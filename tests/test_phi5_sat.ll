; ModuleID = 'test_phi5_sat.c'
source_filename = "test_phi5_sat.c"
...
define i32 @test_phi5_sat(i32 %input) {
entry:
...
merge:
  ; 3-Way Phi. Branch 1 contains the dangerous value.
  %val = phi i32 [ 2147483640, %path1 ], [ 200, %path2 ], [ 300, %path3 ]
