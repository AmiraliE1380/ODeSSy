; ModuleID = 'test_phi7.c'
source_filename = "test_phi7.c"
...
define i32 @test_phi7(i32 %x, i32 %y, i32 %z) {
entry:
  ; ================= LAYER 1 (3 Paths) =================
...
L1_merge:
  %val1 = phi i32 [ 10, %L1_A ], [ 20, %L1_B ], [ 30, %L1_C ]
...
L3_A:
  %v3a = add i32 %val2, 100
  br label %L3_merge
L3_B:
  %v3b = add i32 %val2, 200
  br label %L3_merge
