; ModuleID = '/mydata/ODeSSy/perf_zstd_work/obj.oracle/fse_compress.ll.mid'
...
78:                                               ; preds = %.loopexit16, %69
  %79 = phi i64 [ %116, %.loopexit16 ], [ 0, %69 ]
  %80 = phi i64 [ %115, %.loopexit16 ], [ 0, %69 ]
  %81 = phi i64 [ %117, %.loopexit16 ], [ 0, %69 ]
...
105:                                              ; preds = %97
  ...
  br i1 %108, label %.loopexit16, label %.preheader52

.preheader52:                                     ; preds = %105, %86
  %.ph = phi i64 [ %107, %105 ], [ 8, %86 ]
  br label %109

109:                                              ; preds = %.preheader52, %109
  %110 = phi i64 [ %112, %109 ], [ %.ph, %.preheader52 ]
  %111 = getelementptr inbounds nuw i8, ptr %84, i64 %110
  store i64 %81, ptr %111, align 1, !tbaa !12
  %112 = add nuw nsw i64 %110, 8
  %113 = icmp samesign ult i64 %112, %87
  br i1 %113, label %109, label %.loopexit16, !llvm.loop !17

.loopexit16:                                      ; preds = %109, %105, %78
  %114 = sext i16 %83 to i64
  %115 = add i64 %80, %114
  %116 = add nuw nsw i64 %79, 1
  %117 = add i64 %81, 72340172838076673
  %118 = icmp eq i64 %116, %66
  br i1 %118, label %.loopexit17, label %78, !llvm.loop !18

119:                                              ; preds = %119, %.loopexit17
  %120 = phi i64 [ 0, %.loopexit17 ], [ %133, %119 ]
  %121 = phi i64 [ 0, %.loopexit17 ], [ %132, %119 ]
  %122 = getelementptr inbounds nuw i8, ptr %77, i64 %120
  %123 = and i64 %121, %74
  %124 = load i8, ptr %122, align 1, !tbaa !9
  %125 = getelementptr inbounds nuw i8, ptr %21, i64 %123
  store i8 %124, ptr %125, align 1, !tbaa !9
  %126 = add nuw nsw i64 %121, %73
  %127 = and i64 %126, %74
  %128 = getelementptr inbounds nuw i8, ptr %122, i64 1
  %129 = load i8, ptr %128, align 1, !tbaa !9
  %130 = getelementptr inbounds nuw i8, ptr %21, i64 %127
  store i8 %129, ptr %130, align 1, !tbaa !9
  %131 = add nuw nsw i64 %121, %76
  %132 = and i64 %131, %74
  %133 = add nuw nsw i64 %120, 2
  %134 = icmp samesign ult i64 %133, %72
  br i1 %134, label %119, label %.loopexit15, !llvm.loop !19

.preheader:                                       ; preds = %63, %.loopexit18
  %135 = phi i64 [ %179, %.loopexit18 ], [ 0, %63 ]
  %136 = phi i32 [ %178, %.loopexit18 ], [ 0, %63 ]
  %137 = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %135
  %138 = load i16, ptr %137, align 2, !tbaa !5
  %139 = icmp sgt i16 %138, 0
  br i1 %139, label %140, label %.loopexit18

140:                                              ; preds = %.preheader
  %141 = trunc i64 %135 to i8
...
146:                                              ; preds = %164, %143
  %147 = phi i32 [ %136, %143 ], [ %162, %164 ]
  %148 = phi i32 [ 0, %143 ], [ %165, %164 ]
  %149 = zext nneg i32 %147 to i64
  %150 = getelementptr inbounds nuw i8, ptr %21, i64 %149
  store i8 %141, ptr %150, align 1, !tbaa !9
  br label %151

151:                                              ; preds = %151, %146
  %152 = phi i32 [ %147, %146 ], [ %154, %151 ]
  %153 = add nuw i32 %152, %17
  %154 = and i32 %153, %8
  %155 = icmp ugt i32 %154, %60
  br i1 %155, label %151, label %156, !llvm.loop !20

156:                                              ; preds = %151
  %157 = zext nneg i32 %154 to i64
  %158 = getelementptr inbounds nuw i8, ptr %21, i64 %157
  store i8 %141, ptr %158, align 1, !tbaa !9
  br label %159

159:                                              ; preds = %159, %156
  %160 = phi i32 [ %154, %156 ], [ %162, %159 ]
  %161 = add nuw i32 %160, %17
  %162 = and i32 %161, %8
  %163 = icmp ugt i32 %162, %60
  br i1 %163, label %159, label %164, !llvm.loop !20
...
167:                                              ; preds = %164
  ...
  br i1 %169, label %.loopexit18, label %.thread

.thread:                                          ; preds = %140, %167
  %170 = phi i32 [ %162, %167 ], [ %136, %140 ]
  %171 = zext nneg i32 %170 to i64
  %172 = getelementptr inbounds nuw i8, ptr %21, i64 %171
  store i8 %141, ptr %172, align 1, !tbaa !9
  br label %173

173:                                              ; preds = %173, %.thread
  %174 = phi i32 [ %170, %.thread ], [ %176, %173 ]
  %175 = add nuw i32 %174, %17
  %176 = and i32 %175, %8
  %177 = icmp ugt i32 %176, %60
  br i1 %177, label %173, label %.loopexit18, !llvm.loop !20

.loopexit18:                                      ; preds = %173, %167, %.preheader
  %178 = phi i32 [ %136, %.preheader ], [ %162, %167 ], [ %176, %173 ]
  %179 = add nuw nsw i64 %135, 1
  %180 = icmp eq i64 %179, %66
  br i1 %180, label %.loopexit15, label %.preheader, !llvm.loop !22

.loopexit15:                                      ; preds = %.loopexit18, %119
  %181 = zext i32 %7 to i64
  %182 = and i64 %181, 1
  br i1 %10, label %.loopexit14, label %183

183:                                              ; preds = %.loopexit15
  %184 = and i64 %181, 4294967294
  br label %206

.loopexit14:                                      ; preds = %206, %.loopexit15
  %185 = phi i64 [ 0, %.loopexit15 ], [ %184, %206 ]
  %186 = icmp eq i64 %182, 0
  br i1 %186, label %199, label %187

187:                                              ; preds = %.loopexit14
  %188 = getelementptr inbounds nuw i8, ptr %21, i64 %185
  %189 = load i8, ptr %188, align 1, !tbaa !9
  %190 = trunc nuw i64 %185 to i32
  %191 = add i32 %7, %190
  %192 = trunc i32 %191 to i16
  %193 = zext i8 %189 to i64
  %194 = getelementptr inbounds nuw [2 x i8], ptr %4, i64 %193
  %195 = load i16, ptr %194, align 2, !tbaa !5
  %196 = add i16 %195, 1
  store i16 %196, ptr %194, align 2, !tbaa !5
  %197 = zext i16 %195 to i64
  %198 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %197
  store i16 %192, ptr %198, align 2, !tbaa !5
  br label %199

199:                                              ; preds = %187, %.loopexit14
  %200 = shl i32 %3, 16
  %201 = sub i32 %200, %7
  %202 = add i32 %200, 65536
  %203 = sub i32 %202, %7
  %204 = tail call i32 @llvm.umax.i32(i32 %18, i32 1)
  %205 = zext i32 %204 to i64
  br label %233

206:                                              ; preds = %206, %183
  %207 = phi i64 [ 0, %183 ], [ %231, %206 ]
  ...
  %218 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %217
  store i16 %212, ptr %218, align 2, !tbaa !5
  %219 = or disjoint i64 %207, 1
  %220 = getelementptr inbounds nuw i8, ptr %21, i64 %219
  %221 = load i8, ptr %220, align 1, !tbaa !9
  %222 = trunc nuw i64 %219 to i32
  %223 = add i32 %7, %222
  %224 = trunc i32 %223 to i16
  %225 = zext i8 %221 to i64
  %226 = getelementptr inbounds nuw [2 x i8], ptr %4, i64 %225
  %227 = load i16, ptr %226, align 2, !tbaa !5
  %228 = add i16 %227, 1
  store i16 %228, ptr %226, align 2, !tbaa !5
  %229 = zext i16 %227 to i64
  %230 = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %229
  store i16 %224, ptr %230, align 2, !tbaa !5
  %231 = add nuw i64 %207, 2
  %232 = icmp eq i64 %231, %184
  br i1 %232, label %.loopexit14, label %206, !llvm.loop !23

233:                                              ; preds = %258, %199
  %234 = phi i64 [ 0, %199 ], [ %260, %258 ]
  %235 = phi i32 [ 0, %199 ], [ %259, %258 ]
  %236 = getelementptr inbounds nuw [2 x i8], ptr %1, i64 %234
  %237 = load i16, ptr %236, align 2, !tbaa !5
  switch i16 %237, label %245 [
    i16 0, label %238
    i16 -1, label %240
    i16 1, label %240
  ]
...
238:                                              ; preds = %233
  %.split = getelementptr inbounds nuw [8 x i8], ptr %14, i64 %234
  %239 = getelementptr inbounds nuw i8, ptr %.split, i64 4
  store i32 %203, ptr %239, align 4, !tbaa !24
  br label %258

240:                                              ; preds = %233, %233
  %241 = getelementptr inbounds nuw [8 x i8], ptr %14, i64 %234
  %242 = getelementptr inbounds nuw i8, ptr %241, i64 4
  store i32 %201, ptr %242, align 4, !tbaa !24
  %243 = add i32 %235, -1
...
245:                                              ; preds = %233
  %246 = sext i16 %237 to i32
  %247 = add nsw i32 %246, -1
  %248 = tail call range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %247, i1 true)
  %249 = xor i32 %248, 31
  %250 = sub i32 %3, %249
  %251 = shl i32 %246, %250
  %252 = shl i32 %250, 16
  %253 = sub i32 %252, %251
  %254 = getelementptr inbounds nuw [8 x i8], ptr %14, i64 %234
  %255 = getelementptr inbounds nuw i8, ptr %254, i64 4
  store i32 %253, ptr %255, align 4, !tbaa !24
  %256 = sub i32 %235, %246
  store i32 %256, ptr %254, align 4, !tbaa !27
  %257 = add i32 %235, %246
  br label %258

258:                                              ; preds = %245, %240, %238
  %259 = phi i32 [ %257, %245 ], [ %235, %238 ], [ %244, %240 ]
  %260 = add nuw nsw i64 %234, 1
  %261 = icmp eq i64 %260, %205
  br i1 %261, label %.loopexit, label %233, !llvm.loop !28

.loopexit:                                        ; preds = %258, %6
  %262 = phi i64 [ -44, %6 ], [ 0, %258 ]
  ret i64 %262
}
...
.loopexit.i:                                      ; preds = %149, %128, %115, %.preheader.i.preheader, %.preheader.i
...
FSE_writeNCount_generic.exit:                     ; preds = %173, %156, %107, %.preheader25.i, %200, %193, %.loopexit30.i, %9, %7, %5
  %208 = phi i64 [ -44, %5 ], [ -1, %7 ], [ %207, %200 ], [ -1, %.loopexit30.i ], [ -70, %193 ], [ -1, %9 ], [ -70, %.preheader25.i ], [ -1, %156 ], [ -70, %107 ], [ -70, %173 ]
  ret i64 %208
}
...
FSE_compress_usingCTable_generic.exit:            ; preds = %5, %11, %.loopexit.i, %393
