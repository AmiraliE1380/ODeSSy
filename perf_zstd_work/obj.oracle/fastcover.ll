; ModuleID = '/mydata/ODeSSy/perf_zstd_work/obj.oracle/fastcover.ll.mid'
...
.loopexit14:                                      ; preds = %226, %223, %201, %20
  %233 = phi i64 [ 0, %20 ], [ 0, %226 ], [ %33, %223 ], [ %33, %201 ]
...
.split.us:                                        ; preds = %130, %135
  %132 = phi i32 [ %136, %135 ], [ %24, %130 ]
  br i1 %95, label %.thread, label %133
...
135:                                              ; preds = %134, %133
  ...
  br i1 %137, label %.split27.us, label %.split.us, !llvm.loop !64
...
.split27.us:                                      ; preds = %194, %135
  %.us-phi = phi i64 [ %113, %135 ], [ %195, %194 ]
  %.us-phi28 = phi i32 [ %110, %135 ], [ %196, %194 ]
