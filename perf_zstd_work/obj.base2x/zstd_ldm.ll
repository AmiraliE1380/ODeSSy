...
57:                                               ; preds = %51
  ...
  %59 = tail call i64 @ZSTD_XXH64(ptr noundef captures(none) %58, i64 noundef %34, i64 noundef 0) #14
...
.loopexit:                                        ; preds = %76, %59, %42, %25, %105, %97, %.loopexit5
  %107 = phi i64 [ %10, %.loopexit5 ], [ %93, %105 ], [ %93, %97 ], [ %72, %76 ], [ %55, %59 ], [ %38, %42 ], [ %21, %25 ]
  %108 = phi i64 [ %11, %.loopexit5 ], [ %94, %105 ], [ %94, %97 ], [ %73, %76 ], [ %56, %59 ], [ %39, %42 ], [ %22, %25 ]
...
198:                                              ; preds = %198, %190
  ...
  %203 = tail call i64 @ZSTD_XXH64(ptr noundef captures(none) %202, i64 noundef %153, i64 noundef 0) #14
...
.loopexit89:                                      ; preds = %408, %.preheader88, %396
  %413 = phi i64 [ 0, %396 ], [ %400, %.preheader88 ], [ %409, %408 ]
  %414 = sub i64 0, %413
...
.loopexit:                                        ; preds = %431, %.preheader, %419
  %436 = phi i64 [ 0, %419 ], [ %423, %.preheader ], [ %432, %431 ]
  %437 = add i64 %436, %413
  br label %438
...
.loopexit96:                                      ; preds = %537, %.preheader95, %526
  %542 = phi i64 [ 0, %526 ], [ %538, %537 ], [ %529, %.preheader95 ]
  %543 = add i64 %542, %524
...
.loopexit106:                                     ; preds = %654, %637, %37, %561, %5
  %658 = phi i64 [ -70, %561 ], [ 0, %5 ], [ 0, %654 ], [ 0, %37 ], [ %638, %637 ]
  ret i64 %658
}
...
.lr.ph:                                           ; preds = %39, %.lr.ph.preheader
...
39:                                               ; preds = %21
  ...
  %or.cond = or i1 %exitcond.not, %42
  br i1 %or.cond, label %.loopexit, label %.lr.ph

.loopexit:                                        ; preds = %39, %38, %27, %18, %5, %3
  ret void
}
...
26:                                               ; preds = %21, %17, %7
  ...
  %28 = tail call ptr @ZSTD_selectBlockCompressor(i32 noundef %11, i32 noundef %4, i32 noundef %27) #15
...
51:                                               ; preds = %26
  ...
  %53 = tail call i64 %28(ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %5, i64 noundef %6) #15
...
.lr.ph173:                                        ; preds = %65, %.lr.ph173.preheader
...
140:                                              ; preds = %122
  ...
  %or.cond = or i1 %exitcond.not, %143
  br i1 %or.cond, label %.loopexit43, label %111

.loopexit43:                                      ; preds = %140, %139, %128, %119, %109, %101, %99
...
156:                                              ; preds = %148
  %reass.sub67 = sub i32 %152, %153
  %157 = add i32 %reass.sub67, -1024
...
162:                                              ; preds = %160
  tail call void @ZSTD_fillHashTable(ptr noundef nonnull %1, ptr noundef %86, i32 noundef 0, i32 noundef 0) #15
  br label %164

163:                                              ; preds = %160
  tail call void @ZSTD_fillDoubleHashTable(ptr noundef nonnull %1, ptr noundef %86, i32 noundef 0, i32 noundef 0) #15
  br label %164

164:                                              ; preds = %163, %162, %160
  %165 = tail call i64 %28(ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %86, i64 noundef %93) #15
...
.loopexit44:                                      ; preds = %337, %.loopexit43, %32
  %347 = phi ptr [ %5, %32 ], [ %86, %.loopexit43 ], [ %341, %337 ]
...
358:                                              ; preds = %.loopexit44
  %reass.sub = sub i32 %353, %355
  %359 = add i32 %reass.sub, -1024
...
364:                                              ; preds = %362
  tail call void @ZSTD_fillHashTable(ptr noundef nonnull %1, ptr noundef %347, i32 noundef 0, i32 noundef 0) #15
  br label %366

365:                                              ; preds = %362
  tail call void @ZSTD_fillDoubleHashTable(ptr noundef nonnull %1, ptr noundef %347, i32 noundef 0, i32 noundef 0) #15
  br label %366

366:                                              ; preds = %365, %364, %362
  %367 = ptrtoint ptr %29 to i64
  %368 = sub i64 %367, %350
  %369 = tail call i64 %28(ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %347, i64 noundef %368) #15
  br label %370
