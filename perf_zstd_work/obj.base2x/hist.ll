...
30:                                               ; preds = %.preheader
  ...
  br i1 %32, label %.preheader20.preheader, label %33
...
47:                                               ; preds = %35
  ...
  br i1 %50, label %.loopexit, label %.preheader20.preheader

.preheader20.preheader:                           ; preds = %47, %30
  %.ph = phi i64 [ 0, %30 ], [ %34, %47 ]
  %.ph19 = phi i32 [ 0, %30 ], [ %49, %47 ]
  br label %.preheader20

.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  %51 = phi i64 [ %56, %.preheader20 ], [ %.ph, %.preheader20.preheader ]
  %52 = phi i32 [ %55, %.preheader20 ], [ %.ph19, %.preheader20.preheader ]
  %53 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %51
  %54 = load i32, ptr %53, align 4, !tbaa !8
  %55 = tail call i32 @llvm.umax.i32(i32 %54, i32 %52)
  %56 = add nuw nsw i64 %51, 1
  %57 = icmp eq i64 %51, %25
  br i1 %57, label %.loopexit, label %.preheader20, !llvm.loop !19

.loopexit:                                        ; preds = %.preheader20, %47
  %58 = phi i32 [ %49, %47 ], [ %55, %.preheader20 ]
...
64:                                               ; preds = %60
  %65 = icmp ult i64 %5, 4096
  br i1 %65, label %68, label %66

66:                                               ; preds = %64
  %67 = tail call fastcc i64 @HIST_count_parallel_wksp(ptr noundef %0, ptr noundef %1, ptr noundef %2, i64 noundef %3, i32 noundef 0, ptr noundef %4)
  br label %68

68:                                               ; preds = %66, %64, %60, %.loopexit, %15
  %69 = phi i64 [ %67, %66 ], [ -1, %60 ], [ -66, %64 ], [ 0, %15 ], [ %59, %.loopexit ]
  ret i64 %69
}
...
37:                                               ; preds = %.preheader
  ...
  br i1 %39, label %.preheader20.preheader, label %40
...
54:                                               ; preds = %42
  ...
  br i1 %57, label %.loopexit, label %.preheader20.preheader

.preheader20.preheader:                           ; preds = %54, %37
  %.ph = phi i64 [ 0, %37 ], [ %41, %54 ]
  %.ph19 = phi i32 [ 0, %37 ], [ %56, %54 ]
  br label %.preheader20

.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  %58 = phi i64 [ %63, %.preheader20 ], [ %.ph, %.preheader20.preheader ]
  %59 = phi i32 [ %62, %.preheader20 ], [ %.ph19, %.preheader20.preheader ]
  %60 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %58
  %61 = load i32, ptr %60, align 4, !tbaa !8
  %62 = tail call i32 @llvm.umax.i32(i32 %61, i32 %59)
  %63 = add nuw nsw i64 %58, 1
  %64 = icmp eq i64 %58, %32
  br i1 %64, label %.loopexit, label %.preheader20, !llvm.loop !27

.loopexit:                                        ; preds = %.preheader20, %54
  %65 = phi i32 [ %56, %54 ], [ %62, %.preheader20 ]
  %66 = zext i32 %65 to i64
  br label %69

67:                                               ; preds = %17
  %68 = tail call fastcc i64 @HIST_count_parallel_wksp(ptr noundef %0, ptr noundef nonnull %1, ptr noundef readonly %2, i64 noundef %3, i32 noundef 0, ptr noundef %4)
  br label %69

69:                                               ; preds = %67, %.loopexit, %22, %15, %10, %6
  %70 = phi i64 [ %16, %15 ], [ -1, %6 ], [ -66, %10 ], [ %68, %67 ], [ 0, %22 ], [ %66, %.loopexit ]
  ret i64 %70
}
...
29:                                               ; preds = %.preheader
  ...
  br i1 %31, label %.preheader20.preheader, label %32
...
46:                                               ; preds = %34
  ...
  br i1 %49, label %.loopexit, label %.preheader20.preheader

.preheader20.preheader:                           ; preds = %46, %29
  %.ph = phi i64 [ 0, %29 ], [ %33, %46 ]
  %.ph19 = phi i32 [ 0, %29 ], [ %48, %46 ]
  br label %.preheader20

.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  %50 = phi i64 [ %55, %.preheader20 ], [ %.ph, %.preheader20.preheader ]
  %51 = phi i32 [ %54, %.preheader20 ], [ %.ph19, %.preheader20.preheader ]
  %52 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %50
  %53 = load i32, ptr %52, align 4, !tbaa !8
  %54 = tail call i32 @llvm.umax.i32(i32 %53, i32 %51)
  %55 = add nuw nsw i64 %50, 1
  %56 = icmp eq i64 %50, %24
  br i1 %56, label %.loopexit, label %.preheader20, !llvm.loop !29

.loopexit:                                        ; preds = %.preheader20, %46
  %57 = phi i32 [ %48, %46 ], [ %54, %.preheader20 ]
  %58 = zext i32 %57 to i64
  br label %61

59:                                               ; preds = %4
  %60 = call fastcc i64 @HIST_count_parallel_wksp(ptr noundef %0, ptr noundef %1, ptr noundef readonly %2, i64 noundef %3, i32 noundef 0, ptr noundef nonnull %5)
  br label %61

61:                                               ; preds = %59, %.loopexit, %14
  %62 = phi i64 [ %60, %59 ], [ 0, %14 ], [ %58, %.loopexit ]
...
.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  ...
  %56 = add nuw nsw i64 %51, 1
  %57 = icmp eq i64 %51, %25
  br i1 %57, label %.loopexit, label %.preheader20, !llvm.loop !31
...
60:                                               ; preds = %10
  %61 = call fastcc i64 @HIST_count_parallel_wksp(ptr noundef %0, ptr noundef nonnull %1, ptr noundef readonly %2, i64 noundef %3, i32 noundef 0, ptr noundef nonnull %5)
  br label %62

62:                                               ; preds = %60, %.loopexit, %15, %8
  %63 = phi i64 [ %9, %8 ], [ %61, %60 ], [ 0, %15 ], [ %59, %.loopexit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5)
  ret i64 %63
}
