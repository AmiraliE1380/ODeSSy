...
28:                                               ; preds = %26
  ...
  br i1 %34, label %.preheader28.preheader, label %35
...
35:                                               ; preds = %28
  ...
  %43 = and i1 %42, %41
  br i1 %43, label %.preheader28.preheader, label %44
...
102:                                              ; preds = %100
  ...
  br i1 %105, label %.preheader28.preheader, label %106
...
121:                                              ; preds = %109
  ...
  br i1 %123, label %.loopexit14.thread, label %.preheader28.preheader

.preheader28.preheader:                           ; preds = %121, %102, %35, %28
  %.ph = phi i64 [ 0, %28 ], [ 0, %35 ], [ %103, %102 ], [ %122, %121 ]
  br label %.preheader28

.preheader28:                                     ; preds = %.preheader28.preheader, %.preheader28
  %124 = phi i64 [ %133, %.preheader28 ], [ %.ph, %.preheader28.preheader ]
  %125 = lshr exact i64 %124, 1
  %126 = getelementptr inbounds nuw i8, ptr %29, i64 %125
  %127 = load i8, ptr %126, align 1, !tbaa !17
  %128 = lshr i8 %127, 4
  %129 = getelementptr inbounds nuw i8, ptr %0, i64 %124
  store i8 %128, ptr %129, align 1, !tbaa !17
  %130 = load i8, ptr %126, align 1, !tbaa !17
  %131 = and i8 %130, 15
  %132 = getelementptr i8, ptr %30, i64 %124
  store i8 %131, ptr %132, align 1, !tbaa !17
  %133 = add nuw nsw i64 %124, 2
  %134 = icmp samesign ult i64 %133, %22
  br i1 %134, label %.preheader28, label %.loopexit14.thread, !llvm.loop !24

135:                                              ; preds = %17
  %136 = icmp ugt i64 %6, %19
  br i1 %136, label %137, label %.loopexit

137:                                              ; preds = %135
  %138 = add i64 %1, -1
  %139 = getelementptr inbounds nuw i8, ptr %5, i64 1
  %140 = tail call i64 @FSE_decompress_wksp_bmi2(ptr noundef %0, i64 noundef %138, ptr noundef nonnull %139, i64 noundef %19, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 0) #12
  %141 = icmp ult i64 %140, -119
  br i1 %141, label %.loopexit14, label %.loopexit

.loopexit14.thread:                               ; preds = %.preheader28, %121, %100
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
  br label %.preheader.preheader

.loopexit14:                                      ; preds = %137
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
  %142 = icmp eq i64 %140, 0
  br i1 %142, label %.loopexit, label %.preheader.preheader

.preheader.preheader:                             ; preds = %.loopexit14, %.loopexit14.thread
  %143 = phi i64 [ %24, %.loopexit14.thread ], [ %19, %.loopexit14 ]
  %144 = phi i64 [ %22, %.loopexit14.thread ], [ %140, %.loopexit14 ]
  br label %.preheader

.preheader:                                       ; preds = %151, %.preheader.preheader
...
.loopexit:                                        ; preds = %.preheader, %191, %177, %170, %166, %164, %.loopexit14, %137, %135, %26, %21, %15, %13
  %195 = phi i64 [ %14, %13 ], [ %194, %191 ], [ -72, %15 ], [ -72, %21 ], [ -20, %26 ], [ -72, %135 ], [ %140, %137 ], [ -20, %164 ], [ -20, %177 ], [ -20, %166 ], [ -20, %170 ], [ -20, %.loopexit14 ], [ -20, %.preheader ]
  ret i64 %195
}
...
22:                                               ; preds = %20
  ...
  br i1 %31, label %.preheader27.preheader, label %32
...
32:                                               ; preds = %22
  ...
  %41 = and i1 %39, %40
  br i1 %41, label %.preheader27.preheader, label %42
...
100:                                              ; preds = %98
  ...
  br i1 %103, label %.preheader27.preheader, label %104
...
119:                                              ; preds = %107
  ...
  br i1 %121, label %.loopexit13.thread, label %.preheader27.preheader

.preheader27.preheader:                           ; preds = %119, %100, %32, %22
  %.ph = phi i64 [ 0, %22 ], [ 0, %32 ], [ %101, %100 ], [ %120, %119 ]
  br label %.preheader27

.preheader27:                                     ; preds = %.preheader27.preheader, %.preheader27
  %122 = phi i64 [ %131, %.preheader27 ], [ %.ph, %.preheader27.preheader ]
  %123 = lshr exact i64 %122, 1
  %124 = getelementptr inbounds nuw i8, ptr %23, i64 %123
  %125 = load i8, ptr %124, align 1, !tbaa !17
  %126 = lshr i8 %125, 4
  %127 = getelementptr inbounds nuw i8, ptr %0, i64 %122
  store i8 %126, ptr %127, align 1, !tbaa !17
  %128 = load i8, ptr %124, align 1, !tbaa !17
  %129 = and i8 %128, 15
  %130 = getelementptr i8, ptr %25, i64 %122
  store i8 %129, ptr %130, align 1, !tbaa !17
  %131 = add nuw nsw i64 %122, 2
  %132 = trunc i64 %131 to i32
  %133 = icmp ugt i32 %24, %132
  br i1 %133, label %.preheader27, label %.loopexit13.thread, !llvm.loop !30

134:                                              ; preds = %11
  %135 = icmp ugt i64 %6, %13
  br i1 %135, label %136, label %.loopexit

136:                                              ; preds = %134
  %137 = add i64 %1, -1
  %138 = getelementptr inbounds nuw i8, ptr %5, i64 1
  %139 = tail call i64 @FSE_decompress_wksp_bmi2(ptr noundef %0, i64 noundef %137, ptr noundef nonnull %138, i64 noundef %13, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 1) #12
  %140 = icmp ult i64 %139, -119
  br i1 %140, label %.loopexit13, label %.loopexit

.loopexit13.thread:                               ; preds = %.preheader27, %119, %98
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
  br label %.preheader.preheader

.loopexit13:                                      ; preds = %136
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
  %141 = icmp eq i64 %139, 0
  br i1 %141, label %.loopexit, label %.preheader.preheader

.preheader.preheader:                             ; preds = %.loopexit13, %.loopexit13.thread
  %142 = phi i64 [ %18, %.loopexit13.thread ], [ %13, %.loopexit13 ]
  %143 = phi i64 [ %16, %.loopexit13.thread ], [ %139, %.loopexit13 ]
  br label %.preheader

.preheader:                                       ; preds = %150, %.preheader.preheader
  %144 = phi i64 [ %161, %150 ], [ 0, %.preheader.preheader ]
  %145 = phi i32 [ %159, %150 ], [ 0, %.preheader.preheader ]
  %146 = phi i32 [ %160, %150 ], [ 0, %.preheader.preheader ]
  %147 = getelementptr inbounds nuw i8, ptr %0, i64 %144
  %148 = load i8, ptr %147, align 1, !tbaa !17
  %149 = icmp ugt i8 %148, 12
...
150:                                              ; preds = %.preheader
  ...
  %154 = add i32 %153, 1
  store i32 %154, ptr %152, align 4, !tbaa !5
  ...
  %162 = icmp ugt i64 %143, %161
  br i1 %162, label %.preheader, label %163, !llvm.loop !25
...
165:                                              ; preds = %163
  %166 = tail call range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %159, i1 true)
  %167 = xor i32 %166, 31
  %168 = icmp samesign ugt i32 %167, 11
  br i1 %168, label %.loopexit, label %169

169:                                              ; preds = %165
  %170 = sub nuw nsw i32 32, %166
  store i32 %170, ptr %4, align 4, !tbaa !5
  %171 = shl nuw nsw i32 2, %167
  %172 = sub i32 %171, %159
  %173 = tail call range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %172, i1 true)
  %174 = lshr exact i32 -2147483648, %173
  %175 = icmp eq i32 %174, %172
  br i1 %175, label %176, label %.loopexit

176:                                              ; preds = %169
  %177 = sub nuw nsw i32 32, %173
  %178 = trunc nuw nsw i32 %177 to i8
  %179 = getelementptr inbounds nuw i8, ptr %0, i64 %143
...
190:                                              ; preds = %176
  %191 = trunc nuw i64 %143 to i32
  %192 = add i32 %191, 1
  store i32 %192, ptr %3, align 4, !tbaa !5
  %193 = add nuw nsw i64 %142, 1
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader, %190, %176, %169, %165, %163, %.loopexit13, %136, %134, %20, %15, %9
  %194 = phi i64 [ %193, %190 ], [ -72, %9 ], [ -72, %15 ], [ -20, %20 ], [ -72, %134 ], [ %139, %136 ], [ -20, %163 ], [ -20, %176 ], [ -20, %165 ], [ -20, %169 ], [ -20, %.loopexit13 ], [ -20, %.preheader ]
  ret i64 %194
}
